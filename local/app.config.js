...
module.exports = {
  ...
  port: 3000,
	...
	// Project options.
	projectURL: 'apple.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Style options.
	styleSRC: '../app/library/styles/main.scss', // Path to main .scss file.
