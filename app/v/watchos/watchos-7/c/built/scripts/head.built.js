! function t(e, n, o) {
  ...
  9: [function(t, e, n) {
    ...
    var o = t(10),
      r = t(15),
      i = function() {
        var t = o.getDocument().createElement("canvas");
  ...
  11: [function(t, e, n) {
    ...
    function u() {
      var t = i.getWindow();
      return !r() && !t.orientation || o.windows
    }
    e.exports = s(u), e.exports.original = u
  }, {
    10: 10,
    13: 13,
    15: 15,
  ...
  18: [function(t, e, n) {
    ...
    function i(t, e) {
      ...
      for (var r, i = o.length, s = 0; s < i; s++)
        if ((r = e.match((n = o[s], new RegExp(n + "[a-zA-Z\\s/:]+([0-9_.]+)", "i")))) && r.length > 1) return r[1].replace(/_/g, ".");
      return !1
    }
  ...
  20: [function(t, e, n) {
    ...
    const o = t(7),
      ...
      d = {
        initialize: function() {
          let t = document.documentElement.classList.contains("aow"),
            e = r.os.ios && 10 === r.os.version.major && r.os.version.minor < 3,
          ...
          return o.addTests({
            ...
            webkit: r.browser.safari || r.os.ios,
            ie: r.browser.ie,
            ie11: r.browser.ie && !r.browser.edge,
            edge: r.browser.edge,
            firefox: r.browser.firefox,
            desktop: i(),
            windows: r.os.windows,
            ios: r.os.ios,
            ios12: r.os.ios && 12 === r.os.version.major,
            mobile: void 0 !== window.orientation,
            touch: a,
            webgl: u,
            "legacy-ios": e,
            "prefers-reduced-motion": c(),
            "enhanced-layout": !r.browser.ie && !r.browser.edge && !t || n && !t,
            "static-layout": r.browser.ie || r.browser.edge || t || r.browser.android,
            "ac-nav-overlap": !0
          }), o.htmlClass(), this
        }
      };
