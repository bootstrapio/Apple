require = function() {
  ...
  2: [function(t, e, r) {
    ...
    "@marcom/ac-feature/cssPropertyAvailable": 5
  }],
  3: [function(t, e, r) {
    "use strict";
    var o = t("./cssMaskAvailable"),
  ...
  5: [function(t, e, r) {
    ...
    "@marcom/ac-prefixer/getStyleProperty": 21,
    "@marcom/ac-prefixer/getStyleValue": 22
  }],
  6: [function(t, e, r) {
    "use strict";
    e.exports = {
  ...
  21: [function(t, e, r) {
    ...
    "./shared/getStyleTestElement": 23,
    "./shared/prefixHelper": 24,
    "./shared/stylePropertyCache": 25,
    "./utils/toCSS": 27,
    "./utils/toDOM": 28
  }],
  22: [function(t, e, r) {
  ...
  26: [function(t, e, r) {
    ...
    "./getStyleTestElement": 23,
    "./stylePropertyCache": 25
  }],
  27: [function(t, e, r) {
    "use strict";
  ...
  47: [function(t, e, r) {
    ...
    var o = t("@marcom/ac-headjs"),
      n = t("@marcom/useragent-detect"),
      i = t("@marcom/ac-feature/isDesktop"),
      a = t("@marcom/ac-feature/isHandheld"),
      s = t("@marcom/ac-feature/isTablet"),
      c = t("@marcom/ac-feature/mediaElementsAvailable"),
      u = t("@marcom/ac-feature/canvasAvailable"),
      l = t("@marcom/ac-css-mask"),
      f = t("@marcom/ac-feature/webGLAvailable"),
      p = t("@marcom/ac-feature/prefersReducedMotion"),
      m = function() {
        return {
          initialize: function() {
            var t = document.documentElement.classList.contains("aow"),
              e = (f() && (!t || n.os.ios) && !p(), n.os.ios && 10 === n.os.version.major && n.os.version.minor < 3),
              r = n.os.android && n.browser.chrome;
            return o.addTests({
              aow: t,
              canvas: u,
              "css-mask": l,
              ...
              webkit: n.browser.safari || n.os.ios,
              ie: n.browser.ie,
              ie11: n.browser.ie && !n.browser.edge,
              edge: n.browser.edge,
              firefox: n.browser.firefox,
              "inline-video": c && !t && !n.os.android && !e,
              desktop: i(),
              ...
              touch: a() || s(),
              webgl: f,
              "grid-slide-in-enabled": !n.browser.ie,
              "legacy-ios": e,
              "inline-video-ios": n.os.ios && n.os.version.major >= 10,
              "prefers-reduced-motion": p(),
              "enhanced-layout": !n.browser.ie && !n.browser.edge && !t || r && !t,
              "static-layout": n.browser.ie || n.browser.edge || t || n.browser.android
            }), o.htmlClass(), this
          }
        }
      }();
    e.exports = m.initialize()
  }, {
    "@marcom/ac-css-mask": 1,
    "@marcom/ac-feature/canvasAvailable": 4,
    "@marcom/ac-feature/isDesktop": 7,
    "@marcom/ac-feature/isHandheld": 8,
    "@marcom/ac-feature/isTablet": 9,
    "@marcom/ac-feature/mediaElementsAvailable": 10,
    "@marcom/ac-feature/prefersReducedMotion": 11,
    "@marcom/ac-feature/webGLAvailable": 13,
    "@marcom/ac-headjs": 19,
    "@marcom/useragent-detect": 32
  }],
