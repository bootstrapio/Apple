...
c.exports=new d(window)},{"ac-dom-emitter":11}],965:[function(c,f,b){c("./../shared/objectassign_polyfill");
var h=c("../shared/Shared");var d=c("../shared/ParallaxObjectsController");var a=c("ac-films");
var g=c("ac-dom-traversal/querySelectorAll");var i=(function(){return{initialize:function(){var j=h.initialize();
if(j.parallax){var k=new d(this._getParallaxObjects());k.start()}this.initializeVideo();
return this},initializeVideo:function(){var j=g("#film-trigger");j.forEach(function(k){if(!k.getAttribute("data-analytics-id")){k.setAttribute("data-analytics-id",k.id)
}});a.create(j,{modal:true})},_getParallaxObjects:function(){return[]}}}());f.exports=i.initialize()
},{"../shared/ParallaxObjectsController":969,"../shared/Shared":971,"./../shared/objectassign_polyfill":973,"ac-dom-traversal/querySelectorAll":42,"ac-films":283}],966:[function(b,a,d){var f,i=b("ac-base").Element,c=b("ac-object"),k=b("window-delegate").WindowDelegate,j=b("ac-event-emitter").EventEmitter;
...
},{"ac-base":false,"ac-object":465,"window-delegate":962}],967:[function(c,d,b){var f=c("ac-base").Element,a=c("../shared/BreakpointsDelegate");
...
}};return{getFunctionByKey:function(i){return h[i]}}}());d.exports=g},{"../shared/BreakpointsDelegate":966,"ac-base":false}],968:[function(c,d,b){var g,f=c("ac-event-emitter").EventEmitter,a=c("scroll-time-update").ElementScrollTimeUpdate;
...
return this};g.resize=function(){this._scrollHandler.setOffsets()};d.exports=h},{"scroll-time-update":959}],969:[function(b,d,a){var h,f=b("ac-base").Element,g=b("./ParallaxFunctions"),i=b("./ParallaxObject");
...
return l};d.exports=c},{"./ParallaxFunctions":967,"./ParallaxObject":968,"ac-base":false}],970:[function(c,g,b){var f=c("scroll-time-update").ScrollTimeUpdate;
...
this.scrollTimeUpdate.start()}},{"ac-base":false,"scroll-time-update":959,"window-delegate":962}],971:[function(c,a,f){var d=c("./localnav");
...
return true}}catch(o){}l=false;return false}}}());a.exports=h},{"./BreakpointsDelegate":966,"./RevealNext":970,"./localnav":972,"ac-base":false}],972:[function(b,d,a){var h=b("ac-dom-emitter").DOMEmitter;
...
}}}}());d.exports=i},{"ac-base":false,"ac-dom-emitter":11,"window-delegate":962}],973:[function(b,c,a){if(!Object.assign){if(!Object.keys){Object.keys=function d(g){var f=[];
