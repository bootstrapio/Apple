...
for(var f=0;f<d.length;f++){c(d[f])}return c})({sAbXaO:[function(require,module,exports){
...
}})(this)},{}],"dust-runtime":[function(b,c,a){c.exports=b("sAbXaO")},{}],"ac-video-templates":[function(b,c,a){c.exports=b("OnUF3R")
},{}],OnUF3R:[function(b,c,a){c.exports=(function(){var d=b("./dust-runtime");(function(){d.register("controlBarDefault",h);
...
}return j})();return d})()},{"./dust-runtime":"sAbXaO"}],5:[function(b,a,c){var g,d=b("ac-base").Environment,h=b("ac-base").Element;
var j={Firefox:"ff",IE:"ie",oldie:"oldie"};var i={noJS:"no-js",hasJS:"js"};var k={touch:"touch",noTouch:"no-touch",svg:"svg",noSvg:"no-svg",canvas:"canvas",threedTransform:"threedtransform",nothreedTransform:"no-threedtransform",sticky:"sticky",noSticky:"no-sticky",ios:"ios",media:"media",heroIntro:"hero-intro"};
var f=function(){this._didInitialize=false;this._classTarget=document.documentElement;
this.supportMatrix={}};g=f.prototype;g.initialize=function(){if(this._didInitialize){return
}this.removeNoJSClass();this.setJSClass();this.setBrowserTypeClass();this.setTouchClass();
this.setIOSClasses();this.setSVGClass();this.setCanvasClass();this.setThreedTransformClass();
this.setStickyClass();this.setMediaIntroTypeClass();this._didInitialize=true};g.getBrowserClassNames=function(){return j
};g.getJSClassNames=function(){return i};g.getViewportClassNames=function(){return k
};g.removeNoJSClass=function(){h.removeClassName(this._classTarget,i.noJS)};g.setJSClass=function(){h.addClassName(this._classTarget,i.hasJS)
};g.setBrowserTypeClass=function(){var m=null,l=d.Browser.name,n=d.Browser.version;
if(l==="Firefox"){m=j.Firefox}else{if(l==="IE"){m=j.IE;if(n<9){m=j.oldie}}}if(m){h.addClassName(this._classTarget,m)
}};g.setIOSClasses=function(){if(d.Browser.os!=="iOS"){return}h.addClassName(this._classTarget,k.ios);
h.addClassName(this._classTarget,k.ios+"-"+d.Browser.version)};g.setTouchClass=function(){var l=k.noTouch;
if(d.Feature.touchAvailable()){l=k.touch}h.addClassName(this._classTarget,l)};g.setSVGClass=function(){var l=k.noSvg;
if(d.Feature.svgAvailable()){l=k.svg}h.addClassName(this._classTarget,l)};g.setCanvasClass=function(){if(d.Feature.canvasAvailable()){h.addClassName(this._classTarget,k.canvas)
}};g.setThreedTransformClass=function(){var l=k.nothreedTransform;if(d.Feature.threeDTransformsAvailable()){l=k.threedTransform
}h.addClassName(this._classTarget,l)};g.setStickyClass=function(){var n="position:",m=document.createElement("div"),l=k.noSticky;
m.style.cssText=n+["-webkit-","-moz-","-ms-","-o-",""].join("sticky;"+n)+"sticky;";
if(m.style.position.indexOf("sticky")!==-1){l=k.sticky}if(d.Browser.version<7){l=k.noSticky
}h.addClassName(this._classTarget,l)};g.canUseMP4Video=function(){if(this._mp4Support!==null){return this._mp4Support
}try{var l=document.createElement("VIDEO");if(l.canPlayType&&l.canPlayType("video/mp4").replace(/no/," ")){this._mp4Support=true;
return true}}catch(m){}this._mp4Support=false;return false};g.setMediaIntroTypeClass=function(){if(AC.Environment.Feature.supportsThreeD()||d.Browser.name==="Firefox"){h.addClassName(this._classTarget,k.media);
h.addClassName(this._classTarget,k.heroIntro)}};g.canUseFlow=function(){return d.Feature.canvasAvailable()
};a.exports=new f()},{"ac-base":false}],6:[function(c,d,b){var a=c("./RuntimeDelegate");
var f=(function(){return{initialize:function(){a.initialize();return this}}}());
d.exports=f.initialize()},{"./RuntimeDelegate":5}]},{},[6]);