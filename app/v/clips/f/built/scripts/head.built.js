(function e(b, g, d) {
  ...
  7: [function(b, c, a) {
    ...
    "./data": 9,
    "@marcom/ac-polyfills/Array/prototype.filter": 39,
    "@marcom/ac-polyfills/Array/prototype.some": 47
  }],
  8: [function(b, c, a) {
    c.exports = {
  ...
  10: [function(b, c, a) {
    ...
    "./className/add": 11,
    "@marcom/ac-polyfills/Array/prototype.slice": 46,
    "@marcom/ac-polyfills/Element/prototype.classList": 54
  }],
  11: [function(b, c, a) {
    var d = b("./contains");
  ...
  16: [function(c, d, b) {
    ...
    "@marcom/ac-polyfills/Array/prototype.forEach": 40
  }],
  17: [function(b, d, a) {
    ...
    "@marcom/ac-classlist/add": 10,
    "@marcom/ac-classlist/remove": 15,
  ...
  20: [function(f, g, d) {
    ...
    "@marcom/ac-browser": 6,
    "@marcom/ac-feature/svgAvailable": 3,
    "@marcom/ac-feature/touchAvailable": 4
  }],
  21: [function(b, c, a) {
    (function(h) {
      if (!h.console) {
  ...
  35: [function(b, c, a) {
    ...
    "./Array/prototype.forEach": 40,
    "./Array/prototype.indexOf": 41,
    "./Array/prototype.lastIndexOf": 42,
    "./Array/prototype.map": 43,
    "./Array/prototype.reduce": 44,
    "./Array/prototype.reduceRight": 45,
    "./Array/prototype.slice": 46,
    "./Array/prototype.some": 47
  }],
  36: [function(b, c, a) {
    if (!Array.from) {
      Array.from = (function() {
  ...
  49: [function(b, c, a) {
    ...
    "./Date/now": 50,
    "./Date/prototype.toISOString": 51,
    "./Date/prototype.toJSON": 52
  }],
  50: [function(c, d, a) {
    if (!Date.now) {
      Date.now = function b() {
  ...
  53: [function(b, c, a) {
    ...
    "./Element/prototype.classList": 54,
    "./Element/prototype.matches": 55,
    "./Element/prototype.remove": 56
  }],
  54: [function(b, c, a) {
  ...
  79: [function(f, d, h) {
    ...
    "./shared/getStyleTestElement": 81,
    "./shared/prefixHelper": 82,
    "./shared/stylePropertyCache": 83,
    "./utils/toCSS": 85,
    "./utils/toDOM": 86
  }],
  80: [function(d, b, h) {
  ...
  84: [function(c, b, d) {
    ...
    "./getStyleTestElement": 81,
    "./stylePropertyCache": 83
  }],
  85: [function(c, d, b) {
  ...
  89: [function(b, c, a) {
    c.exports = {
      ...
      os: [{
        ...
        userAgent: "Mac",
        test: function(d) {
          return (d.ua.indexOf("Macintosh") > -1)
        }
      }, {
        name: "ios",
        test: function(d) {
        ...
        userAgent: "Linux",
        test: function(d) {
          return ((d.ua.indexOf("Linux") > -1 || d.platform.indexOf("Linux") > -1) && d.ua.indexOf("Android") === -1)
        }
      }, {
        name: "fireos",
        test: function(d) {
  ...
  93: [function(d, f, b) {
    var i = d("@marcom/useragent-detect").os;
    var a = d("./touchAvailable").original;
    var h = d("./helpers/globals");
    var g = d("@marcom/function-utils/once");

    function c() {
      var j = h.getWindow();
      return ((!a() && !j.orientation) || i.windows)
    }
    f.exports = g(c);
    ...
    "./helpers/globals": 92,
    "./touchAvailable": 96,
    "@marcom/function-utils/once": 87,
    "@marcom/useragent-detect": 91
  }],
  94: [function(b, c, a) {
  ...
  95: [function(b, c, a) {
    ...
    var d = b("@marcom/function-utils/once");
    ...
    "@marcom/ac-prefixer/getStyleValue": 80,
    "@marcom/function-utils/once": 87
  }],
  96: [function(c, d, b) {
    var g = c("./helpers/globals");
    var f = c("@marcom/function-utils/once");
  ...
  97: [function(c, f, b) {
    var i = c("@marcom/ac-headjs");
    var a = {
      isDesktop: c("@marcom/feature-detect/isDesktop"),
      threeDTransformsAvailable: c("@marcom/feature-detect/threeDTransformsAvailable"),
      prefersReducedMotion: c("@marcom/feature-detect/prefersReducedMotion")
    };
    var d = c("@marcom/ac-useragent");
    var g = (!a.threeDTransformsAvailable() || a.prefersReducedMotion());
    var h = (function() {
      return {
        initialize: function() {
          i.addTests({
            reducedMotion: g,
            inlineVideo: (a.isDesktop() || (d.os.ios && d.os.version.major >= 10)),
            progressive: true,
            ios: d.os.ios === true,
            oldIos10: d.os.ios && d.os.version.major === 10 && d.os.version.minor < 3,
            ie11: d.browser.ie && d.browser.version.major <= 11,
    ...
    f.exports = h.initialize()
  }, {
    "@marcom/ac-headjs": 19,
    "@marcom/ac-useragent": 75,
    "@marcom/feature-detect/isDesktop": 93,
    "@marcom/feature-detect/prefersReducedMotion": 94,
    "@marcom/feature-detect/threeDTransformsAvailable": 95
  }]
}, {}, [97]);