require = function() {
  ...
  25: [function(t, e, o) {
    ...
    }).call(this, t(6), "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
  }, {
    6: 6
  }],
  26: [function(t, e, o) {
  ...
  28: [function(t, e, o) {
    ...
    function i(t, e, o, r) {
      ...
      s(e, n) || (u && a ? l(e, n) : c ? f(e, i) : t === S ? l(e, n) : t === x && f(e, n))
    }

    function a(t, e, o, r) {
      var n = t._subscribers,
        i = n.length;
      n[i] = e, n[i + S] = o, n[i + x] = r
    }
    ...
    function u(t, e) {
      t._state === O && (t._state = E, t._detail = e, y.async(p, t))
    }

    function f(t, e) {
      t._state === O && (t._state = E, t._detail = e, y.async(m, t))
    }
    ...
    var y = t(26).config,
      d = (t(26).configure, t(32).objectOrFunction),
      h = t(32).isFunction,
      g = (t(32).now, t(24).all),
      w = t(29).race,
      v = t(31).resolve,
    ...
    }, r.all = g, r.race = w, r.resolve = v, r.reject = b, o.Promise = r
  }, {
    24: 24,
    25: 25,
    26: 26,
  ...
  36: [function(t, e, o) {
    ...
    n.addTests({
      ...
      ie: i.browser.ie,
      edge: i.browser.edge,
      "win-firefox": i.os.windows && i.browser.firefox,
      "hero-inline-video": !s() && !c && (a() || i.os.ios && i.os.version.major >= 10),
      "inline-video": !s() && !c && (a() || i.os.ios && i.os.version.major >= 10),
      "sprite-sheet-player": l() && !c,
      "siri-wave": u && !s() && !c,
      "hero-animation": u && !s() && !c && (a() || r() || i.os.ios && i.os.version.major >= 10) && !i.browser.ie && !i.browser.firefox,
      "sprite-animations": l() && !c && !i.browser.firefox && !s(),
      "quick-look": r()
    }), n.htmlClass()
  }, {
    11: 11,
  ...
  "@marcom/ac-polyfills/JSON": [function(require, module, exports) {
    "use strict";
    var _interopRequireDefault = require(4),
      _typeof2 = _interopRequireDefault(require(5));
