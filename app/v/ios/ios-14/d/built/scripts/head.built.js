! function t(e, n, o) {
  ...
  7: [function(t, e, n) {
    ...
    var o = t(5),
      i = t(8);
    e.exports = new o(document.documentElement, i), e.exports.FeatureDetect = o;
    var r = t(6);
  ...
  13: [function(t, e, n) {
    ...
    function s(t, e, n) {
      for (var o, i, s = t.length, u = 0; u < s; u++)
        if ("function" == typeof t[u].test ? !0 === t[u].test(n) && (o = t[u].name) : n.ua.indexOf(t[u].userAgent) > -1 && (o = t[u].name), o) {
          if (e[o] = !0, "string" == typeof(i = r(t[u], n.ua))) {
            var a = i.split(".");
            e.version.string = i, a && a.length > 0 && (e.version.major = parseInt(a[0] || 0), e.version.minor = parseInt(a[1] || 0), e.version.patch = parseInt(a[2] || 0))
  ...
  15: [function(t, e, n) {
    ...
    const o = t(7),
      i = t(14),
      r = t(10),
      s = document.documentElement.classList.contains("aow"),
      u = window.CSS.supports("mix-blend-mode", "multiply");
    let a = t(16)();
    o.addTests({
      edge: i.browser.edge,
      "reduced-motion": r(),
      ...
      "blend-mode": u,
      safari: a.safari,
      "safari-mobile": a.mobile,
      "safari-iphone-x": a.iphonex,
      "safari-ipad": a.ipad,
      "hero-static": r() || i.browser.edge || s
    }), o.htmlClass()
  }, {
    10: 10,
    14: 14,
  ...
  16: [function(t, e, n) {
    ...
    e.exports = () => {
      let t = (() => {
          let t = [window.outerWidth, window.outerHeight];
          return "0.46" === (Math.min(...t) / Math.max(...t)).toFixed(2)
        })(),
        e = o.browser.safari,
        n = o.os.ios,
        i = o.os.osx,
        r = e && n,
        s = e && i && 12 === o.browser.version.major,
        u = e && i && 13 === o.browser.version.major && o.browser.version.minor < 1;
      return {
        safari: e,
        old: s || u,
        mobile: r && !t,
        iphonex: r && t,
        ipad: e && i && !1 === window.navigator.standalone
      }
    }
  }, {
    14: 14
