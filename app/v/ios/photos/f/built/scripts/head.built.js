! function(t) {
  ...
  t.exports = s.initialize()
}, function(t, e, n) {
  "use strict";
  n(28);
  var o = n(29),
    r = n(30);
  t.exports = new o(document.documentElement, r), t.exports.FeatureDetect = o;
  var i = n(33);
    ...
    for (var o, r, s = t.length, u = 0; u < s; u++)
      if ("function" == typeof t[u].test ? !0 === t[u].test(n) && (o = t[u].name) : n.ua.indexOf(t[u].userAgent) > -1 && (o = t[u].name), o) {
        if (e[o] = !0, "string" == typeof(r = i(t[u], n.ua))) {
          var a = r.split(".");
          e.version.name = r, a && a.length > 0 && (e.version.major = parseInt(a[0] || 0), e.version.minor = parseInt(a[1] || 0), e.version.patch = parseInt(a[2] || 0))
