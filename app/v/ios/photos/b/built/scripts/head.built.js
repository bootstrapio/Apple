(function e(h, j, l) {
  ...
  8: [function(g, k, h) {
    ...
    "./data": 10,
    "@marcom/ac-polyfills/Array/prototype.filter": 36,
    "@marcom/ac-polyfills/Array/prototype.some": 45
  }],
  9: [function(d, g, f) {
    g.exports = {
  ...
  11: [function(g, k, h) {
    ...
    "./className/add": 12,
    "@marcom/ac-polyfills/Array/prototype.slice": 44,
    "@marcom/ac-polyfills/Element/prototype.classList": 52
  }],
  12: [function(g, k, h) {
    var j = g("./contains");
  ...
  17: [function(k, j, g) {
    ...
    "@marcom/ac-polyfills/Array/prototype.forEach": 38
  }],
  18: [function(d, g, f) {
    (function(l) {
      if (!l.console) {
  ...
  31: [function(d, g, f) {
    ...
    window.matchMedia || (window.matchMedia = function() {
      ...
      if (!c) {
        ...
        c = {
          matchMedium: function(k) {
            var h = "@media " + k + "{ #matchmediajs-test { width: 1px; } }";
            if (b.styleSheet) {
  ...
  32: [function(d, g, f) {
    ...
    "./Array/from": 33,
    "./Array/isArray": 34,
    "./Array/prototype.every": 35,
    "./Array/prototype.filter": 36,
    "./Array/prototype.find": 37,
    "./Array/prototype.forEach": 38,
    "./Array/prototype.indexOf": 39,
    "./Array/prototype.lastIndexOf": 40,
    "./Array/prototype.map": 41,
    "./Array/prototype.reduce": 42,
    "./Array/prototype.reduceRight": 43,
    "./Array/prototype.slice": 44,
    "./Array/prototype.some": 45
  }],
  33: [function(d, g, f) {
    if (!Array.from) {
      Array.from = (function() {
  ...
  47: [function(d, g, f) {
    ...
    "./Date/now": 48,
    "./Date/prototype.toISOString": 49,
    "./Date/prototype.toJSON": 50
  }],
  48: [function(i, h, g) {
    if (!Date.now) {
      Date.now = function f() {
  ...
  51: [function(d, g, f) {
    ...
    "./Element/prototype.classList": 52,
    "./Element/prototype.matches": 53,
    "./Element/prototype.remove": 54
  }],
  52: [function(d, g, f) {
  ...
  70: [function(d, g, f) {
    ...
    "html5shiv/src/html5shiv": 29
  }],
  71: [function(d, g, f) {
    d("matchmedia-polyfill");
    d("matchmedia-polyfill/matchMedia.addListener")
  }, {
    "matchmedia-polyfill": 31,
    "matchmedia-polyfill/matchMedia.addListener": 30
  }],
  72: [function(d, g, f) {
    d("./performance/now")
  }, {
  ...
  78: [function(m, l, n) {
    ...
    "@marcom/ac-browser": 7,
    "@marcom/ac-feature/svgAvailable": 4,
    "@marcom/ac-feature/touchAvailable": 5
  }],
  79: [function(f, i, g) {
    var h = {
  ...
  83: [function(o, m, i) {
    var k = o("@marcom/ac-headjs");
    var n = o("@marcom/ac-useragent");
    var j = {
      isDesktop: o("@marcom/ac-feature/isDesktop")
    };
    var l = (function() {
      return {
        initialize: function() {
          k.addTests({
            inlineVideo: (j.isDesktop() || (n.os.ios && n.os.version.major >= 10)),
            ios: n.os.ios === true,
            ios9: n.os.ios && n.os.version.major === 9,
            oldIos10: n.os.ios && n.os.version.major === 10 && n.os.version.minor < 3,
            ie11: n.browser.ie && n.browser.version.major <= 11,
            edge: n.browser.edge,
    ...
    m.exports = l.initialize()
  }, {
    "@marcom/ac-feature/isDesktop": 3,
    "@marcom/ac-headjs": 77,
    "@marcom/ac-useragent": 79
  }]
}, {}, [83]);