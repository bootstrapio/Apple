! function() {
  ...
  3: [function(t, e, i) {
    ...
    "./sharedRAFEmitterIDGeneratorInstance": 9,
    "./sharedRAFExecutorInstance": 10,
  ...
  12: [function(t, e, i) {
    ...
    class O extends a {
      constructor(t) {
        ...
        this._cachedPos = {
          ...
          this._attach(), this.refreshSize()
        })
      }
      _bindMethods() {
        this._onPlaying = this._onPlaying.bind(this), this._onLoadedMetadata = this._onLoadedMetadata.bind(this), this._videoElement && (this._videoElement.addEventListener("playing", this._onPlaying), this._videoElement.addEventListener("loadedmetadata", this._onLoadedMetadata))
      }
      _attach() {
        this._distance = 50;
        const t = {
        ...
        this._renderer = new e({
          ...
          useCanvasForVideoTexture: _,
          maxLat: this._maxLat
        }), this._renderer.attach(), this._renderer.domElement.classList.add("threesixty-renderer"), this.el.appendChild(this._renderer.domElement), this._animate = this._animate.bind(this), this._animateRAF = n(this._animate)
      }
      _animate() {
        this._update(), this._animateRAF = n(this._animate)
      }
      _update(t) {
      ...
      async _updateTexture(t) {
        await this._renderer.updateTexture(t), this.trigger("textureChange")
      }
      _onResize() {
      ...
      _onLoadedMetadata() {
        this._videoElement.removeEventListener("loadedmetadata", this._onLoadedMetadata), this._onResize()
      }
      _onPlaying() {
        this._videoElement.removeEventListener("playing", this._onPlaying), this._onResize(), this._orientationControls && this._orientationControls.enable()
      }
      requestOrientationControl() {
        this._orientationControls && this._orientationControls.requestPermission()
      }
      play() {
        this._orientationControls && this._orientationControls.requestPermission(), this._videoElement && this._videoElement.play()
      }
      pause() {
      ...
      oscillateLongitude() {
        ...
        return this._currentTimer ? this._currentTimer.cancel().then(() => {
          this._currentTimer = null, this.oscillateLongitude()
        }) : (r(this._animateRAF), this.trigger(O.ROTATION_START, i), new Promise(n => {
          this._currentTimer = h(e, e => {
            const n = Math.sin(Math.PI * this._sineEasing.getValue(e)),
              r = (new THREE.Vector2).copy(t);
            r.x = t.x - n * this._oscillationDistance, this._tmpCurrentPosition = {
              lat: r.y,
              lon: r.x
            }, this.trigger(O.ROTATION_UPDATE, {
              t: e,
              easedVal: n,
            ...
            }), this._renderer.positionCamera(r.x, r.y)
          }), this._currentTimer.promise.then(() => {
            this.trigger(O.ROTATION_COMPLETE, i), this.setPos(t.y, t.x), this._animate(), this._currentTimer = null, this._tmpCurrentPosition = null, n()
          }).catch(() => {})
        }))
      }
      get mediaElement() {
      ...
      _respositionCameraToPosition(t, e) {
        if (this._currentTimer) return this._currentTimer.cancel().then(() => {
          this._currentTimer = null, this.setPos(this._tmpCurrentPosition.y, this._tmpCurrentPosition.x), this._tmpCurrentPosition = null, this._respositionCameraToPosition(t, e)
        });
        if (this._pointerControls.cancelInertia(), this.arrowControls.cancelInertia(), t.lat === this.position.lat && t.lon === this.position.lon) return this.trigger(O.ROTATION_START, {
          time: 0,
          startPosition: Object.assign({}, this.position),
          targetPosition: Object.assign({}, this.position)
        }), this.trigger(O.ROTATION_COMPLETE, {
          time: 1,
          startPosition: Object.assign({}, this.position),
          targetPosition: Object.assign({}, this.position)
        }), Promise.resolve();
        ...
        return this.trigger(O.ROTATION_START, f), new Promise(e => {
          this._currentTimer = h(d, t => {
            ...
            }), this._tmpCurrentPosition = n, this._renderer.positionCamera(n.x, n.y)
          }), this._currentTimer.promise.then(() => {
            this.trigger(O.ROTATION_COMPLETE, f), this.setPos(t.lat, t.lon), this._animate(), this._currentTimer = null, this._tmpCurrentPosition = null, e()
          })
        }).catch(() => {})
      }
    }
    ...
    "./controls/ArrowControls": 14,
    "./controls/OrientationControls": 16,
    "./controls/PointerControls": 17,
    "./renderers/SphericalRenderer": 18,
    "./utils/inverseLongitude": 19,
    "./utils/loadScript": 20,
    "./utils/map": 21,
    "./utils/simpleTimer": 23,
    "./utils/vector3FromLatLon": 24,
    "@marcom/ac-easing/src/ac-easing/createBezier": 92,
    "@marcom/ac-event-emitter-micro/EventEmitterMicro": 95,
    "@marcom/ac-feature/webGLAvailable": 104,
    "@marcom/ac-raf-emitter/cancelUpdate": 8,
    "@marcom/ac-raf-emitter/update": 11,
    "@marcom/useragent-detect": 327
  }],
  13: [function(t, e, i) {
    e.exports = t("./AC360")
  }, {
  ...
  14: [function(t, e, i) {
    ...
    e.exports = class extends n {
      constructor(t) {
        super(t = Object.assign({}, a, t)), this._bindMethods()
      }
      _bindMethods() {
      ...
      leftArrowDown() {
        Math.abs(this._velocity.x - this._horizontalIncrement) < this._maxVelocity ? this._velocity.x -= this._horizontalIncrement : this._velocity.x = -this._maxVelocity, this._lon = r(this._lon + this._velocity.x), this._triggerInertia()
      }
      rightArrowDown() {
        Math.abs(this._velocity.x + this._horizontalIncrement) < this._maxVelocity ? this._velocity.x += this._horizontalIncrement : this._velocity.x = this._maxVelocity, this._velocity.x += this._horizontalIncrement, this._lon = r(this._lon + this._velocity.x), this._triggerInertia()
      }
      upArrowDown(t) {
      ...
      _triggerInertia() {
        s(this._inertiaRaf), o(this._updateInertia)
      }
      get isActive() {
  ...
  15: [function(t, e, i) {
    ...
    e.exports = class {
      constructor(t = {}) {
        this._horizontalFriction = t.friction && t.friction.x || s, this._verticalFriction = t.friction && t.friction.x || s, this._horizontalIncrement = t.acceleration && t.acceleration.x || a, this._verticalIncrement = t.acceleration && t.acceleration.y || a, this._minVelocity = t.minVelocity || c, this._maxVelocity = t.maxVelocity || l, this._velocity = {
          x: 0,
          y: 0
        }, this._bindMethods()
      }
  ...
  16: [function(t, e, i) {
    ...
    e.exports = class {
      ...
      requestPermission() {
        return this._permissionPromise || ("function" != typeof DeviceMotionEvent.requestPermission ? this._permissionPromise = Promise.resolve() : (this._permissionPromise = DeviceMotionEvent.requestPermission(), this._permissionPromise.catch(t => {
          r("User didn't grant Gyro permission, or request wasn't tied to a user gesture"), this._permissionPromise = null
  ...
  17: [function(t, e, i) {
    ...
    e.exports = class extends r {
      constructor(t) {
        super(t = Object.assign({}, a, t)), this.el = t.el, this._mouseDown = !1, this._scale = 1, this._hasInertia = !1 !== t.inertia || t.inertia, this._bindMethods(), this._addEventListeners()
      }
      _bindMethods() {
        this._onMouseMove = this._onMouseMove.bind(this), this._onMouseDown = this._onMouseDown.bind(this), this._onMouseUp = this._onMouseUp.bind(this), this._onTouchMove = this._onTouchMove.bind(this), this._onClick = this._onClick.bind(this), super._bindMethods()
      }
      _addEventListeners() {
      ...
      _onMouseUp(t) {
        window.removeEventListener("mousemove", this._onMouseMove), window.removeEventListener("mouseup", this._onMouseUp), document.body.removeEventListener("touchmove", this._onTouchMove), document.body.removeEventListener("touchend", this._onMouseUp), this._mouseDown && this._hasInertia && Date.now() - this._mouseMoveTime < 300 && this._updateInertia(), setTimeout(() => {
          this._mouseDown || (this._dragging = !1)
      ...
      _onMouseDown(t) {
        ...
        this._cachedPosition = t, window.addEventListener("mousemove", this._onMouseMove), window.addEventListener("mouseup", this._onMouseUp), document.body.addEventListener("touchmove", this._onTouchMove, {
          passive: !1
        }), document.body.addEventListener("touchend", this._onMouseUp), this._mouseDown = !0, this._lastMouseX = e.clientX, this._lastMouseY = e.clientY, this._lastMouseDownLon = n(this._lon), this._lastMouseDownLat = this._lat
      }
      _onTouchMove(t) {
    ...
    e.exports = class {
      ...
      attach() {
        ...
        this._camera = new THREE.PerspectiveCamera(75, i, 1, 1100), this._camera.target = new THREE.Vector3(0, 0, 0), this._scene = new THREE.Scene, this._geometry = new THREE.SphereBufferGeometry(500, 60, 40), this._geometry.scale(-1, 1, 1), this._texture = this._createTexture(this._textureSrc), this._material = new THREE.MeshBasicMaterial({
          ...
          antialias: !1,
          powerPreference: o
        }), this._renderer.setPixelRatio(window.devicePixelRatio), this._renderer.setSize(t, e), this._canvas && this._tick()
      }
      _tick() {
        this._canvasCtx && this._videoElement && (this._canvasCtx.drawImage(this._videoElement, 0, 0, this._canvas.width, this._canvas.height), this._texture.needsUpdate = !0), s(() => this._tick())
      }
      update(t) {
        const e = t,
        ...
        return this._camera.zoom = this._pointerControls.scale, this._camera.position.x = o, this._camera.position.y = s, this._camera.position.z = a, this._camera.lookAt(this._camera.target), this._camera.updateProjectionMatrix(), this._renderer.render(this._scene, this._camera), {
          lat: i,
          lon: e.lon,
          x: o,
          y: s,
      ...
      refreshSize(t, e) {
        this._canvas && (this._canvas.width = THREE.Math.ceilPowerOfTwo(this._videoElement.videoWidth || 1), this._canvas.height = THREE.Math.ceilPowerOfTwo(this._videoElement.videoHeight || 1)), this._camera.aspect = t / e, this._camera.updateProjectionMatrix(), this._renderer.setSize(t, e), this._renderer.render(this._scene, this._camera)
      }
      positionCamera(t, e) {
      ...
      async updateTexture(t) {
        return new Promise(e => {
          (new THREE.TextureLoader).load(t, t => {
            this._material.map = t, this._material.map.needsUpdate = !0, e()
          })
        })
      }
    }
  ...
  25: [function(t, e, i) {
    ...
    "./helpers/TabManager": 26,
    "./helpers/hideSiblingElements": 28,
    "./helpers/showSiblingElements": 31
  }],
  26: [function(t, e, i) {
    "use strict";
  ...
  37: [function(t, e, i) {
    ...
    "./request": 36,
    "@marcom/ac-object/toQueryParameters": 137
  }],
  38: [function(t, e, i) {
    "use strict";
    var n = t("./request"),
  ...
  41: [function(t, e, i) {
    ...
    var u = {
      ...
      d = function(t) {
        t = t || {}, this.options = r(u, t), s.call(this), this.elements = [], this.eventObserver = null, this.publishShareClick = this.publishShareClick.bind(this), this.options.autoEnable && this.enable()
      },
      p = s.prototype,
      f = d.prototype = o(p);
    f.enable = function() {
    ...
    "@marcom/ac-console": 39,
    "@marcom/ac-dom-events/addEventListener": 60,
    "@marcom/ac-dom-events/removeEventListener": 64,
    "@marcom/ac-dom-traversal/querySelectorAll": 88,
    "@marcom/ac-event-emitter-micro": 94,
    "@marcom/ac-object/create": 130,
    "@marcom/ac-object/extend": 132
  }],
  42: [function(t, e, i) {
    "use strict";
  ...
  43: [function(t, e, i) {
    ...
    "./className/add": 44,
    "@marcom/ac-polyfills/Array/prototype.slice": 142,
  ...
  50: [function(t, e, i) {
    ...
    var n = t("./select");
    e.exports = function(t) {
      return n(t), document.execCommand("copy")
    }
  }, {
    "./select": 53
  }],
  ...
  58: [function(t, e, i) {
    ...
    "./DOMEmitterEvent": 59,
    "@marcom/ac-dom-events/addEventListener": 60,
    "@marcom/ac-dom-events/dispatchEvent": 61,
    "@marcom/ac-dom-events/removeEventListener": 64,
    "@marcom/ac-dom-traversal/matchesSelector": 87,
    "@marcom/ac-dom-traversal/querySelectorAll": 88,
    "ac-event-emitter": 328
  }],
  59: [function(t, e, i) {
    "use strict";
    var n, r = {
    ...
    "@marcom/ac-dom-events/preventDefault": 63,
    "@marcom/ac-dom-events/stopPropagation": 67,
    "@marcom/ac-dom-events/target": 68
  }],
  60: [function(t, e, i) {
    "use strict";
    ...
    "./shared/getEventType": 65,
    "./utils/addEventListener": 69
  }],
  61: [function(t, e, i) {
    "use strict";
  ...
  86: [function(t, e, i) {
    ...
    "@marcom/ac-dom-nodes/COMMENT_NODE": 74,
    "@marcom/ac-dom-nodes/DOCUMENT_FRAGMENT_NODE": 75,
    "@marcom/ac-dom-nodes/DOCUMENT_NODE": 76,
    "@marcom/ac-dom-nodes/ELEMENT_NODE": 77,
    "@marcom/ac-dom-nodes/TEXT_NODE": 78,
    "@marcom/ac-dom-nodes/isNode": 83,
    "@marcom/ac-polyfills/Array/prototype.indexOf": 141
  }],
  87: [function(t, e, i) {
    "use strict";
  ...
  90: [function(t, e, i) {
    ...
    "@marcom/ac-dom-nodes/isDocumentFragment": 81,
    "@marcom/ac-dom-nodes/isElement": 82,
    "@marcom/ac-dom-nodes/remove": 84,
    "@marcom/ac-polyfills/Array/prototype.indexOf": 141
  }],
  91: [function(t, e, i) {
    "use strict";
  ...
  92: [function(t, e, i) {
    ...
    "@marcom/ac-polyfills/Array/prototype.every": 139
  }],
  93: [function(t, e, i) {
    e.exports = function(t, e, i, n) {
      function r(t, e) {
  ...
  96: [function(t, e, i) {
    ...
    "./ac-event-emitter/EventEmitter": 97
  }],
  97: [function(t, e, i) {
    "use strict";
  ...
  109: [function(t, e, i) {
    ...
    function c(t) {
      h.trigger(s.ENTERFULLSCREEN, t)
    }

    function l(t) {
      n = void 0, h.trigger(s.EXITFULLSCREEN, t)
    }
  ...
  114: [function(t, e, i) {
    ...
    "./internal/KeyEvent": 116,
    "@marcom/ac-dom-events/utils/addEventListener": 69,
    "@marcom/ac-dom-events/utils/removeEventListener": 71,
    "@marcom/ac-event-emitter-micro": 94,
    "@marcom/ac-object/create": 130
  }],
  115: [function(t, e, i) {
  ...
  119: [function(t, e, i) {
    ...
    "./ac-modal-basic/Modal": 120,
    "./ac-modal-basic/Renderer": 121,
    "./ac-modal-basic/classNames": 122,
    "./ac-modal-basic/dataAttributes": 123
  }],
  120: [function(t, e, i) {
    "use strict";
    var n = {
    ...
    function u(t, e) {
      c.call(this), this.options = o.defaults(h, t), this.renderer = new l(e), this.opened = !1, this._keysToClose = [a.ESCAPE], this._attachedKeysToClose = [], this.close = this.close.bind(this)
    }
    ...
    "@marcom/ac-dom-events/removeEventListener": 64,
    "@marcom/ac-dom-events/target": 68,
    "@marcom/ac-dom-metrics/getScrollX": 72,
    "@marcom/ac-dom-metrics/getScrollY": 73,
    "@marcom/ac-event-emitter-micro": 94,
    "@marcom/ac-keyboard": 115,
    "@marcom/ac-keyboard/keyMap": 118,
    "@marcom/ac-object/create": 130,
    "@marcom/ac-object/defaults": 131
  }],
  121: [function(t, e, i) {
    "use strict";
    var n = {
  ...
  124: [function(t, e, i) {
    ...
    "./ac-modal/Modal": 125,
    "./ac-modal/factory/createFullViewportModal": 126,
    "./ac-modal/factory/createStandardModal": 127
  }],
  125: [function(t, e, i) {
    "use strict";
    ...
    "@marcom/ac-accessibility/CircularTab": 25,
    "@marcom/ac-event-emitter-micro": 94,
    "@marcom/ac-modal-basic": 119
  }],
  126: [function(t, e, i) {
    "use strict";
    var n = t("../Modal"),
  ...
  129: [function(t, e, i) {
    ...
    "./extend": 132,
    "@marcom/ac-polyfills/Array/isArray": 138
  }],
  130: [function(t, e, i) {
    "use strict";
    var n = function() {};
  ...
  147: [function(t, e, i) {
    ...
    "./shared/camelCasedEventTypes": 148,
    "./shared/prefixHelper": 149,
    "./shared/windowFallbackEventTypes": 150,
    "./utils/eventTypeAvailable": 151
  }],
  148: [function(t, e, i) {
    "use strict";
    e.exports = {
  ...
  153: [function(t, e, i) {
    ...
    "@marcom/ac-event-emitter-micro": 94,
    "@marcom/ac-raf-emitter-id-generator/sharedRAFEmitterIDGeneratorInstance": 152,
    "@marcom/ac-raf-executor/sharedRAFExecutorInstance": 162
  }],
  154: [function(t, e, i) {
    "use strict";
    var n = t("./SingleCallRAFEmitter"),
  ...
  163: [function(t, e, i) {
    ...
    "./ac-router/History": 164,
    "./ac-router/Router": 165,
    "@marcom/ac-routes": 166
  }],
  164: [function(t, e, i) {
    "use strict";
    ...
    "@marcom/ac-dom-events": 62,
    "@marcom/ac-event-emitter": 96,
    "@marcom/ac-object": 128
  }],
  165: [function(t, e, i) {
    "use strict";
    var n = t("@marcom/ac-object").create,
  ...
  179: [function(t, e, i) {
    ...
    e.exports = {
      ...
      ShareFactory: t("./ac-social/ShareFactory"),
      AutoSocial: t("./ac-social/AutoSocial")
    }
  }, {
    "./ac-social/AutoSocial": 180,
    "./ac-social/Debug": 181,
    "./ac-social/Dialog": 182,
    "./ac-social/Focus": 183,
    "./ac-social/Link": 184,
    "./ac-social/ShareFactory": 186
  }],
  180: [function(t, e, i) {
    "use strict";
  ...
  184: [function(t, e, i) {
    ...
    "./NetworkActions": 185,
    "./network-actions/DefaultNetworkAction": 188
  }],
  185: [function(t, e, i) {
    "use strict";
    ...
    "./network-actions/EMailShare": 189,
    "./network-actions/FacebookShare": 190,
    "./network-actions/LineShare": 191,
    "./network-actions/PinterestShare": 193,
    "./network-actions/QQWeiboShare": 194,
    "./network-actions/QZoneShare": 195,
    "./network-actions/RenrenShare": 196,
    "./network-actions/TumblrShare": 197,
    "./network-actions/TwitterFavorite": 198,
    "./network-actions/TwitterReply": 199,
    "./network-actions/TwitterRetweet": 200,
    "./network-actions/TwitterTweet": 201,
    "./network-actions/VKShare": 202,
    "./network-actions/WeiboShare": 203,
    "./network-actions/WhatsAppShare": 204
  }],
  186: [function(t, e, i) {
    "use strict";
    var n = t("./Dialog"),
    ...
    function s() {
      this._buttonEvts = [], this._autoCreatedUrlEls = []
    }
    var a = s.prototype;
    a.autoCreate = function(t) {
      ...
      0 === this._autoCreatedUrlEls.length ? this._autoCreatedUrlEls = Array.prototype.slice.call(i) : (i = i.filter(this._hasNotBeenAutoCreated.bind(this)), this._autoCreatedUrlEls = this._autoCreatedUrlEls.concat(i)), i.forEach(function(t) {
        ...
        e.forEach(function(t) {
          this._createSocialButton(t, i)
        }.bind(this))
      }, this)
    }, a._hasNotBeenAutoCreated = function(t) {
      return -1 === this._autoCreatedUrlEls.indexOf(t)
    }, a._createSocialButton = function(t, e) {
      ...
      this._buttonEvts.forEach(function(t) {
        t.button.removeEventListener("click", t.callback)
      }.bind(this)), this._buttonEvts = []
    }, e.exports = new s
  }, {
    "./Dialog": 182,
    "./copy-actions/CopyToClipboard": 187
  }],
  187: [function(t, e, i) {
    "use strict";
    ...
    function r(t, e) {
      this.el = t, this.el.addEventListener("click", function() {
        n.copy(e), this._notifyTextCopied()
      }.bind(this))
    }
    r.prototype._notifyTextCopied = function() {
      var t = this.el.parentNode.querySelector("[data-ac-social-notification]");
      try {
        t.classList.add("show-notification"), setTimeout(function() {
          t.classList.remove("show-notification")
        }, 1e3)
      } catch (t) {
    ...
    var R = function(e) {
      function i(t) {
        ...
        try {
          ...
          e._maxWidth = t.maxWidth || Math.min(window.innerWidth, 1280)
        }
        return e._lastResize = 0, e._lastMouseCoords = {}, e.el.classList.add("ac-video-player"), e.el.classList.add("idle-state"), e._isLive = t.live, e._isDvr = t.dvr, e._isLive && e._useLiveMode(t.dvr), e._videoImpl = u(t, e.el), e._isResponsive = t.responsive, e._isResponsive && (e._breakpointDetect = new P({
          el: e.el,
          player: e,
          breakpoints: T,
          addClass: !0
        })), e._supportsInlineVideo = b || !(w && E), e._cachedPiPMode = e.isPictureInPicture(), e._cachedReadyState = e.getReadyState(), e._cachedVisibleTracksLength = 0, e.el.appendChild(e._videoImpl.getRenderElement()), (t.poster || void 0 === t.poster) && (e._initPoster(t.poster), t.autoplay || void 0 === t.preload || "none" !== t.preload && "metadata" !== t.preload && !1 !== t.preload || e._poster.show()), e._bindMethods(), e._addEventListeners(), b && (e._keyboardControl = A({
          player: e,
          threesixty: t.threesixty,
          keyboardTarget: t.keyboardTarget
        })), t.controls && e._initUIComponents(), e._initErrorView(), t.parentElement && t.parentElement.appendChild(e.el), e._chapterEmitter = new l(t), e.refreshSize = e.refreshSize.bind(e), e._setPersistedUserSettings(), e._refreshSizeTimeout = setTimeout(e.refreshSize, 0), window.addEventListener("DOMContentLoaded", e.refreshSize), e
      }
      return function(t, e) {
        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function, not " + typeof e);
        t.prototype = Object.create(e && e.prototype, {
        ...
        key: "_forwardEvent",
        value: function(t) {
          S(t.type + " time:" + this.getCurrentTime()), this.trigger(t.type)
        }
      }, {
        key: "_forwardNamedEvent",
        value: function(t) {
          S(t + " time:" + this.getCurrentTime()), this.trigger(t)
        }
      }, {
        key: "_onPlayPromiseError",
        value: function() {
          S("play() Promise rejected, probably because the browser is blocking autoplay"), this.el.classList.add("initial-play"), this._showStartState(), this._started = !1, this._poster.show(), this.once("play", this._onPlay)
        }
      }, {
        ...
        value: function(t) {
          ...
          if (this._forwardEvent(t), this._storedAudioTrackType && this._storedAudioTrackLanguage && this.getAudioTracks().length > 1) {
            var i = this.getAudioTracks().find(function(t) {
              return t.language === e._storedAudioTrackLanguage && t.kind === e._storedAudioTrackType
            });
            i && (i.enabled = !0), this._storedAudioTrackLanguage = null
          }
          var n = this.getAudioTracks().find(function(t) {
            return t.enabled
          });
        ...
        value: function(t) {
          ...
          if (!this._cachedVisibleTracksLength && "none" !== this._storedCCLanguage && this.getTextTracks().length > 0) {
            var n = this.getTextTracks().find(function(t) {
              return t.language === e._storedCCLanguage || s[t.language] === e._storedCCLanguage
            });
            n && (setTimeout(function() {
              e.getTextTracks().forEach(function(t) {
                n !== t && (t.mode = "hidden")
              }), n.mode = "showing", setTimeout(function() {
                0 === n.cues.length && (n.mode = "hidden", n.mode = "showing")
              }, 1)
            }, 1), this._storedCCLanguage = "none")
          }
        ...
        key: "_onVolumeChange",
        value: function(t) {
          h.setItem(h.VOLUME_LEVEL, this.getVolume()), h.setItem(h.VOLUME_MUTED, this.getMuted())
        }
      }, {
        key: "_onTimeUpdate",
        value: function() {
        ...
        value: function(t, e, i, n) {
          if (this._setError(!1), this.refreshSize(), this._started = !1, Array.isArray(t) || (t = [t]), e && !Array.isArray(e) && (e = [{
              src: e
          ...
          this.once("play", this._onPlay), (this.options.autoplay && b || this.getEnded()) && this.once("loadstart", function() {
            this.play()
          }.bind(this)), n || (n = this.options), n && this._poster && this.setPoster(n.poster), this._poster && this._poster.show(), this.controls && this.controls.sharingModule && (n.sharing ? this.controls.sharingModule.setData(n.sharing) : this.controls.sharingModule.setData(null)), void 0 !== n.live && (this._isLive = n.live, this._useLiveMode(n.dvr)), this._hideEndState(), this._setPersistedUserSettings(), this._videoImpl.load(t, e, i), this.controls && this.controls.overlays ? this.controls.overlays.setData(s) : this.controls && this.once("controlsready", function() {
        ...
        value: function() {
          return b ? this.el : this.getMediaElement()
        }
      }, {
        key: "getFullScreenEnabled",
        value: function() {
          return p.fullscreenEnabled(this.getFullScreenElement())
        }
      }, {
        key: "isFullscreen",
        value: function() {
          return b ? p.fullscreenElement() === this.getFullScreenElement() : this._videoImpl.isFullscreen()
        }
      }, {
        ...
        value: function() {
          if (!this.isFullscreen()) {
            this.controls && (this.controls.el.display = "none", this._hideControls()), this.trigger("fullscreen:willenter", {
              type: "enter"
            }), this._lastResize = Date.now(), y(this._updateFullscreenId);
            var t = this;
            this._updateFullscreenId = v(function e() {
              t.refreshSize(), t._updateFullscreenId = v(e)
            }), x ? setTimeout(function() {
              this._lastResize = Date.now(), p.requestFullscreen(this.getFullScreenElement())
            }.bind(this), 300) : p.requestFullscreen(this.getFullScreenElement())
          }
        }
      }, {
        key: "exitFullscreen",
        value: function() {
          this.isFullscreen() && (this.controls && (this.controls.el.display = "none", this._hideControls()), this.trigger("fullscreen:willexit", {
            ...
            p.exitFullscreen(this.getFullScreenElement())
          }.bind(this), 300) : p.exitFullscreen(this.getFullScreenElement()))
        }
      }, {
        ...
        value: function() {
          this._lastResize = Date.now(), this.controls && (this.controls.el.display = "", this._hideControls()), this._preventUserInteraction = !0, setTimeout(function() {
            y(this._updateFullscreenId), this._preventUserInteraction = !1, this.refreshSize()
        ...
        value: function() {
          this._controlsFactory ? (this._instantiateDefaultCustomUIControls(), b ? this.el.appendChild(this._blockade.el) : (this.controls.el.classList.add("mobile"), this.setControls(!0))) : this.setControls(!0)
        }
      }, {
        key: "_showControls",
        value: function() {
        ...
        value: function() {
          this.options.autoplay && b || this._showStartState()
        }
      }, {
        key: "_showStartState",
        value: function() {
          this.controls && this.controls.el.classList.add("start-state"), this._poster && this._poster.show(), b || M(this.getMediaElement())
        }
      }, {
        key: "_hideStartState",
        value: function() {
          this.controls && this.controls.el.classList.remove("start-state"), this._poster && this._poster.hide(), b || F(this.getMediaElement())
        }
      }, {
        key: "_showEndState",
        value: function() {
          this.controls && (this.controls.mainControlsElement ? this.controls.mainControlsElement.contains(document.activeElement) && setTimeout(function() {
            ...
            this.controls.playButtonElement.focus()
          }.bind(this)), this.controls.el.classList.add("end-state")), this._poster && this._poster.show(), M(this.getMediaElement())
        }
      }, {
        key: "_hideEndState",
        value: function() {
          this.controls && this.controls.el.classList.remove("end-state"), b || F(this.getMediaElement())
        }
      }, {
        key: "_createBlockade",
        value: function() {
          this._blockade = new c(document.createElement("div")), this._blockade.el.classList.add("ac-video-blockade")
        }
      }, {
        ...
        value: function() {
          ...
          }), this.controls.el.parentNode !== this.el && this.el.appendChild(this.controls.el), this._videoImpl.setControls(!1), this._createBlockade(), this._controlsInteraction = D({
            player: this,
        ...
        value: function() {
          this.controls.axListSelector.style.maxHeight = "min(" + (this.el.getBoundingClientRect().height - 80) + "px,250px)", this.controls.el.classList.add("captions-selector-showing")
        }
      }, {
        ...
        key: "_onStart",
        value: function() {
          this._started = !0, this.el.classList.add("initial-play"), this.el.classList.remove("idle-state"), this._poster && this._poster.hide(), this.controls && (this._hideStartState(), this._hideEndState()), this.once("ended", this._onEnded)
        }
      }, {
        key: "_onEnded",
        value: function() {
          ...
          }.bind(this), 300), this._poster && this._poster.show(), this._started = !1
        }
      }, {
        key: "_initPoster",
        value: function(t) {
        ...
        key: "_initErrorView",
        value: function() {
          this._errorView = new _, this.el.appendChild(this._errorView.el)
        }
      }, {
        key: "_useLiveMode",
        value: function(e) {
          var i = this;
          clearInterval(this._captionRemovalInterval), this._isLive ? (this.el.classList.add("ac-video-live"), e && !C ? this.el.classList.add("ac-video-live-dvr") : k && (this._captionRemovalInterval = setInterval(function() {
            t("../utils/removeStateCaptions")(i.getMediaElement())
          }, 1e4))) : (this.el.classList.remove("ac-video-live"), this.el.classList.remove("ac-video-live-dvr"))
        }
      }, {
        key: "once",
        value: function(t, e, n) {
          if (arguments.length < 3 || "object" === (void 0 === n ? "undefined" : r(n)))(function t(e, i, n) {
            null === e && (e = Function.prototype);
            var r = Object.getOwnPropertyDescriptor(e, i);
            if (void 0 === r) {
              var o = Object.getPrototypeOf(e);
        ...
        value: function() {
          ...
          S("play called"), !this._videoImpl.getError() || 0 !== e && !isNaN(e) ? this._videoImpl.play() : setTimeout(function() {
            t._errorView.focus()
          }, 1e3)
        }
      }, {
        ...
        key: "refreshSize",
        value: function() {
          this._breakpointDetect ? this._breakpointDetect.refresh() : (this._currentBreakpoint && this.el.classList.remove(this._currentBreakpoint.name), this._currentBreakpoint = P.getBreakpointFromElement(this.el, T), this.el.classList.add(this._currentBreakpoint.name)), this._videoImpl && this._videoImpl.refreshSize()
        }
      }, {
        key: "_setError",
        value: function(t) {
        ...
        value: function(t) {
          ...
          if (this._started) S("ERROR: an error occured during playback, but we'll try to recover. Error code " + (e ? e.message : "unknown"));
            ...
            if (t.message) i = t.message;
              ...
              if (!m.translationReady()) return void m.getTranslation({
        ...
        key: "destroy",
        value: function() {
          this._removeEventListeners(), clearInterval(this._captionRemovalInterval), this.controls && (this.controls.destroy(), this.controls = null), this._poster && (this._poster.destroy(), this._poster = null), this._controlsInteraction && (this._controlsInteraction.destroy(), this._controlsInteraction = null), this._keyboardControl && this._keyboardControl.destroy(), this.el.innerHTML = "", this._breakpointDetect && this._breakpointDetect.destroy(), this._chapterEmitter && this._chapterEmitter.destroy(), this._blockade && (this._blockade = null), this._videoImpl.destroy(), this._videoImpl = null, clearTimeout(this._refreshSizeTimeout), a.prototype.destroy.call(this)
        }
      }]), i
    }();
    R.LOADEDMETADATA = 1, R.LOADEDDATA = 2, R.CANPLAY = 3, R.CANPLAYTHROUGH = 4, e.exports = R
  }, {
    "../chapters/ChapterEmitter": 208,
    "../dom-emitter/DOMEmitterMicro": 209,
    "../event-emitter-shim/EventEmitterShim": 210,
    "../posterframe/PosterFrameFactory": 219,
    "../ui/DefaultBreakpoints": 230,
    "../ui/controls-interaction/createControlsInteraction": 252,
    "../ui/error/ErrorView": 263,
    "../ui/keyboard-control/createKeyboardControl": 269,
    "../ui/localization/LanguageMapping": 272,
    "../ui/localization/Localization": 273,
    "../utils/BreakpointDetect": 286,
    "../utils/Storage": 287,
    "../utils/getVersion": 289,
    "../utils/removeStateCaptions": 293,
    "../video/VideoFactory": 304,
    "./event/EventsToForward": 214,
    "./event/ReadyStateChangeEvents": 215,
    "@marcom/ac-accessibility/helpers/hide": 27,
    "@marcom/ac-accessibility/helpers/show": 30,
    "@marcom/ac-console/log": 56,
    "@marcom/ac-feature/isDesktop": 99,
    "@marcom/ac-feature/isHandheld": 100,
    "@marcom/ac-feature/isRetina": 101,
    "@marcom/ac-feature/touchAvailable": 103,
    "@marcom/ac-fullscreen": 105,
    "@marcom/ac-raf-emitter/cancelUpdate": 158,
    "@marcom/ac-raf-emitter/update": 160,
    "@marcom/useragent-detect": 327
  }],
  213: [function(t, e, i) {
    "use strict";
    ...
    var o = t("./Player"),
      ...
      l = function(t) {
        ...
        return function(t, e) {
          ...
          key: "play",
          value: function() {
            this.get360().requestOrientationControl(), r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "play", this).apply(this, arguments)
          }
        }, {
          key: "_bindMethods",
          value: function() {
  ...
  216: [function(t, e, i) {
    ...
    "../../optimizeVideoUrl": 211,
    "../../ui/ControlBar": 228,
    "../../ui/ControlsFactory": 229,
    "../../ui/DefaultComponents": 231,
    "../Player": 212,
    "../ThreeSixtyPlayer": 213,
    "@marcom/ac-feature/isDesktop": 99
  }],
  217: [function(t, e, i) {
    "use strict";
  ...
  221: [function(t, e, i) {
    ...
    "../ui/elements/Label": 255,
    "../ui/factory/createComponents": 265,
    "./TextTracksBehavior": 220,
    "@marcom/ac-event-emitter-micro": 94
  }],
  222: [function(t, e, i) {
    "use strict";
  ...
  224: [function(t, e, i) {
    ...
    "./TextTracksNative": 222,
    "./TextTracksPolyfill": 223,
    "@marcom/useragent-detect": 327
  }],
  225: [function(t, e, i) {
    "use strict";
  ...
  226: [function(t, e, i) {
    ...
    e.exports = function(t) {
      ...
      return t.filter(function(t) {
        return !(e.has(t.label) || "subtitles" !== t.kind && "captions" !== t.kind && t.kind) && (e.add(t.label), !0)
      })
    }
  }, {}],
  227: [function(t, e, i) {
  ...
  228: [function(t, e, i) {
    ...
    var n = t("@marcom/ac-string/supplant"),
      ...
      _ = m.prototype;
    _._initialize = function(t) {
      this.el = t.element || document.createElement("div"), this._basePath = t.basePath, this._forceEnglishLabels = t.forceEnglishLabels, this.el.style.display = "none", this._template = t.template || f, this._templateData = t.templateData || Object.assign({
      ...
      r && (this.endState = new h(Object.assign({}, {
        el: r,
        player: this._player
      ...
      this._componentCollection && (this._componentCollection.destroy(), this._componentCollection = null), this._loadingIndicator && (this._loadingIndicator.destroy(), this._loadingIndicator = null), this.overlays && this.overlays.destroy(), this._destroyed = !0, this._player = null, this._templateData = null
    }, e.exports = m
  }, {
    "../utils/Time": 288,
    "../utils/merge": 292,
    "./compass/Compass": 248,
    "./end-state/EndStateItemContainer": 262,
    "./factory/createComponents": 265,
    "./loading-indicator/LoadingIndicator": 270,
    "./localization/Localization": 273,
    "./overlays/OverlayContainer": 275,
    "./templates/default-controls.html": 279,
    "@marcom/ac-feature/isDesktop": 99,
  ...
  231: [function(t, e, i) {
    ...
    "./behaviors/AirPlayButtonBehavior": 232,
    "./behaviors/AudioTracksSelectorBehavior": 233,
    "./behaviors/CaptionsButtonBehavior": 236,
    "./behaviors/CaptionsSelectorBehavior": 237,
    "./behaviors/FullScreenButtonBehavior": 238,
    "./behaviors/LiveButtonBehavior": 239,
    "./behaviors/MuteButtonBehavior": 240,
    "./behaviors/PictureInPictureButtonBehavior": 241,
    "./behaviors/PlayPauseButtonBehavior": 242,
    "./behaviors/ProgressBarSliderBehavior": 243,
    "./behaviors/SharingButtonBehavior": 244,
    "./behaviors/SocialContainerBehavior": 245,
    "./behaviors/VolumeSliderBehavior": 246,
    "./elements/Button": 253,
    "./elements/Container": 254,
    "./elements/Label": 255,
    "./elements/ListSelector": 256,
    "./elements/Slider": 257,
    "./elements/StatefulButton": 258,
    "./elements/ToggleButton": 259,
    "./elements/mixins/CursorPointer": 260,
    "./templates/progress-slider.html": 281,
    "./templates/volume-slider.html": 285
  }],
  232: [function(t, e, i) {
    "use strict";
    var n = function() {
    ...
    var r = t("./BaseBehavior"),
      ...
      s = function(t) {
        ...
        return function(t, e) {
          ...
          value: function() {
            this._updateState = this._updateState.bind(this), this._player.on("AudioTrackChange", this._updateState), this._player.on("loadedmetadata", this._updateState), this._player.on("playing", this._updateState), this._player.on("play", this._updateState)
          }
        }, {
          key: "_updateState",
          value: function() {
            var t = function(t) {
              var e = [],
                i = function(t) {
                  e.some(function(e) {
                    return e.language === t.language && e.kind === t.kind
                  }) || e.push(t)
                },
                n = !0,
                r = !1,
                o = void 0;
              try {
                for (var s, a = t[Symbol.iterator](); !(n = (s = a.next()).done); n = !0) i(s.value)
              } catch (t) {
                r = !0, o = t
              } finally {
                try {
          ...
          value: function(t) {
            var e = t.detail;
            this._player.getAudioTracks().forEach(function(t) {
              return t.enabled = !1
            }), e.enabled = !0, setTimeout(this._updateState)
          }
        }, {
          key: "destroy",
          value: function() {
            this._player.off("loadedmetadata", this._updateState), this._player.off("playing", this._updateState), this._player.off("play", this._updateState), this._player.off("AudioTrackChange", this._updateState)
          }
        }]), e
      }();
    e.exports = s
  }, {
    "../localization/LanguageMapping": 272,
    "./BaseBehavior": 234
  }],
  234: [function(t, e, i) {
    "use strict";
  ...
  236: [function(t, e, i) {
    ...
    "../../texttracks/getFilteredTextTracks": 226,
    "../../utils/Storage": 287,
    "./ButtonBehavior": 235
  }],
  237: [function(t, e, i) {
        ...
        return function(t, e) {
          ...
          value: function() {
            var t = this,
              ...
              i = h(this._player.getTextTracks()).map(function(i) {
                ...
                i.label && "en" !== i.language && "English" !== i.language && i.label !== i.language && (n = i.label ? i.label + " (" + (l[i.language] || i.language) + ")" : (l[i.language] || i.language) + " " + ("description" === i.kind ? " AD" : "")), ("showing" === i.mode || r.length && r.some(function(t) {
                  return "showing" === t.mode
                })) && (e = !1);
                var o = {
                ...
                return Object.defineProperty(o, "enabled", {
                  get: function() {
                    var t = "hidden";
                    return ("showing" === i.mode || r.length && r.some(function(t) {
                      return "showing" === t.mode
                    })) && (t = "showing"), "showing" === t
                  },
                  set: function(t) {
          ...
          value: function(t) {
            ...
            this._player.getVisibleTextTracks().forEach(function(t) {
              t.mode = "hidden"
            }), e.language !== r ? (e.enabled = !0, d.removeItem("cc-disabled")) : d.setItem("cc-disabled", !0), a && this._player.getMediaElement().textTracks.dispatchEvent(new CustomEvent("change")), setTimeout(this._updateState)
          }
        }, {
          key: "destroy",
          value: function() {
    ...
    "../../texttracks/findMatchingTextTracks": 225,
    "../../texttracks/getFilteredTextTracks": 226,
    "../../utils/Storage": 287,
    "../localization/LanguageMapping": 272,
    "../localization/Localization": 273,
    ...
    var r = t("./ButtonBehavior"),
      ...
      s = function(t) {
        function e(t, i) {
          ...
          return n._updateState = n._updateState.bind(n), n._player.on("timeupdate", n._updateState), n
        }
        return function(t, e) {
          if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function, not " + typeof e);
          t.prototype = Object.create(e && e.prototype, {
          ...
          key: "_updateState",
          value: function() {
            this._player.getDuration() - this._player.getCurrentTime() < o ? this._view.setState("on") : this._view.setState("off")
          }
        }, {
          key: "_onClick",
          value: function() {
  ...
  243: [function(t, e, i) {
    ...
    var r = t("./BaseBehavior"),
      ...
      l = function(t) {
        function e(t, i) {
          ...
          return n._player.isDvr() ? n._liveStreamLookback = c : n._liveStreamLookback = 0, n._visible = !1, n._ariaTextTemplate = i.localization.currenttimetext, n._onDurationChange(), n._refreshChapters(), n
        }
        return function(t, e) {
          if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function, not " + typeof e);
          t.prototype = Object.create(e && e.prototype, {
          ...
          value: function() {
            ...
            t && !isNaN(t) && t !== Math.Infinity ? this._view.setChapters(this._player.getChapters().map(function(e) {
              ...
              return Object.assign({}, e, {
                ...
                startTime: i,
                "start-time": parseFloat(e["start-time"])
              })
          ...
          key: "_getDuration",
          value: function() {
            return this._cachedDuration && isNaN(this._cachedDuration) || (this._cachedDuration = Math.max(0, this._player.getDuration() - this._liveStreamLookback)), this._cachedDuration
          }
        }, {
          ...
          key: "_onDurationChange",
          value: function() {
            this._cachedDuration = Math.max(0, this._player.getDuration() - this._liveStreamLookback), this._updateSliderPosition(this._getTimeAsPercent()), this._player.getPaused() || this._onPlay(), this._refreshChapters(), 0 === this._cachedDuration || isNaN(this._cachedDuration) ? this._view.hide() : this._view.show()
          }
        }, {
          key: "_onSliderChange",
          value: function() {
    ...
    "../../utils/liveStreamLookback": 290,
    "./BaseBehavior": 234,
    "@marcom/ac-raf-emitter/cancelDraw": 157,
      ...
      h = function(t) {
        function e(t) {
          ...
          return i._span = document.createElement("span"), i._span.innerText = c(r, {
            ...
            chaptertime: c(l.getTranslation().currenttimetext, {
              minutes: u,
              seconds: d
            })
    ...
    var o = t("./ThreeSixtyControlsInteraction"),
      s = function(t) {
        ...
        return function(t, e) {
          ...
          key: "_onDragging",
          value: function(t) {
            r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_onDragging", this).call(this, t)
          }
        }, {
          key: "_shouldIgnoreUserInteraction",
          value: function(t) {
  ...
  252: [function(t, e, i) {
    ...
    "./DefaultControlsInteraction": 249,
    "./ThreeSixtyControlsInteraction": 250,
    "./ThreeSixtyMobileControlsInteraction": 251,
    "@marcom/useragent-detect": 327
  }],
  253: [function(t, e, i) {
    "use strict";
  ...
  257: [function(t, e, i) {
    ...
    }, s.setBufferedValue = function(t) {
      this._bufferedTrack.style.left = t + "%"
    ...
    "../chapters/ChapterView": 247,
    "@marcom/ac-slider": 172
  }],
  258: [function(t, e, i) {
    "use strict";
    var n = function() {
    ...
    var r = t("../localization/Localization"),
      ...
      a = function() {
        function t(e) {
          ...
          ! function(t, e) {
            if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
          }(this, t), this._player = e.player, this.el = e.el, this.el.innerHTML = o, this._ariaSpan = this._player.controls.el.querySelector("#loading-status"), this._ariaString = "", r.getTranslation({
            callback: function(t) {
              i._ariaString = t.loading, i._isShowing() && (i._ariaSpan.innerText = i._ariaString)
            }
          }), this._showTimeoutDelay = void 0 !== e.showTimeoutDelay ? e.showTimeoutDelay : s, this._bindMethods(), this._addEventListeners()
        }
        return n(t, [{
          key: "_bindMethods",
          value: function() {
            this.show = this.show.bind(this), this.hide = this.hide.bind(this), this._onPlaying = this._onPlaying.bind(this), this._onSeeking = this._onSeeking.bind(this), this._onSeeked = this._onSeeked.bind(this), this._onPause = this._onPause.bind(this), this._onEnded = this._onEnded.bind(this), this._onError = this._onError.bind(this), this._doShow = this._doShow.bind(this), this._checkLoadingState = this._checkLoadingState.bind(this), this._onPlay = this._onPlay.bind(this), this._onMouseOut = this._onMouseOut.bind(this)
          }
        }, {
          key: "_addEventListeners",
          value: function() {
            this._player.on("waiting", this.show), this._player.on("seeking", this._onSeeking), this._player.on("seeked", this._onSeeked), this._player.on("playing", this._onPlaying), this._player.on("ended", this._onEnded), this._player.on("canplaythrough", this._checkLoadingState), this._player.on("progress", this._checkLoadingState), this._player.on("error", this._onError), this._player.on("pause", this._onPause), this._player.on("timeupdate", this._checkLoadingState), this._player.on("play", this._onPlay), this._player.controls && this._player.controls.el.addEventListener("mouseout", this._onMouseOut)
          }
        }, {
          key: "_removeEventListeners",
          value: function() {
            this._player.off("waiting", this.show), this._player.off("seeking", this._onSeeking), this._player.off("seeked", this._onSeeked), this._player.off("playing", this._onPlaying), this._player.off("ended", this._onEnded), this._player.off("canplaythrough", this._checkLoadingState), this._player.off("progress", this._checkLoadingState), this._player.off("error", this._onError), this._player.off("pause", this._onPause), this._player.off("timeupdate", this._checkLoadingState), this._player.off("play", this._onPlay), this.el.removeEventListener("click", this._onClick), this._player.controls && this._player.controls.el.removeEventListener("mouseout", this._onMouseOut)
          }
        }, {
          key: "_onPause",
          value: function() {
            this._isPaused = this._player.getPaused(), this._isPaused && this.hide()
          }
        }, {
          key: "_onPlaying",
          value: function() {
            this._isPaused = this._player.getPaused(), this._started = !0, this._checkLoadingState()
          }
        }, {
          key: "_onPlay",
          value: function() {
            !this._isPaused && this._started || (this._isPaused = this._player.getPaused(), this._isPaused || (this._started = !0), this._isSeeking = !1, this._checkLoadingState(!0))
          }
        }, {
          key: "_onSeeking",
          value: function() {
            this._isSeeking = !0, this.show()
          }
        }, {
          key: "_onSeeked",
          value: function() {
          ...
          key: "show",
          value: function(t) {
            this._isPaused || (!0 !== t && this._started ? (clearTimeout(this._showTimeout), this._showTimeout = setTimeout(this._doShow, this._showTimeoutDelay)) : this._doShow())
          }
        }, {
          key: "_checkLoadingState",
          value: function(t) {
            !this._player.getEnded() && this._started && (this._player.isStalled() || this._isSeeking) ? this.show(!0 === t) : this.hide()
          }
        }, {
          key: "_isShowing",
          value: function() {
          ...
          key: "_doShow",
          value: function() {
            this._player.el.classList.add("loading"), this._player.el.classList.remove("was-loading"), this._ariaSpan.innerText = this._ariaString
          }
        }, {
          key: "hide",
          value: function() {
            clearTimeout(this._showTimeout), this._isShowing() && (this._player.el.classList.remove("loading"), this._player.el.classList.contains("user-hover") || this._player.el.classList.add("was-loading"), this._ariaSpan.innerText = "")
          }
        }, {
          key: "destroy",
          value: function() {
  ...
  273: [function(t, e, i) {
    ...
    e.exports = {
      ...
      getTranslation: function(t) {
        ...
        return t.forceEnglishLabels ? (u(), c[e]) : (a.get(o, {
          success: function(i) {
            try {
  ...
  276: [function(t, e, i) {
    ...
    var n = t("../templates/overlays/trickplay-overlay.html"),
      ...
      c = function(t) {
        this._player = t.player, this.el = document.createElement("div"), this.el.style.opacity = "0", this.el.innerHTML = n, this._player.isDvr() ? this._liveStreamLookback = a : this._liveStreamLookback = 0, this._thumbnailHandler = new o({
    ...
    l._initPointerTracking = function() {
    ...
    }, l._getDuration = function() {
      return this._cachedDuration && isNaN(this._cachedDuration) || (this._cachedDuration = Math.max(0, this._player.getDuration() - this._liveStreamLookback)), this._cachedDuration
    }, l.setPopUpPosition = function(t) {
      this.show();
    ...
    }, l._onScrubberFocusOut = function(t) {
      this.hide()
      ...
      this._cachedDuration = Math.max(0, this._player.getDuration() - this._liveStreamLookback), this._cachedTrackerUpdate && (this._onTrackerUpdate(this._cachedTrackerUpdate), this._setThumbnail()), this.el.style.opacity = "1"
    }, l._setThumbnail = function(t) {
      this._thumbnailHandler.setTime(this._time, this._getDuration())
    }, l._setTimeFromPercentPosition = function(t) {
    ...
    "../../utils/Time": 288,
    "../../utils/liveStreamLookback": 290,
    "../templates/overlays/trickplay-overlay.html": 280,
    "./ThumbnailHandler": 277,
    "@marcom/function-utils/throttle": 323
  }],
  277: [function(t, e, i) {
    "use strict";
    var n = function(t) {
  ...
  278: [function(t, e, i) {
    ...
    var n = t("../templates/states/SharingState.html"),
      ...
      u = void 0;
    try {
      u = t("@marcom/ac-analytics-share/factory/create")
    } catch (t) {
    ...
    m._initializeElement = function(t, e) {
      ...
      this._doFacebookShare = this._doSocialShare.bind(this, a.FACEBOOK_SHARE), this._doTwitterShare = this._doSocialShare.bind(this, a.TWITTER_TWEET), this._doLineShare = this._doSocialShare.bind(this, a.LINE_SHARE), this._copyUrl = this._copyUrl.bind(this), this._copyEmbedCode = this._copyEmbedCode.bind(this), this._closeCopyArea = this._showTextArea.bind(this, !1), this._closeState = this._closeState.bind(this)
      ...
      this._facebookButton && this._facebookButton.removeEventListener("click", this._doFacebookShare), this._twitterButton && this._twitterButton.removeEventListener("click", this._doTwitterShare), this._lineButton && this._lineButton.removeEventListener("click", this._doLineShare), this._copyLinkButton && this._copyLinkButton.removeEventListener("click", this._copyUrl), this._copyEmbedCodeButton && this._copyEmbedCodeButton.removeEventListener("click", this._copyEmbedCode), this._copyCloseButton && this._copyCloseButton.removeEventListener("click", this._closeCopyArea), this._closeButton && this._closeButton.removeEventListener("click", this._closeState)
    }, m._syncSocialShareHidden = function() {
      this._facebookButton && (this._hideFacebook ? this._facebookButton.classList.add("hide-button") : this._facebookButton.classList.remove("hide-button")), this._twitterButton && (this._hideTwitter ? this._twitterButton.classList.add("hide-button") : this._twitterButton.classList.remove("hide-button")), this._lineButton && (this._hideLine ? this._lineButton.classList.add("hide-button") : this._lineButton.classList.remove("hide-button"))
      ...
      this._firstButton || (this._firstButton = h.getTabbableElements(this._sharingButtonContainer)[0]), this._firstButton.focus()
    }, m.show = function() {
    ...
    "../localization/Localization": 273,
    "../templates/states/IFrameEmbed.html": 283,
    "../templates/states/SharingState.html": 284,
    "@marcom/ac-accessibility/helpers/TabManager": 26,
    "@marcom/ac-analytics-share/factory/create": 42,
    "@marcom/ac-clipboard/select": 53,
    "@marcom/ac-console/log": 56,
    "@marcom/ac-social": 179,
    "@marcom/ac-string/supplant": 205,
    "@marcom/useragent-detect": 327
  }],
  279: [function(t, e, i) {
  ...
  287: [function(t, e, i) {
    ...
    e.exports = {
      setItem: function(t, e) {
        return localStorage.setItem("acv-" + t, e)
      },
      getItem: function(t) {
        return localStorage.getItem("acv-" + t)
      },
      hasItem: function(t) {
        return null !== localStorage.getItem("acv-" + t)
      },
      removeItem: function(t) {
        return localStorage.removeItem("acv-" + t)
      },
  ...
  298: [function(t, e, i) {
    ...
    e.exports = {
      getVideoSource: function(t, e, i, a) {
        ...
        0 === e && (e = y.width), i && (l = l.filter(function(t) {
          return t.type === i
        })), w < 1920 && (l = l.filter(function(t) {
          return t.width <= w
        })), (g = v ? l.reduce(function(t, i) {
          return Math.abs(i.height - e) < Math.abs(t.height - e) ? i : t
        }) : l.reduce(function(t, i) {
          return Math.abs(i.width - e) < Math.abs(t.width - e) ? i : t
        })).extension = t.indexOf(".m3u8") >= 0 ? "m3u8" : "mp4";
      ...
      getThumbnailImageSource: function(t) {
        return t.match(l) ? {
          url: t.replace(a, "_thumbnails.jpg")
        } : null
      }
    }
  }, {
    ...
    var o = window.Hls,
      ...
      u = function(t) {
        function e(t) {
          ...
          return i._src = null, i._hlsUrl = t.hlsUrl || c, i._hlsConfig = t.hlsConfig || {}, i._initialize(t), i
        }
        return function(t, e) {
          if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function, not " + typeof e);
          t.prototype = Object.create(e && e.prototype, {
          ...
          value: function(t) {
            var e = this;
            void 0 === o && (this._deferredQueue = [], l(this._hlsUrl).then(function() {
              o = window.Hls, e._initialize(t), e._deferredQueue.forEach(function(t) {
                t()
              }), e._deferredQueue = null
            })), this._debugHls = t.debugHls, this._enablePerformanceLogging = t.enablePerformanceLogging, this._onHlsError = this._onHlsError.bind(this), this._onDesiredRateChanged = this._onDesiredRateChanged.bind(this), this._onPlay = this._onPlay.bind(this), this.on("play", this._onPlay)
          }
        }, {
          key: "_initHls",
          value: function() {
            if (this._hls) {
              this._cachedVisibleTracks = Array.from(this.el.textTracks).filter(function(t) {
                return "showing" === t.mode
            ...
            i.default = Object.assign({}, i.default), i.default.reportCDNServer = !1, this._hls = new o(Object.assign({
          ...
          value: function(t, e) {
            if (o) {
              ...
              var i = function() {
                this._mediaAttached = !0, this._hls.off(o.Events.MEDIA_ATTACHED, i), this.setSrc(t[0]), this._createTextTrackTags(e)
              }.bind(this);
          ...
          key: "setSrc",
          value: function(t) {
            o ? (this._hls || this._initHls(), this._src = t, this._manifestParsed = !1, this._hls.loadSource(t, {
              appData: {}
            ...
            }.bind(this))) : this._deferredQueue.push(this.setSrc.bind(this, t))
          }
        }, {
          key: "getCurrentTime",
          value: function() {
            var t = r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "getCurrentTime", this).call(this);
            return t < .1 ? 0 : t
          }
        }, {
          key: "getCurrentSrc",
          ...
          value: function() {
            this._hls && void 0 !== this._hls.desiredRate && (this._hls.desiredRate = 0), r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_playPromiseRejected", this).call(this)
          }
        }, {
          key: "_onPlay",
          value: function() {
          ...
          value: function() {
            if (this._hls && this._hls.audioTracks) {
              var t = this._hls.audioTrack,
                i = this._hls;
              return this._hls.audioTracks.map(function(e) {
                var n = {
                  label: e.name,
                  kind: e.characteristics.some(function(t) {
                    return "public.accessibility.describes-video" === t
                  }) ? "description" : "main",
                  language: e.lang,
                  _hlsTrack: e
                };
                return Object.defineProperty(n, "enabled", {
                  ...
                  set: function(t) {
                    t && (i.audioTrackController.audioTrack = e.id)
                  }
                }), n
              })
            }
          ...
          key: "destroy",
          value: function() {
            this.off("play", this._onPlay), r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "destroy", this).call(this), this._hls && (this._hls.off(o.Events.AUDIO_TRACK_SWITCHED, this._forwardAudioTrackChangeEvent), this._hls.off(o.Events.AUDIO_TRACKS_UPDATED, this._forwardAudioTrackChangeEvent), this._hls.destroy(), this._hls = null)
          }
        }, {
          key: "_onHlsError",
          value: function(t, e) {
          ...
          key: "play",
          value: function() {
            this._shouldPlay = !0, this._manifestParsed && (this._mediaAttached || this.load([this._src]), r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "play", this).call(this))
          }
        }, {
          key: "pause",
          value: function() {
          ...
          key: "isStalled",
          value: function() {
            return void 0 !== this._hls.desiredRate && 1 === this._hls.desiredRate && this._hls.desiredRate !== this._hls.effectiveRate || r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "isStalled", this).call(this)
          }
        }, {
          key: "goToLive",
          value: function() {
            this.setCurrentTime(Math.max(this._hls.liveSyncPosition, this.getDuration() - a / 2))
          }
        }]), e
      }();
    e.exports = u
  ...
  300: [function(t, e, i) {
        ...
        return function(t, e) {
          ...
          value: function(t, e, i) {
            i && (t = t.map(function(t) {
              return t + "#t=" + i
            })), this.el.textTracks.length && (this._cachedVisibleTracks = Array.from(this.el.textTracks).filter(function(t) {
              return "showing" === t.mode
          ...
          key: "setMuted",
          value: function(t) {
            this.el.muted = t, t ? this.el.setAttribute("muted", "") : this.el.removeAttribute("muted")
          }
        }, {
          key: "getEnded",
          value: function() {
            ...
            if (this._cachedVisibleTracks) {
              if (!this._cachedVisibleTracks.length) {
                var e = !0,
                  ...
                  n = void 0;
                try {
                  for (var r, o = Array.from(this.el.textTracks)[Symbol.iterator](); !(e = (r = o.next()).done); e = !0) {
                    r.value.mode = "hidden"
                  }
                } catch (t) {
                  i = !0, n = t
    ...
    "../dom-emitter/DOMEmitterMicro": 209,
    "../texttracks/createTextTracks": 224,
    "@marcom/ac-console/log": 56,
    "@marcom/useragent-detect": 327
  }],
  301: [function(t, e, i) {
    ...
    var n = t("./HTML5Video"),
      ...
      o = function(t) {
        function e(t) {
          ...
          return i._super = n.prototype, i._init(t), i
        }
        return function(t, e) {
          if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function, not " + typeof e);
          t.prototype = Object.create(e && e.prototype, {
      ...
      c = void 0;
    try {
      for (var l, h = Object.getOwnPropertyNames(r.prototype)[Symbol.iterator](); !(s = (l = h.next()).done); s = !0) {
        var u = l.value;
        "constructor" !== u && (o.prototype[u] = r.prototype[u])
      }
    } catch (t) {
      a = !0, c = t
    } finally {
    ...
    var r = t("@marcom/ac-360"),
      o = function() {
        ...
        return n(t, [{
          key: "_init",
          value: function(t) {
            this._renderElement = document.createElement("div"), this._renderElement.classList.add("threesixty-video-container"), this.el.style.visibility = "hidden", this.el.style.opacity = 0, this.sendMouseDown = this.sendMouseDown.bind(this), this._renderElement.appendChild(this.el), this._init360()
          }
        }, {
          key: "_init360",
          value: function() {
            ...
            }.bind(this)), this._loadOnInit && (this.load.apply(this, function(t) {
              if (Array.isArray(t)) {
                for (var e = 0, i = Array(t.length); e < t.length; e++) i[e] = t[e];
                return i
              }
              return Array.from(t)
            }(this._loadOnInit)), this._loadOnInit = null)
          }
        }, {
          key: "load",
          value: function() {
            this._ac360 ? (this._ac360.setPos(0, 0), this._super.load.apply(this, arguments)) : this._loadOnInit = arguments
          }
        }, {
          key: "play",
          value: function() {
            this.getEnded() && this._ac360.setPos(0, 0), this._super.play.apply(this)
          }
        }, {
          key: "sendMouseDown",
          value: function(t) {
  ...
  304: [function(t, e, i) {
    ...
    function u(t) {
      return (t.hls || function(t) {
        return t.src && -1 !== t.src.indexOf(".m3u8") || t.sources && t.sources[0] && -1 !== t.sources[0].indexOf(".m3u8")
      }(t)) && !(l && !1 !== t.useNativeHls && !t.dvr) && h
    }
    var d = function() {
      function t() {
        ! function(t, e) {
      ...
      return n(t, [{
        key: "create",
        value: function(t, e) {
          if (u(t) && !t.threesixty) return new r(Object.assign({}, t, {
            parentElement: e
          }));
          if (t.threesixty) {
            var i = o;
            return u(t) && (i = s), new i(Object.assign({}, t, {
              parentElement: e
            }))
          }
          return new a(Object.assign({}, t, {
            parentElement: e
          }))
        }
      }]), t
  ...
  305: [function(t, e, i) {
    ...
    "./getContentDimensions": 306,
    "./getDimensions": 307,
    "./getMaxScrollPosition": 308,
    "./getPagePosition": 309,
    "./getPercentInViewport": 310,
    "./getPixelsInViewport": 311,
    "./getPosition": 312,
    "./getScrollPosition": 313,
  ...
  317: [function(t, e, i) {
    ...
    "./helpers/globals": 316,
    "./touchAvailable": 321,
    "@marcom/function-utils/once": 322,
    "@marcom/useragent-detect": 327
  }],
  318: [function(t, e, i) {
    "use strict";
  ...
  328: [function(t, e, i) {
    ...
    "./ac-event-emitter/EventEmitter": 329,
    dup: 96
  }],
  329: [function(t, e, i) {
  ...
  330: [function(t, e, i) {
    ...
    e.exports = function t(e, i) {
      ...
      if (l.length) c = s(l, Object.assign(i || {}, {
        ...
        for (var _ in u) u.hasOwnProperty(_) && (c = s(u[_], Object.assign(i || {}, {
  ...
  331: [function(t, e, i) {
    ...
    "@marcom/ac-analytics": "@marcom/ac-analytics",
    "@marcom/ac-video/event-emitter-shim/EventEmitterShim": 210,
    "@marcom/useragent-detect": 327
  }],
  332: [function(t, e, i) {
    "use strict";
    ...
    "../windowload/windowLoad": 342,
    "@marcom/feature-detect/touchAvailable": 321,
    "@marcom/useragent-detect": 327
  }],
  333: [function(t, e, i) {
    "use strict";
    ...
    e.exports = function(t, e) {
      ...
      t.forEach(function(t) {
        t.hasAttribute("data-films-options") && (!1 !== JSON.parse(t.getAttribute("data-films-options")).closeOnEnd || e.closeOnEnd || (e.closeOnEnd = !1)); - 1 !== t.href.indexOf(".m3u8") && (o = !0)
      }), e.maxWidth || (e.maxWidth = 1280), e.hls = void 0 !== e.hls ? e.hls : o;
      var s, m = r(e);
      i = new n({
        hashChange: !0,
        pushState: !1
      ...
      var g = function(t, e) {
        t.detatch(), y.delete(e)
      };
      return i.start(), {
        play: function(e) {
          for (var i = 0, n = t.length; i < n; i++) t[i].id !== e && t[i] !== e || _(t[i].href)
        },
        player: m,
        modalVideo: s.modal,
        destroy: function() {
          y.forEach(g), s.destroy()
        }
      }
    }
  }, {
    "./bindAnchor": 332,
    "./createClickHandler": 334,
    "./createHandheldModalLink": 336,
    "./createInlineLink": 337,
    "./createModalLink": 338,
    "@marcom/ac-router": 163,
    "@marcom/ac-video/optimizeVideoUrl": 211,
    "@marcom/ac-video/player/factory/createShareablePlayer": 217,
    "@marcom/feature-detect/isHandheld": 318,
    "@marcom/useragent-detect": 327
  }],
  334: [function(t, e, i) {
    "use strict";
  ...
  335: [function(t, e, i) {
    ...
    "../../../.versionfile": 1,
    "../analytics/AnalyticsTranslator": 331,
    "./bindAnchors": 333,
    "@marcom/ac-console/log": 56
  }],
  336: [function(t, e, i) {
    ...
    e.exports = function(t, e, i) {
      ...
      return e.appendChild(t.el), {
        play: function(i, n, r) {
          var o = function() {
            t.isPictureInPicture() || (t.getPaused() || t.pause(), t.el.classList.remove("player-fullscreen"))
          };
          t.el.classList.add("player-fullscreen"), t.once("ended", o), t.once("exitfullscreen", o);
          var s = e.getAttribute("data-films-options");
          s && (n = Object.assign({}, n, JSON.parse(s))), t.load(i, null, 0, Object.assign({
  ...
  339: [function(t, e, i) {
    ...
    "../../resize/ResizeHandler": 341,
    "@marcom/ac-video/utils/urlOptimizer/19X9AssetSizes": 296
  }],
  340: [function(t, e, i) {
    "use strict";
    t("../AutoFilms")()
