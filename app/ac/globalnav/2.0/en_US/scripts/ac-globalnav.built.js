(function e(b, g, d) {
  ...
  6: [function(d, b, j) {
    var a = d("@marcom/ac-checksum").adler32;
    var i = d("@marcom/ac-object");
    var k = d("./Item/apis");
    ...
    "@marcom/ac-object": 132
  }],
  7: [function(d, g, b) {
    var h = d("@marcom/ac-console").log;
  ...
  8: [function(d, a, g) {
    var c = d("@marcom/ac-feature");
    var b;
    try {
      var h = window.localStorage;
      var j = window.sessionStorage
    } catch (i) {
      b = false
    }
    var f = {
      ...
      available: function() {
        try {
          h.setItem("localStorage", 1);
          h.removeItem("localStorage")
        } catch (k) {
          b = false
        }
        if (b === undefined) {
          b = c.localStorageAvailable()
        }
        return b
      },
      getItem: function(k) {
        return h.getItem(k) || j.getItem(k)
      },
      setItem: function(l, m, k) {
        if (k === false) {
          j.setItem(l, m)
        } else {
          h.setItem(l, m)
    ...
    "@marcom/ac-feature": 100
  }],
  9: [function(d, f, c) {
    var g = d("@marcom/ac-dom-nodes");
    var i = 1000 * 60 * 60 * 24;
    var a = "ac-storage";
    var h;
    var b = {
  ...
  16: [function(b, c, a) {
    (function() {
      var f = typeof a != "undefined" ? a : this;
      ...
      f.btoa || (f.btoa = function(k) {
        var n = String(k);
        for (var m, i, h = 0, l = g, j = ""; n.charAt(h | 0) || (l = "=", h % 1); j += l.charAt(63 & m >> 8 - h % 1 * 8)) {
          i = n.charCodeAt(h += 3 / 4);
          if (i > 255) {
            throw new d("'btoa' failed: The string to be encoded contains characters outside of the Latin1 range.")
          }
          m = m << 8 | i
        }
        return j
      });
      f.atob || (f.atob = function(k) {
        var n = String(k).replace(/=+$/, "");
        if (n.length % 4 == 1) {
          throw new d("'atob' failed: The string to be decoded is not correctly encoded.")
        }
        for (var m = 0, l, i, h = 0, j = ""; i = n.charAt(h++); ~i && (l = m % 4 ? l * 64 + i : i, m++ % 4) ? j += String.fromCharCode(255 & l >> (-2 * m & 6)) : 0) {
          i = g.indexOf(i)
        }
        return j
      })
  ...
  17: [function(f, d, i) {
    f("@marcom/ac-polyfills/Promise");
    f("@marcom/ac-polyfills/Object/create");
    var j = null;
    try {
      j = f("@marcom/ac-storage")
    } catch (l) {}
    var q = f("@marcom/ac-event-emitter-micro").EventEmitterMicro;
    var o = f("mustache");
    var k = f("Base64");
    var a = f("./cookie.js");
    var m = "ac-store-cache";
    var p = {
      items: f("../mustache/items.mustache")
    };
    ...
    var n = function n(r) {
      if (r && r.length > 0) {
        r[0]["first"] = true;
        r[r.length - 1]["last"] = true
      }
      return r || []
    };
    var g = function(K, L, S, C) {
      q.call(this);
      var F = this;
      var D = null;
      var E = null;
      ...
      var I = function I(V, W) {
        var T;
        var U = P[V];
        var X = U !== W;
        if (X && typeof U === "object" && W === "object") {
          X = false;
          for (T in W) {
            X = X || W[T] !== U[T]
          }
        ...
        if (X) {
          P[V] = W;
          F.trigger(V + "Change", W)
        }
      };
      var B = function B(W, aa, Z, U) {
        var V = (W.indexOf("?") === -1 ? "?" : "&");
        var X = /(%5B|\[)storefront(%5D|\])/g;
        Z = Z || {};
        W = W.replace(X, aa.storefront || L);
        W = W.indexOf("//") === 0 ? window.location.protocol + W : W;
        W += V + "apikey=" + encodeURIComponent(S);
        W += U ? "&l=" + encodeURIComponent(window.location + "") : "";
        for (var Y in Z) {
          var T = new RegExp("(%5B|\\[)" + Y + "(%5D|\\])", "g");
          W = W.replace(T, encodeURIComponent(Z[Y]))
        }
        return new Promise(function(ad, ac) {
          var ab = new XMLHttpRequest();
          ab.onreadystatechange = function ae() {
            if (ab.readyState === 4) {
              try {
                var ag = JSON.parse(ab.responseText);
                ad(ag)
              } catch (af) {
                ac(new h("Response is not JSON.", h.Types.BAD_JSON_RESPONSE))
              }
            }
          };
          ab.open("GET", W);
          ab.withCredentials = true;
          ab.send()
        })
      };
      var w = function() {
        var U = (window.decodeURIComponent(window.escape(k.atob(a.getAs("sfa") || ""))) || "").split("|");
        var T = function T(V) {
          return U[0] === "2" && V === 9 ? U[2] : U[0] === "2" && V > 1 ? U[V + 1] : U[V]
        };
        E = E || {
          version: T(0),
          storefront: T(1),
          ...
          segmentCode: T(4),
          channelCode: T(5),
          showBanner: T(6) === "1" || T(6) === "true",
          persistBanner: T(7) === "1" || T(7) === "true",
          bagEnabled: T(8) !== "0" && T(8) !== "false",
      ...
      var A = function A() {
        ...
        var X = true;
        var T = null;
        y = y || (O().then(function(ac) {
          var ad = a.getAs("cn");
          var aa = ac.storefront || L;
          var Y = /([^\/]*)\/\/([^\/]*)\/.*/;
          var Z = (document.referrer || "").replace(Y, "$2");
          var ab = (document.location + "").replace(Y, "$2");
          D = D || c.getItem(m);
          U = ac.bagEnabled;
          X = ac.showBanner;
          V = D && ((H && D.ttl === 0) || (W < D.ttl && ad === D.cn && S === D.key && aa === D.sfLoc && (!Z || Z === ab)));
          return V ? Promise.resolve() : B(C, ac, {}, false).then(function(ae) {
            T = isNaN(parseInt(ae.items, 10));
            D = {
              ttl: (parseInt(ae.ttl, 10) * 1000 + W) || 0,
              items: !T ? parseInt(ae.items, 10) : 0,
              cn: ad,
              api: ae.api,
              key: S,
              sfLoc: aa
      ...
      var t = w();
      var x = t.consumerStorefront;
      if (!!x && !!L && x !== L) {
        v(true)
      }
      this.getStoreState = function R() {
        return A().then(function() {
          return P.storeState
        })
      };
      this.getItemCount = function s() {
        return A().then(function() {
          return P.itemCount
        })
      };
      this.__setItemCount = function G(T) {
        r = null;
        I("itemCount", T);
        if (D) {
          D.items = T;
      ...
      this.getStorefront = O;
      this.exitStorefront = v;
      this.addItem = function M(U) {
        var T = this;
        u = u.then(O).then(function(W) {
          var V = D && D.api && D.api.addToBag;
          if (!V) {
          ...
          if (V.addedToBag) {
            T.__setItemCount(V.bagQuantity || 0);
            T.clearBagCache()
          }
          return V.addedToBag ? Promise.resolve(V.message) : Promise.reject(new h(V.message, h.Types.ITEM_NOT_ADDED))
        });
        return u
      };
      this.addFavorite = function N(T) {
        return new Promise(function(V, U) {
          this.trigger("favoriteAdded");
          V()
        })
      };
      this.updateBagFlyout = function z() {
        if (r === null) {
          K.innerHTML = o.render(p.items, {
            loading: {
              text: "Loading..."
            }
          });
          r = true;
          (D && D.api ? Promise.resolve() : A()).then(O).then(function(W) {
            var V = D && D.api && D.api.flyout;
            if (!V) {
            ...
            r = W || {};
            r.bag = r.bag || {};
            r.bag["items"] = n(r.bag["items"]);
            r.links = n(r.links);
            r.promoLinks = n(r.promoLinks);
            r.buttons = n(r.buttons);
            if (r.bag["items"].length === 0 && !r.message) {
              r.message = {
                type: "empty",
                text: r.bag["emptyBagMsg"]
              }
            }
            if (r.bag["extraItemsMsg"]) {
              r.lineMessage = {
                text: r.bag["extraItemsMsg"]
              }
            }
            if (r.links.length > 0) {
              r.navigation = {
                noBtn: r.buttons.length <= 0,
                links: r.links
              }
            }
            if (r.promoLinks.length > 0) {
              r.explodedPromoLinks = {
                promoLinks: r.promoLinks
              }
            }
            for (var V = 0; V < r.bag["items"].length; V += 1) {
              var X = r.bag["items"][V] || {};
              X.qty = X.qty > 1 ? {
                text: X.qty
              } : false
            }
            K.innerHTML = o.render(p.items, r)
          }, function T() {
            r = null
          })
        }
      };
      this.clearCache = function Q(T) {
        if (!T || !H) {
          c.removeItem(m);
          D = null;
          E = null;
      ...
      this.clearBagCache = function J() {
        r = null
      }
    };
    g.prototype = Object.create(q.prototype);
    g.prototype.AcStoreError = h;
    g.AcStoreError = h;
    g.staticClearCache = function b() {
      c.removeItem(m)
    };
    d.exports = g
  }, {
    ...
    "./cookie.js": 18,
    "@marcom/ac-event-emitter-micro": 82,
    "@marcom/ac-polyfills/Object/create": 162,
    "@marcom/ac-polyfills/Promise": 164,
    "@marcom/ac-storage": 5,
    Base64: 16,
    mustache: 192
  }],
  18: [function(f, g, c) {
    var b = function b(k) {
      var j = encodeURIComponent(k).replace(/[\-\.\+\*]/g, "\\$&");
      var l = new RegExp("(?:(?:^|.*;)\\s*" + j + "\\s*\\=\\s*([^;]*).*$)|^.*$");
      return decodeURIComponent(document.cookie.replace(l, "$1")) || null
    };
    var a = function a(j) {
      var k = window.cookieMap && window.cookieMap["as_" + j];
      return k ? b(k) : b("as_" + j) || b("as_" + j + "_stag") || b("as_" + j + "_qa1") || b("as_" + j + "_qa2") || b("as_" + j + "_qa3") || b("as_" + j + "_dev")
    };
    var i = function i(k) {
      var j = k && encodeURIComponent(k).replace(/[\-\.\+\*]/g, "\\$&");
      return !k ? false : (new RegExp("(?:^|;\\s*)" + j + "\\s*\\=")).test(document.cookie)
    };
    var h = function h(l, k, j) {
      if (!i(l)) {
        return false
      }
    ...
    var d = function d(l, k, j) {
      if (window.envCookieSuffix) {
        h("as_" + l + window.envCookieSuffix, k, j)
      } else {
        h("as_" + l, k, j);
        h("as_" + l + "_stag", k, j);
        h("as_" + l + "_qa1", k, j);
  ...
  21: [function(b, c, a) {
    ...
    "./data": 23,
    "@marcom/ac-polyfills/Array/prototype.filter": 153,
    "@marcom/ac-polyfills/Array/prototype.some": 157
  }],
  22: [function(b, c, a) {
    c.exports = {
  ...
  24: [function(b, c, a) {
    ...
    "./className/add": 26,
    "@marcom/ac-polyfills/Array/prototype.slice": 156,
    "@marcom/ac-polyfills/Element/prototype.classList": 159
  }],
  25: [function(b, c, a) {
    c.exports = {
      add: b("./className/add"),
  ...
  41: [function(c, f, b) {
    ...
    "@marcom/ac-prefixer/getEventType": 35
  }],
  42: [function(c, d, b) {
  ...
  55: [function(b, c, a) {
    ...
    "./COMMENT_NODE": 46,
    "./DOCUMENT_FRAGMENT_NODE": 47,
    "./DOCUMENT_NODE": 48,
    "./DOCUMENT_TYPE_NODE": 49,
    "./ELEMENT_NODE": 50,
    "./TEXT_NODE": 51,
    "./createDocumentFragment": 52,
    "./filterByNodeType": 53,
    "./hasAttribute": 54,
    "./indexOf": 56,
    "./insertAfter": 57,
  ...
  56: [function(c, d, b) {
    ...
    "@marcom/ac-polyfills/Array/prototype.indexOf": 155,
    "@marcom/ac-polyfills/Array/prototype.slice": 156
  }],
  57: [function(b, c, a) {
  ...
  75: [function(g, c, i) {
    ...
    "@marcom/ac-dom-nodes/COMMENT_NODE": 46,
    "@marcom/ac-dom-nodes/DOCUMENT_FRAGMENT_NODE": 47,
    "@marcom/ac-dom-nodes/DOCUMENT_NODE": 48,
  ...
  76: [function(d, f, c) {
    ...
    "./internal/nativeMatches": 74,
    "./internal/validate": 75,
    "./shims/matchesSelector": 79,
    "@marcom/ac-dom-nodes/isElement": 67
  }],
  77: [function(c, d, a) {
    var h = c("./internal/validate");
  ...
  81: [function(c, b, f) {
    ...
    "@marcom/ac-dom-nodes/isDocumentFragment": 65,
    "@marcom/ac-dom-nodes/isElement": 67,
  ...
  82: [function(b, c, a) {
    ...
    "./ac-event-emitter-micro/EventEmitterMicro": 83
  }],
  83: [function(b, c, a) {
    function f() {
      this._events = {}
  ...
  88: [function(b, c, a) {
    ...
    "./shared/camelCasedEventTypes": 91,
    "./shared/prefixHelper": 93,
    "./shared/windowFallbackEventTypes": 96,
    "./utils/eventTypeAvailable": 97,
    dup: 35
  }],
  89: [function(f, d, h) {
    ...
    "./shared/getStyleTestElement": 92,
    "./shared/prefixHelper": 93,
    "./shared/stylePropertyCache": 94,
    "./utils/toCSS": 98,
    "./utils/toDOM": 99
  }],
  90: [function(d, b, h) {
  ...
  95: [function(c, b, d) {
    ...
    "./getStyleTestElement": 92,
    "./stylePropertyCache": 94
  }],
  96: [function(b, c, a) {
  ...
  100: [function(b, c, a) {
    ...
    "./canvasAvailable": 101,
    "./continuousScrollEventsAvailable": 102,
    "./cookiesAvailable": 103,
    "./cssLinearGradientAvailable": 104,
    "./cssPropertyAvailable": 105,
    "./cssViewportUnitsAvailable": 106,
    "./elementAttributeAvailable": 107,
    "./eventTypeAvailable": 108,
    "./isDesktop": 110,
    "./isHandheld": 111,
    "./isRetina": 112,
    "./isTablet": 113,
    "./localStorageAvailable": 114,
    "./mediaElementsAvailable": 115,
    "./mediaQueriesAvailable": 116,
    "./sessionStorageAvailable": 117,
    "./svgAvailable": 118,
    "./threeDTransformsAvailable": 119,
    "./touchAvailable": 120,
    "./webGLAvailable": 121
  }],
  101: [function(b, c, a) {
    ...
    "./helpers/globals": 109,
    "@marcom/ac-function/once": 124
  }],
  102: [function(c, d, b) {
    var h = c("@marcom/ac-browser");
  ...
  104: [function(c, d, b) {
    ...
    "@marcom/ac-function/once": 124,
    "@marcom/ac-prefixer/getStyleValue": 90
  }],
  105: [function(c, d, b) {
    var g = c("@marcom/ac-prefixer/getStyleValue");
    ...
    "@marcom/ac-function/memoize": 123,
    "@marcom/ac-prefixer/getStyleProperty": 89,
    "@marcom/ac-prefixer/getStyleValue": 90
  }],
  106: [function(b, c, a) {
  ...
  108: [function(c, f, b) {
    ...
    "@marcom/ac-function/memoize": 123,
    "@marcom/ac-prefixer/getEventType": 88
  }],
  109: [function(b, c, a) {
    c.exports = {
      getWindow: function() {
  ...
  116: [function(c, d, b) {
    ...
    "./helpers/globals": 109,
    "@marcom/ac-function/once": 124,
    "@marcom/ac-polyfills/matchMedia": 166
  }],
  117: [function(c, d, b) {
    var g = c("./helpers/globals");
    var f = c("@marcom/ac-function/once");
  ...
  130: [function(b, c, a) {
    ...
    d.stringify = function(l, n, g, j, h) {
      ...
      if (typeof l === "string" || typeof l === "number" || typeof l === "boolean") {
        return [f.encode(n) + "=" + f.encode(l)]
      }
      var q = [];
      if (typeof l === "undefined") {
        return q
      }
      var k = Array.isArray(h) ? h : Object.keys(l);
      for (var m = 0, o = k.length; m < o; ++m) {
        var p = k[m];
        if (Array.isArray(l)) {
          q = q.concat(d.stringify(l[p], g(n, p), g, j, h))
        } else {
          q = q.concat(d.stringify(l[p], n + "[" + p + "]", g, j, h))
        }
      }
      return q
    };
    c.exports = function(o, s) {
      s = s || {};
      var j = typeof s.delimiter === "undefined" ? d.delimiter : s.delimiter;
      var l = typeof s.strictNullHandling === "boolean" ? s.strictNullHandling : d.strictNullHandling;
      var n;
      var k;
      ...
      var g;
      if (s.arrayFormat in d.arrayPrefixGenerators) {
        g = s.arrayFormat
      } else {
        if ("indices" in s) {
          g = s.indices ? "indices" : "repeat"
        } else {
          g = "indices"
        }
      }
      var h = d.arrayPrefixGenerators[g];
      if (!n) {
        n = Object.keys(o)
      }
      for (var m = 0, p = n.length; m < p; ++m) {
        var q = n[m];
        r = r.concat(d.stringify(o[q], q, h, l, k))
      }
      return r.join(j)
    }
  }, {
  ...
  133: [function(c, d, b) {
    ...
    "./extend": 136,
    "@marcom/ac-polyfills/Array/isArray": 152
  }],
  134: [function(b, d, a) {
    var f = function() {};
  ...
  136: [function(c, d, b) {
    ...
    "@marcom/ac-polyfills/Array/prototype.forEach": 154
  }],
  137: [function(c, d, b) {
    var a = Object.prototype.hasOwnProperty;
  ...
  141: [function(c, f, b) {
    ...
    "@marcom/ac-url/joinSearchParams": 127
  }],
  142: [function(b, c, a) {
  ...
  169: [function(b, c, a) {
    ...
    var d = new RegExp("(" + f + "+" + g + "*|" + f + "*" + g + "+|[0-9]+)", "g");
  ...
  170: [function(b, d, a) {
    ...
    d.exports = function h(j) {
      return g(j, f)
    }
  }, {
    "./capitalize": 168,
    "./splitWords": 169,
    "./utils/transformWords": 171
  }],
  171: [function(b, c, a) {
    var f = b("../splitWords");
    c.exports = function d(l, m) {
      var k = f(l);
      var j = k.length;
      var g = "";
      var h;
  ...
  172: [function(b, a, f) {
    ...
    "@marcom/ac-dom-events/utils/addEventListener": 44,
    "@marcom/ac-event-emitter-micro": 82,
    "@marcom/ac-feature/mediaQueriesAvailable": 116,
    "@marcom/ac-polyfills/Function/prototype.bind": 160,
    "@marcom/ac-polyfills/Object/create": 162,
    "@marcom/ac-polyfills/Object/keys": 163
  }],
  173: [function(i, c, x) {
  ...
  178: [function(b, f, a) {
    ...
    "./request": 177,
    "ac-object/toQueryParameters": 174
  }],
  179: [function(b, d, a) {
    var c = b("./request");
    var f = function() {
  ...
  182: [function(b, c, a) {
    ...
    "./ac-shared-instance/SharedInstance": 183
  }],
  183: [function(d, h, c) {
    var i = window,
      g = "AC",
  ...
  188: [function(c, d, b) {
    ...
    "ac-polyfills/Array/prototype.forEach": 189
  }],
  189: [function(b, c, a) {
    if (!Array.prototype.forEach) {
      Array.prototype.forEach = function d(k, j) {
  ...
  190: [function(b, c, a) {
    ...
    "./ac-mvc-model/Model": 191
  }],
  191: [function(f, a, g) {
    var j = f("ac-event-emitter-micro").EventEmitterMicro;
    var b = f("ac-object/defaults");
    var i = f("ac-object/create");
    var c = f("ac-mvc-cid").CID;
    var d = function(k) {
      j.call(this);
      this.attributes = b(this.defaultAttributes, k || {});
      this.cid = c.getNewCID();
      if (this.attributes[this.idAttribute]) {
        this.id = this.attributes[this.idAttribute]
      }
    };
    var h = d.prototype = i(j.prototype);
    h.defaultAttributes = {};
    h.idAttribute = "id";
    h._trigger = function(m, l, k) {
      k = k || {};
      if (k.silent !== true) {
        this.trigger(m, l)
      }
    };
    h._triggerChange = function(m, l, k) {
    ...
    "ac-event-emitter-micro": 180,
    "ac-mvc-cid": 184,
    "ac-object/create": 186,
    "ac-object/defaults": 187
  }],
  192: [function(c, d, b) {
    /*!
     ...
     */
    (function a(h, g) {
      if (typeof b === "object" && b && typeof b.nodeName !== "string") {
        g(b)
      } else {
      ...
      var E = Array.isArray || function j(W) {
      ...
      function P(X, W) {
        return X != null && typeof X === "object" && (W in X)
      }
      ...
      function F(W) {
        return String(W).replace(/[&<>"'`=\/]/g, function X(Y) {
          return w[Y]
        })
      }
      var z = /\s*/;
      ...
      function k(ap, ae) {
        ...
        function ac(ar) {
          ...
          if (!E(ar) || ar.length !== 2) {
            throw new Error("Invalid tags: " + ar)
          }
          ai = new RegExp(o(ar[0]) + "\\s*");
          ad = new RegExp("\\s*" + o(ar[1]));
          ao = new RegExp("\\s*" + o("}" + ar[1]))
        }
        ac(ae || L.tags);
        var Y = new g(ap);
        var Z, X, ah, ak, aa, W;
        while (!Y.eos()) {
          ...
          ah = Y.scanUntil(ai);
          if (ah) {
            for (var al = 0, aj = ah.length; al < aj; ++al) {
              ak = ah.charAt(al);
              if (K(ak)) {
                ab.push(af.length)
              } else {
          ...
          if (X === "#" || X === "^") {
            ...
            if (X === "/") {
              W = ag.pop();
              if (!W) {
                throw new Error('Unopened section "' + ah + '" at ' + Z)
              }
              if (W[1] !== ah) {
                throw new Error('Unclosed section "' + W[1] + '" at ' + Z)
              }
            } else {
              if (X === "name" || X === "{" || X === "&") {
                an = true
        ...
        W = ag.pop();
        if (W) {
          throw new Error('Unclosed section "' + W[1] + '" at ' + Y.pos)
        }
        return s(v(af))
      }
      ...
      function v(ab) {
        var X = [];
        var Z, W;
        for (var Y = 0, aa = ab.length; Y < aa; ++Y) {
          Z = ab[Y];
          if (Z) {
            if (Z[0] === "text" && W && W[0] === "text") {
              W[1] += Z[1];
              W[3] = Z[3]
            } else {
              X.push(Z);
        ...
        for (var W = 0, Y = ab.length; W < Y; ++W) {
          ...
          switch (X[0]) {
            ...
            case "/":
              Z = ac.pop();
              Z[5] = X[2];
              aa = ac.length > 0 ? ac[ac.length - 1][4] : ad;
              break;
            default:
              aa.push(X)
          }
      ...
      g.prototype.eos = function Q() {
        return this.tail === ""
      };
      g.prototype.scan = function U(Y) {
        var X = this.tail.match(Y);
        if (!X || X.index !== 0) {
          return ""
        }
        var W = X[0];
        this.tail = this.tail.substring(W.length);
        this.pos += W.length;
        return W
      };
      g.prototype.scanUntil = function O(Y) {
        var X = this.tail.search(Y),
          W;
        switch (X) {
          case -1:
            W = this.tail;
          ...
          case 0:
            ...
            break;
          default:
            W = this.tail.substring(0, X);
            this.tail = this.tail.substring(X)
        }
        this.pos += W.length;
        return W
      };
      ...
      S.prototype.lookup = function p(Z) {
        var X = this.cache;
        var ab;
      ...
      q.prototype.clearCache = function G() {
        this.cache = {}
      };
      q.prototype.parse = function B(Y, X) {
        var W = this.cache;
        var Z = W[Y];
        if (Z == null) {
          Z = W[Y] = k(Y, X)
      ...
      q.prototype.render = function H(Z, W, Y) {
        var aa = this.parse(Z);
        var X = (W instanceof S) ? W : new S(W);
        return this.renderTokens(aa, X, Y, Z)
      };
      q.prototype.renderTokens = function t(ad, W, ab, af) {
        var Z = "";
        var Y, X, ae;
        for (var aa = 0, ac = ad.length; aa < ac; ++aa) {
          ae = undefined;
          Y = ad[aa];
          X = Y[0];
          if (X === "#") {
            ae = this.renderSection(Y, W, ab, af)
          } else {
            if (X === "^") {
              ae = this.renderInverted(Y, W, ab, af)
            } else {
              if (X === ">") {
                ae = this.renderPartial(Y, W, ab, af)
              } else {
                if (X === "&") {
                  ae = this.unescapedValue(Y, W)
                } else {
                  if (X === "name") {
                    ae = this.escapedValue(Y, W)
                  } else {
                    if (X === "text") {
                      ae = this.rawValue(Y)
                    }
      ...
      q.prototype.renderSection = function C(Y, W, ab, ae) {
        var af = this;
        var aa = "";
        var ac = W.lookup(Y[1]);

        function X(ag) {
          return af.render(ag, W, ab)
        }
        if (!ac) {
          return
        }
        if (E(ac)) {
          for (var Z = 0, ad = ac.length; Z < ad; ++Z) {
            aa += this.renderTokens(Y[4], W.push(ac[Z]), ab, ae)
          }
        } else {
          if (typeof ac === "object" || typeof ac === "string" || typeof ac === "number") {
            aa += this.renderTokens(Y[4], W.push(ac), ab, ae)
          } else {
            if (A(ac)) {
              if (typeof ae !== "string") {
                throw new Error("Cannot use higher-order sections without the original template")
              }
              ac = ac.call(W.view, ae.slice(Y[3], Y[5]), X);
              if (ac != null) {
                aa += ac
              }
            } else {
              aa += this.renderTokens(Y[4], W, ab, ae)
            }
          }
        }
        return aa
      };
      q.prototype.renderInverted = function h(Y, X, W, aa) {
        var Z = X.lookup(Y[1]);
        if (!Z || (E(Z) && Z.length === 0)) {
          return this.renderTokens(Y[4], X, W, aa)
        }
      };
      q.prototype.renderPartial = function N(Y, X, W) {
        if (!W) {
          return
        }
        var Z = A(W) ? W(Y[1]) : W[Y[1]];
        if (Z != null) {
          return this.renderTokens(this.parse(Z), X, W, Z)
        }
      };
      q.prototype.unescapedValue = function m(X, W) {
        var Y = W.lookup(X[1]);
        if (Y != null) {
          return Y
        }
      };
      q.prototype.escapedValue = function J(X, W) {
        var Y = W.lookup(X[1]);
        if (Y != null) {
          return L.escape(Y)
        }
      };
      q.prototype.rawValue = function l(W) {
        return W[1]
      };
      L.name = "/ac/globalnav/2.0/en_US/scripts/mustache.js";
      L.version = "2.2.1";
      L.tags = ["{{", "}}"];
      var V = new q();
      L.clearCache = function G() {
        return V.clearCache()
      };
      L.parse = function B(X, W) {
        return V.parse(X, W)
      };
      L.render = function H(Y, W, X) {
        if (typeof Y !== "string") {
          throw new TypeError('Invalid template! Template should be a "string" but "' + R(Y) + '" was given as the first argument for mustache#render(template, view, partials)')
        }
        return V.render(Y, W, X)
      };
      L.to_html = function n(Z, X, Y, aa) {
        var W = L.render(Z, X, Y);
        if (A(aa)) {
          aa(W)
        } else {
          return W
  ...
  193: [function(b, c, a) {
    ...
    b("@marcom/ac-polyfills/String/prototype.trim");
    ...
    "@marcom/ac-polyfills/Function/prototype.bind": 160,
    "@marcom/ac-polyfills/Object/create": 162,
    "@marcom/ac-polyfills/String/prototype.trim": 165,
    "@marcom/ac-polyfills/requestAnimationFrame": 167
  }],
  194: [function(m, d, D) {
    var u = m("@aos/ac-store");
    var h = m("./menu/CheckboxMenu");
    var b = m("@marcom/ac-headjs/FeatureDetect");
    var A = m("./helpers/featureDetectTests");
    var i = m("@marcom/ac-dom-traversal/querySelector");
    var k = m("@marcom/ac-dom-events/utils/addEventListener");
    var f = m("@marcom/ac-classlist");
    var y = m("@marcom/ac-browser");
    var l = m("@marcom/ac-dom-events/preventDefault");
    var n = m("@marcom/ac-dom-events/stopPropagation");
    var B = m("@marcom/ac-dom-events/target");
    var x = m("./helpers/keyMap");
    var o = m("./helpers/ClickAway");
    var g = m("./search/SearchController");
    var r = m("./search/SearchReveal");
    var t = m("./segment/SegmentBar");
    var j = m("@marcom/ac-viewport-emitter/ViewportEmitter");
    var c = m("./helpers/scrollSwitch");
    var z = m("./helpers/getSettings");
    var q = m("@marcom/ac-object/defaults");
    var a = "with-bagview";
    var s = "with-badge";
    var w = "blocktransitions";
    var p = (y.os === "iOS" && y.version < 8);

    function C() {
      var F = document.getElementById("ac-globalnav");
      var E = new b(F, A);
      this.el = F;
      this._viewports = new j("ac-gn-viewport-emitter");
      E.htmlClass();
    ...
    v._initializeSettings = function() {
      ...
      this._settings = q(E, z())
    };
    v._initializeFlyoutListeners = function() {
      k(window, "beforeunload", this._hideFlyouts.bind(this));
      k(window, "popstate", this._hideFlyouts.bind(this));
      k(document, "keydown", this._onBodyKeydown.bind(this));
      k(this.el, "keydown", this._onKeydown.bind(this));
      k(document.body, "focus", this._trapFocus.bind(this), true);
    ...
    v._trapFocus = function(E) {
      var F = (this._bagVisible && this._viewports.viewport === "xsmall");
      var H;
      var G;
      if (this.menu.isOpen() || F || this._searchVisible) {
        H = B(E);
        if (!H.className.match(/\b(ac-gn-)/i)) {
          l(E);
          for (G = 0; G < this.firstFocusEl.length; G++) {
            if (this.firstFocusEl[G]) {
              this.firstFocusEl[G].focus()
            }
          }
        }
      }
    ...
    v._initializeMenu = function() {
      this.menu = new h(document.getElementById("ac-gn-menustate"), document.getElementById("ac-gn-menuanchor-open"), document.getElementById("ac-gn-menuanchor-close"));
    ...
    v._initializeStore = function() {
      ...
      this.bag.link = i(".ac-gn-link-bag", this.bag.tab);
      this.bag.linkSmall = i(".ac-gn-link-bag", this.bag.tabSmall);
      this.bag.content = document.getElementById("ac-gn-bagview-content");
      this.bag.items = 0;
      this._bagVisible = false;
      this.store = new u(this.bag.content, this._settings.storeLocale, this._settings.storeKey, this._settings.storeAPI);
      window.acStore = this.store;
      var F = document.getElementById("ac-gn-segmentbar");
      if (F && this._settings.segmentbarEnabled) {
        this.segment = new t(F, this._settings);
    ...
    v._onStoreResolve = function(F) {
      var E;
      this.store.getItemCount().then(this.updateItemCount.bind(this), this._failSilently);
      this.store.on("itemCountChange", this.updateItemCount.bind(this));
      this.toggleBag = this.toggleBag.bind(this);
      k(this.bag.link, "click", this.toggleBag);
      this._onBagMouseUp = this._onBagMouseUp.bind(this);
      k(this.bag.link, "mouseup", this._onBagMouseUp);
      if (this.bag.linkSmall) {
        k(this.bag.linkSmall, "click", this.toggleBag);
        k(this.bag.linkSmall, "mouseup", this._onBagMouseUp)
      }
      ...
      E = new o(".ac-gn-bag, .ac-gn-bagview");
      E.on("click", this.hideBag.bind(this))
    };
    v._onStoreReject = function() {};
    v._initializeSearch = function() {
      var E;
      this.searchOpenTrigger = i(".ac-gn-link-search", this.el);
      ...
      if (this.searchOpenTrigger) {
        ...
        k(this.searchOpenTrigger, "click", this.onSearchOpenClick.bind(this));
        k(this.searchCloseTrigger, "click", this.onSearchCloseClick.bind(this));
        k(this.searchCloseTrigger, "mouseup", this.onSearchCloseMouseUp.bind(this));
        k(window, "orientationchange", this._onSearchOrientationChange.bind(this));
        E = new o(".ac-gn-searchview, .ac-gn-link-search");
        E.on("click", this._onSearchClickAway.bind(this));
        this.searchController = new g(this.el, this._settings);
        this.searchReveal = new r(this.el, this._viewports);
        this.searchReveal.on("hideend", this._onSearchHideEnd.bind(this));
        this.menu.on("close", this.hideSearch.bind(this))
      }
    };
    v._onViewportChange = function(F) {
      var E = (F.from === "medium" || F.to === "medium" || F.from === "large" || F.to === "large");
      var G = (F.from === "small" || F.to === "small" || F.from === "xsmall" || F.to === "xsmall");
      if (E && G) {
    ...
    v._onBagMouseUp = function(E) {
      this.bag.link.blur();
      if (this.bag.linkSmall) {
        this.bag.linkSmall.blur()
      }
    };
    v.updateItemCount = function(E) {
      this.bag.items = E;
      if (E) {
        this.showBadge()
      } else {
    ...
    v.showBadge = function() {
      f.add(this.bag.tab, s);
      f.add(this.bag.tabSmall, s);
    ...
    v.hideBadge = function() {
      f.remove(this.bag.tab, s);
      f.remove(this.bag.tabSmall, s);
    ...
    v.onSearchOpenClick = function(E) {
    ...
    v.onSearchCloseClick = function(E) {
      var F = (this.searchCloseTrigger === document.activeElement);
      l(E);
      this.hideSearch();
      if (F) {
        this.searchOpenTrigger.focus()
    ...
    v.onSearchCloseMouseUp = function(E) {
    ...
    v.showSearch = function() {
      ...
      if (p && !this._isBreakpointWithMenu()) {
    ...
    "./helpers/ClickAway": 195,
    "./helpers/featureDetectTests": 196,
    "./helpers/getSettings": 197,
    "./helpers/keyMap": 198,
    "./helpers/scrollSwitch": 199,
    "./menu/CheckboxMenu": 200,
    "./search/SearchController": 201,
    "./search/SearchReveal": 203,
    "./segment/SegmentBar": 210,
    "@aos/ac-store": 17,
    "@marcom/ac-browser": 20,
    "@marcom/ac-classlist": 31,
    "@marcom/ac-dom-events/preventDefault": 40,
    "@marcom/ac-dom-events/stopPropagation": 42,
    "@marcom/ac-dom-events/target": 43,
    "@marcom/ac-dom-events/utils/addEventListener": 44,
    "@marcom/ac-dom-traversal/querySelector": 77,
    "@marcom/ac-headjs/FeatureDetect": 126,
    "@marcom/ac-object/defaults": 135,
    "@marcom/ac-viewport-emitter/ViewportEmitter": 172
  }],
  195: [function(c, b, d) {
    ...
    var j = c("@marcom/ac-dom-traversal/ancestors");
    ...
    var f = h.prototype = Object.create(i.prototype);
    f._checkTarget = function(k) {
      var l = a(k);
      if (!j(l, this._selector, true).length) {
        this.trigger("click", k)
      }
    };
    ...
    "@marcom/ac-dom-events/target": 43,
    "@marcom/ac-dom-events/utils/addEventListener": 44,
    "@marcom/ac-dom-traversal/ancestors": 73,
    "@marcom/ac-event-emitter-micro": 82,
    "@marcom/ac-polyfills/Function/prototype.bind": 160
  }],
  196: [function(d, f, c) {
    ...
    "@marcom/ac-browser": 20,
    "@marcom/ac-feature/svgAvailable": 118,
    "@marcom/ac-feature/touchAvailable": 120
  }],
  197: [function(d, c, h) {
    var b = d("@marcom/ac-dom-traversal/querySelectorAll");
    var i = d("@marcom/ac-string/toCamelCase");
    var k = {
    ...
    "@marcom/ac-dom-traversal/querySelectorAll": 78,
    "@marcom/ac-string/toCamelCase": 170
  }],
  198: [function(b, c, a) {
    c.exports = {
      BACKSPACE: 8,
  ...
  199: [function(b, a, g) {
    ...
    var j = b("@marcom/ac-browser");
    var l = b("@marcom/ac-dom-traversal/querySelector");
    var f = "ac-gn-noscroll";
    var m = "ac-gn-noscroll-long";
    var k = ", maximum-scale=1, user-scalable=0";
    var h = null;
    var c;
    var i = function() {
      if (h === null) {
        h = false;
        if (j.name === "Android" || (j.os === "iOS" && parseInt(j.version, 10) < 8)) {
          c = l("meta[name=viewport]");
          if (c) {
            h = true
          }
        }
    ...
    a.exports = {
      lock: function() {
        var n = (document.body.scrollHeight > document.documentElement.clientWidth);
        d.add(document.documentElement, f);
        d.toggle(document.documentElement, m, n);
        if (i()) {
          c.setAttribute("content", c.getAttribute("content") + k)
        }
      },
      unlock: function() {
        d.remove(document.documentElement, f);
        d.remove(document.documentElement, m);
        if (i()) {
          c.setAttribute("content", c.getAttribute("content").replace(k, ""))
        }
      }
    }
  }, {
  ...
  200: [function(d, f, b) {
    ...
    var a = d("@marcom/ac-dom-events/utils/addEventListener");
    var c = d("@marcom/ac-dom-events/preventDefault");
    ...
    function h(k, j, l) {
      ...
      a(this.el, "change", this.update.bind(this));
      a(this.anchorOpen, "click", this._anchorOpenClick.bind(this));
      a(this.anchorClose, "click", this._anchorCloseClick.bind(this));
      if (window.location.hash === "#" + k.id) {
        window.location.hash = ""
      }
    }
    var g = h.prototype = Object.create(i.prototype);
    g.update = function() {
      var j = this.isOpen();
      if (j !== this._lastOpen) {
        this.trigger(j ? "open" : "close");
        this._lastOpen = j
      }
    };
    g.isOpen = function() {
    ...
    g._anchorOpenClick = function(j) {
      c(j);
      this.open();
      this.anchorClose.focus()
    };
    g._anchorCloseClick = function(j) {
      c(j);
      this.close();
  ...
  201: [function(c, b, d) {
    var g = c("@marcom/ac-dom-events/utils/addEventListener");
    var o = c("@marcom/ac-dom-traversal/querySelector");
    var n = c("@marcom/ac-function/debounce");
    var i = c("@marcom/ac-dom-events/preventDefault");
    var k = c("./guid");
    var p = c("./SearchFormController");
    var m = c("./results/SearchResultsSelectionController");
    var j = c("./results/SearchResultsView");
    var a = c("./results/SearchModel");
    var h = c("../helpers/keyMap");

    function l(r, q) {
      this.el = r;
      this.locale = q.searchLocale;
      this.searchView = document.getElementById("ac-gn-searchview");
      ...
      this._initializeCustomSettings(q);
      g(this.searchForm, "submit", this._onFormSubmit.bind(this));
      this.searchID = k();
      this.searchResultsModel = new a(q.searchAPI);
      this.searchResultsModel.on("change", this._onModelChange.bind(this));
      this.fetchDataLazy = n(this.fetchData, 100);
      this.searchFormController = new p(this.searchView);
      ...
      this.selectionController = new m(this.searchResults);
      this.selectionController.on("change", this._onSelectionChange.bind(this));
      this.searchResultsView = new j(this.searchResults)
    }
    var f = l.prototype;
    f._initializeCustomSettings = function(q) {
      if (q.searchAction) {
        this.searchForm.action = q.searchAction
      }
      if (q.searchInput) {
        this.searchInput.name = q.searchInput
      }
      if (q.searchField) {
        this._initializeFields(q.searchField)
      }
    };
    f._initializeFields = function(q) {
      var t = this.searchSrc.parentNode;
    ...
    f._onFormSubmit = function(q) {
      var r = this.selectionController.getSelected();
      if (r && !r.hover) {
        i(q);
        this.selectionController.goToSelected()
      }
    };
    f._onKeydown = function(q) {
      var r = q.originalEvent.keyCode;
      if (r === h.ENTER) {
        this._onFormSubmit(q.originalEvent)
      }
    };
    f._onKeyup = function(q) {
      this.selectionController.onKeyup(q.originalEvent)
    };
    f._onModelChange = function() {
      this.searchResultsView.render(this.searchResultsModel.attributes);
      this.selectionController.updateSelectableItems()
    };
    f._onInputChange = function() {
      this.fetchDataLazy()
    };
    f._onInputBlur = function() {
      this.selectionController.setSelected()
    };
    f._onSelectionChange = function(q) {
      this.searchFormController.setAutocomplete(q)
    };
    f.focusInput = function() {
      this.searchInput.focus();
      this.fetchData()
    };
    f.blurInput = function() {
      this.searchInput.blur()
    };
    f.clearInput = function() {
    ...
    "../helpers/keyMap": 198,
    "./SearchFormController": 202,
    "./guid": 204,
    "./results/SearchModel": 205,
    "./results/SearchResultsSelectionController": 206,
    "./results/SearchResultsView": 207,
    "@marcom/ac-dom-events/preventDefault": 40,
    "@marcom/ac-dom-events/utils/addEventListener": 44,
    "@marcom/ac-dom-traversal/querySelector": 77,
    "@marcom/ac-function/debounce": 122
  }],
  202: [function(c, b, f) {
    var d = c("@marcom/ac-classlist");
    var k = c("@marcom/ac-dom-traversal/querySelector");
    var h = c("@marcom/ac-dom-events/utils/addEventListener");
    var a = c("@marcom/ac-dom-events/utils/removeEventListener");
    var j = c("@marcom/ac-dom-events/preventDefault");
    var m = c("@marcom/ac-event-emitter-micro").EventEmitterMicro;
    var i = c("../helpers/keyMap");
    ...
    function l(n) {
      ...
      h(this.searchForm, "submit", this._onFormSubmit.bind(this));
      h(this.searchInput, "blur", this._onInputBlur.bind(this));
      h(this.searchInput, "focus", this._onInputFocus.bind(this));
      h(this.searchReset, "click", this._onInputReset.bind(this));
      h(this.searchInput, "keyup", this._onSearchKeyup.bind(this));
      h(this.searchInput, "keydown", this._onSearchKeydown.bind(this));
      this._searchAction = this.searchForm.getAttribute("action");
      if (!this.searchInput.name) {
        this.searchInput.removeAttribute("name")
      }
    }
    var g = l.prototype = Object.create(m.prototype);
    g._onFormSubmit = function(n) {
      if (!this.inputHasValidText()) {
        j(n)
      }
    };
    g._onInputFocus = function() {
    ...
    g._onInputBlur = function(n) {
      this.trigger("blur")
    };
    g._onInputReset = function(n) {
      j(n);
    ...
    g._onSearchKeydown = function(n) {
      var o = n.keyCode;
      if (o === i.ARROW_DOWN || o === i.ARROW_UP) {
        j(n)
      } else {
        if (o === i.ENTER && !this.inputHasValidText()) {
          j(n)
        }
      }
    ...
    g.setAutocomplete = function(n) {
      if (!n || n.section !== "suggestions" || n.hover) {
        n = false
      }
      if (!n) {
        ...
        this.searchInput.value = n.value
      }
      this._lastValue = this.searchInput.value;
      this._updateButtons()
    };
    g.clearAutocomplete = function() {
      if (this._valueBeforeAutocomplete !== false) {
        this.searchInput.value = this._valueBeforeAutocomplete;
        this._valueBeforeAutocomplete = false
      }
    };
    g.hasAutocomplete = function() {
      return (this._valueBeforeAutocomplete !== false)
    };
    g.clearInput = function() {
      this.searchInput.value = "";
      this._updateButtons()
    };
    g.inputHasValue = function() {
      return (this.searchInput.value.length && this.searchInput.value.length > 0) ? true : false
    };
    g.inputHasValidText = function() {
      return !this.searchInput.value.match(/^\s*$/)
    };
    g.showSearchReset = function() {
      d.add(this.searchForm, "with-reset")
    };
    g.hideSearchReset = function() {
      d.remove(this.searchForm, "with-reset")
    };
    g.enableSearchReset = function() {
      this.searchReset.disabled = false
    };
    g.disableSearchReset = function() {
      this.searchReset.disabled = true
    };
    g.enableSearchSubmit = function() {
      this.searchSubmit.disabled = false
    };
    g.disableSearchSubmit = function() {
      this.searchSubmit.disabled = true
    };
    g.updateFormAction = function() {
      if (this.searchInput.name) {
        return
      }
      if (this.inputHasValidText()) {
    ...
    g.formatSearchInput = function(n) {
      return encodeURIComponent(n.replace(/[\s\/\'\\]+/g, " ").trim().replace(/\s+/g, "-"))
    };
    b.exports = l
  }, {
    "../helpers/keyMap": 198,
    ...
    "@marcom/ac-dom-events/preventDefault": 40,
    "@marcom/ac-dom-events/utils/addEventListener": 44,
    "@marcom/ac-dom-events/utils/removeEventListener": 45,
    "@marcom/ac-dom-traversal/querySelector": 77,
    "@marcom/ac-event-emitter-micro": 82
  }],
  203: [function(d, c, h) {
    var l = d("@marcom/ac-dom-events/addEventListener");
    var g = d("@marcom/ac-classlist");
    var m = d("@marcom/ac-feature/cssPropertyAvailable");
    var o = d("@marcom/ac-event-emitter-micro").EventEmitterMicro;
    var n = "searchshow";
    var k = "searchhide";
    var i = "searchopen";
    var f = "before-";
    ...
    j.remove = function() {
      ...
      g.remove(this.el, n, i, k)
    };
    j._onNextFrame = function() {
      var p;
      if (this._nextFrameCallback) {
        p = this._nextFrameCallback;
        this._nextFrameCallback = null;
        p.call(this)
      }
    };
    j._setNextFrame = function(p) {
      this._nextFrameCallback = p;
      window.requestAnimationFrame(this._onNextFrame)
    };
    j._onAnimationEnd = function(p) {
      if (this._animationEndCheck) {
        if (this._animationEndCheck.call(this, p)) {
    ...
    j._onAnimationEndTimeout = function() {
      clearTimeout(this._animationEndTimeout);
      this._animationEndTimeout = null;
    ...
    j._setAnimationEnd = function(q, p) {
      if (this._animationsAvailable) {
        this._animationEndCheck = p;
        this._animationEndCallback = q;
        this._animationEndTimeout = setTimeout(this._onAnimationEndTimeout, b)
      } else {
        q.call(this)
      }
    };
    j._frameShow = function() {
      this.trigger("showstart");
      g.add(this.el, n);
      this._setAnimationEnd(this._frameAfterShow, this._onShowAnimationEnd)
    };
    j._frameAfterShow = function() {
      g.add(this.el, i);
      g.remove(this.el, n);
      this.trigger("showend")
    };
    j._onShowAnimationEnd = function(p) {
      if (this._viewportEmitter.viewport === "small" || this._viewportEmitter.viewport === "xsmall") {
        return g.contains(p.target, "ac-gn-list")
      }
      return p.animationName === "ac-gn-searchform-slide"
    };
    j._frameHide = function() {
      if (this._animationEndCallback) {
    ...
    j._frameAfterHide = function() {
      g.remove(this.el, k);
      this.trigger("hideend")
    };
    j._onHideAnimationEnd = function(p) {
      if (this._viewportEmitter.viewport === "small" || this._viewportEmitter.viewport === "xsmall") {
        return g.contains(p.target, "ac-gn-list")
      }
      return g.contains(p.target, "ac-gn-search")
    };
    c.exports = a
  }, {
    "@marcom/ac-classlist": 31,
    ...
    "@marcom/ac-event-emitter-micro": 82,
    "@marcom/ac-feature/cssPropertyAvailable": 105
  }],
  204: [function(c, d, a) {
    var b = function() {
      var f = function() {
  ...
  205: [function(g, c, h) {
    g("@marcom/ac-polyfills/JSON");
    g("@marcom/ac-polyfills/Date/now");
    var b = g("ac-ajax-xhr");
    var f = g("ac-mvc-model").Model;
    var j = g("./sectionLabels");
    var d = g("./sectionAnalyticsEvents");

    function a(k) {
      this.requestURL = k
    }
    var i = a.prototype = new f();
    i.requestMethod = "post";
    i.fetchData = function(k) {
      k.query = this._normalizeQuery(k.query);
      if (k.query !== this.lastQuery) {
        this.lastQuery = k.query;
        b[this.requestMethod](this.requestURL, this._getRequestConfiguration(k))
      }
    };
    i._normalizeQuery = function(k) {
      return k.trim().replace(/\s+/g, " ")
    };
    i._getRequestData = function(k) {
    ...
    i._getRequestConfiguration = function(k) {
      this._lastRequestTime = Date.now();
      return {
        complete: this._onFetchComplete.bind(this),
        data: this._getRequestData(k),
    ...
    i._boldQueryTerms = function(l) {
      var k;
      if (!this.lastQuery) {
        return l
      }
      k = new RegExp("(\\b" + this.lastQuery.split(" ").join("|\\b") + ")", "ig");
      return l.replace(k, "<b>$&</b>")
    };
    i._jsonToData = function(s) {
      var n = JSON.parse(s);
      ...
      for (m = 0; m < q; m++) {
        t = n.results[m];
        if (t.sectionResults.length) {
          k = t.sectionName.toLowerCase();
          if (this.lastQuery === "" && k === "quicklinks") {
            k = "defaultlinks"
          }
          t.sectionName = k;
          t.sectionLabel = j[k] || k;
          t.sectionAnalyticsEvent = d[k];
          for (l = 0; l < t.sectionResults.length; l++) {
            t.sectionResults[l].rawLabel = t.sectionResults[l].label;
            t.sectionResults[l].label = this._boldQueryTerms(t.sectionResults[l].label);
            t.sectionResults[l].index = l
          }
          if (k === "quicklinks") {
            o.unshift(t)
          } else {
      ...
      if (o.length) {
        ...
        if (this.lastQuery === "") {
          ...
          n.noresults = j.noresults
        }
      }
      n.query = this.lastQuery;
      n.initial = !("results" in this.attributes);
      return n
    };
    i._onFetchSuccess = function(n, l, k, o) {
      var m;
      if (n !== this._lastRequestTime) {
        return
      }
      m = this._jsonToData(l);
      this.set(m);
      this._trigger("fetchdata:success", m)
    };
    i._onFetchError = function(l, k) {
      this._trigger("fetchdata:error", {
        request: l,
        status: k
      })
    };
    i._onFetchComplete = function(l, k) {
    ...
    "./sectionAnalyticsEvents": 208,
    "./sectionLabels": 209,
    "@marcom/ac-polyfills/Date/now": 158,
    "@marcom/ac-polyfills/JSON": 161,
    "ac-ajax-xhr": 175,
    "ac-mvc-model": 190
  }],
  206: [function(d, c, g) {
    var f = d("@marcom/ac-classlist");
    var i = d("@marcom/ac-dom-events/utils/addEventListener");
    var a = d("@marcom/ac-dom-traversal/querySelectorAll");
    var o = d("@marcom/ac-event-emitter-micro").EventEmitterMicro;
    var b = d("@marcom/ac-dom-events/target");
    var j = d("../../helpers/keyMap");
    var l = d("@marcom/ac-object/clone");
    var n = "ac-gn-searchresults-link";
    var k = "current";
    var m = function(p) {
      o.call(this);
      this.el = p;
      ...
      i(this.el, "mousemove", this._onMouseMove.bind(this));
      i(this.el, "mouseleave", this._onMouseLeave.bind(this))
    };
    var h = m.prototype = Object.create(o.prototype);
    h._onMouseMove = function(p) {
      var r = b(p);
      var q;
      if (f.contains(r, n) && !f.contains(r, k)) {
        this.setSelectedElement(r, true)
      }
    };
    h._onMouseLeave = function(p) {
      var q = b(p);
      if (q === this.el) {
        this.setSelected()
      }
    };
    h.updateSelectableItems = function() {
      var p = a("." + n);
      var r;
      var q;
      this._selectableItems = [];
      ...
      for (q = 0; q < p.length; q++) {
        ...
        this._selectableItems.push({
          ...
          value: r.textContent || r.innerText,
          index: q,
          hover: false
        })
      }
    };
    h.getSelectableItems = function() {
      return this._selectableItems
    };
    h.setSelected = function(q, p) {
      q = q || false;
      if (this._selectedItem && this._selectedItem !== q) {
        this._selectedItem.hover = false;
        f.remove(this._selectedItem.element, k)
      }
      if (q) {
        q.hover = !!p;
        f.add(q.element, k)
      }
      if (this._selectedItem !== q) {
        this._selectedItem = q;
        if (q) {
          q = l(q)
        }
        this.trigger("change", q)
      }
    };
    h.setSelectedIndex = function(p, q) {
      this.setSelected(this._selectableItems[p], q)
    };
    h.setSelectedElement = function(r, q) {
      var p;
      for (p = 0; p < this._selectableItems.length; p++) {
        if (this._selectableItems[p].element === r) {
          this.setSelected(this._selectableItems[p], q);
          return
        }
      }
    ...
    h._moveUp = function() {
      var q = this.getSelectableItems();
      var p = this.getSelected();
      if (p) {
        if (p.index > 0) {
          this.setSelected(q[p.index - 1])
        } else {
          this.setSelected()
        }
      }
    };
    h._moveDown = function() {
      var q = this.getSelectableItems();
      var p = this.getSelected();
      if (p) {
        if (q[p.index + 1]) {
        ...
        if (q[0]) {
          this.setSelected(q[0])
        }
      }
    };
    h.goToSelected = function() {
    ...
    "@marcom/ac-dom-traversal/querySelectorAll": 78,
    "@marcom/ac-event-emitter-micro": 82,
    "@marcom/ac-object/clone": 133
  }],
  207: [function(b, a, d) {
    var h = b("mustache");
    var c = b("@marcom/ac-classlist");
    var i = b("../../../../mustache/results.mustache");
    var k = "with-content";
    var j = "with-content-initial";
    var g = function(l) {
      this.el = l;
      this.visible = false;
    ...
    var f = g.prototype;
    f.render = function(l) {
      if (!l.results && !l.noresults) {
        this.reset()
      } else {
        this.el.innerHTML = h.render(i, l);
        if (!this.visible) {
          c.add(this.el, k, j);
    ...
    f.reset = function() {
      c.remove(this.el, k, j);
      this.el.innerHTML = "";
      this.visible = false
    };
    f._removeInitial = function() {
      c.remove(this.el, j)
    };
    a.exports = g
  }, {
    "../../../../mustache/results.mustache": 211,
    "@marcom/ac-classlist": 31,
    mustache: 192
  }],
  208: [function(b, c, a) {
  ...
  209: [function(b, c, a) {
    var d = document.getElementById("ac-gn-searchresults");
    var f;
    if (d) {
      f = {
        quicklinks: d.getAttribute("data-string-quicklinks"),
        defaultlinks: d.getAttribute("data-string-quicklinks"),
        suggestions: d.getAttribute("data-string-suggestions"),
        noresults: d.getAttribute("data-string-noresults")
      }
    }
    c.exports = f
  }, {}],
  210: [function(f, b, h) {
    f("@marcom/ac-polyfills/Object/keys");
    var p = f("mustache");
    var q = f("../../../mustache/segment.mustache");
    var g = f("@marcom/ac-classlist");
    var j = f("@marcom/ac-dom-events/utils/addEventListener");
    var a = f("@marcom/ac-dom-nodes/hasAttribute");
    var m = f("@marcom/ac-dom-events/preventDefault");
    var l = f("@marcom/ac-dom-events/target");
    var n = "ac-gn-segmentbar-visible";
    var k = "{%STOREFRONT%}";
    var o = "/shop/goto/home";
    var c = "/shop/goto/exitstore";

    function d(s, r) {
      this.el = s;
      this.store = window.acStore;
      this.strings = JSON.parse(this.el.getAttribute("data-strings").replace(/[']/g, '"'));
      this.redirect = r.segmentbarRedirect || a(this.el, "data-redirect");
      this.storeRootPath = "/" + r.storeLocale;
      j(this.el, "click", this._onClick.bind(this))
    }
    var i = d.prototype;
    i._onClick = function(r) {
      var s = l(r);
      if (s.id === "ac-gn-segmentbar-exit") {
    ...
    i._getViewCopyFromSegmentCode = function(t) {
      var r;
      var s;
      if (t in this.strings.segments && this.strings.segments[t]) {
        return this.strings.segments[t]
      }
      r = Object.keys(this.strings.segments);
      for (s = 0; s < r.length; s++) {
        if (t.indexOf(r[s] + "-") === 0 && this.strings.segments[r[s]]) {
          return this.strings.segments[r[s]]
        }
      }
    ...
    i.show = function(r) {
      ...
      var t;
      if (r.name) {
        s = this.strings.view.replace(k, r.name)
      } else {
        s = this._getViewCopyFromSegmentCode(r.segmentCode)
      }
      t = {
        view: {
          copy: s,
          url: "//www.apple.com" + this.storeRootPath + o
        },
        exit: {
      ...
      this.el.innerHTML = p.render(q, t);
      g.add(document.documentElement, n)
    };
    i.hide = function() {
      g.remove(document.documentElement, n)
    };
    b.exports = d
  }, {
    "../../../mustache/segment.mustache": 212,
    "@marcom/ac-classlist": 31,
    "@marcom/ac-dom-events/preventDefault": 40,
    "@marcom/ac-dom-events/target": 43,
    "@marcom/ac-dom-events/utils/addEventListener": 44,
    "@marcom/ac-dom-nodes/hasAttribute": 54,
    "@marcom/ac-polyfills/Object/keys": 163,
    mustache: 192
  }],
  211: [function(b, c, a) {
