! function() {
  ...
  2: [function(t, e, i) {
    ...
    r.isFocusableElement = function(t, e, i) {
      ...
      return s ? !t.disabled : !t.contentEditable || (i = i || parseFloat(t.getAttribute("tabindex")), !isNaN(i))
  ...
  4: [function(t, e, i) {
    ...
    e.exports = function s(t, e, i) {
      e = e || document.body;
      for (var r = t, a = t; r = r.previousElementSibling;) n(r, i);
      for (; a = a.nextElementSibling;) n(a, i);
  ...
  6: [function(t, e, i) {
    ...
    e.exports = function(t) {
      o(t, a), o(t, s.HIDDEN);
      for (var e = t.querySelectorAll("[" + (r + a) + "]"), i = e.length; i--;) o(e[i], a)
    }
  }, {
    "./../maps/ariaMap": 8,
    "./removeAttributes": 5
  ...
  7: [function(t, e, i) {
    ...
    e.exports = function s(t, e) {
      e = e || document.body;
      for (var i = t, r = t; i = i.previousElementSibling;) n(i);
  ...
  12: [function(t, e, i) {
    ...
    e.exports = {
      parentNode: function(t, e, i) {
        if (i = i || "target", t && !n(t, d)) throw new TypeError(e + ": " + i + f)
      },
      childNode: function(t, e, i) {
        if (i = i || "target", t && !n(t, l)) throw new TypeError(e + ": " + i + m)
      },
      insertNode: function(t, e, i) {
        if (i = i || "node", t && !n(t, h)) throw new TypeError(e + ": " + i + u)
      },
      hasParentNode: function(t, e, i) {
        if (i = i || "target", !t.parentNode) throw new TypeError(e + ": " + i + _)
      }
    }
  }, {
    "../NODE_TYPES": 10,
  ...
  18: [function(t, e, i) {
    ...
    e.exports = r(n), e.exports.original = n
  }, {
    "./helpers/globals": 17,
  ...
  21: [function(t, e, i) {
    ...
    _._getStickyEnabled = function() {
      ...
      var e;
      this.menu.isOpen() && (null === this._menuCollapseOnScroll && (this._menuCollapseOnScroll = this.tray.offsetHeight >= this.tray.scrollHeight), this._menuCollapseOnScroll ? (this._closeMenu(), this.menu.anchorOpen.focus()) : (e = t.target, n(e, m) && s(e, this._selectors.traySelector, !0) || (t.preventDefault(), this._menuCollapseOnScroll = !0)))
      ...
      this.menu.close()
    }, _.destroy = function() {}, e.exports = f
  }, {
  ...
  22: [function(t, e, i) {
    ...
    n.prototype.constructor = n, a.update = function() {
      var t = this.isOpen();
  ...
  23: [function(t, e, i) {
    ...
    function n(t) {
      s.call(this), this._selector = t, this._touching = !1, document.addEventListener("click", this._onClick.bind(this)), document.addEventListener("touchstart", this._onTouchStart.bind(this)), document.addEventListener("touchend", this._onTouchEnd.bind(this))
    }
    var s = t("@marcom/ac-event-emitter-micro/EventEmitterMicro"),
      r = t("@marcom/dom-traversal/ancestors"),
      a = s.prototype,
      o = n.prototype = Object.create(a);
    n.prototype.constructor = n, o._checkTarget = function(t) {
      var e = t.target;
  ...
  24: [function(t, e, i) {
    ...
    u.prototype.constructor = u, m._featureDetection = function() {
      var t = s("position", "sticky") && !h,
        e = c;
      t || (e = "no-" + e), this.el.classList.add(e), this.placeholder.classList.add(e)
      ...
      t += document.documentElement.offsetTop + document.body.offsetTop, t !== this._placeholderOffset && (this._placeholderOffset = t, this._updatePosition())
    }, m._updatePosition = function() {
      var t = a("y");
      t > this._placeholderOffset ? this.stuck || (this.el.classList.add(this._selectors.stuckClassName), this.placeholder.classList.add(this._selectors.stuckClassName), this.stuck = !0, this.trigger("stuck")) : this.stuck && (this.el.classList.remove(this._selectors.stuckClassName), this.placeholder.classList.remove(this._selectors.stuckClassName), this.stuck = !1, this.trigger("unstuck"))
    }, e.exports = u
  }, {
  ...
  25: [function(t, e, i) {
    ...
    e.exports = function(t) {
      ...
      for (r = s(), t = a(t), i = t.charAt(0).toUpperCase() + t.substring(1), e = "filter" === t ? ["WebkitFilter", "filter"] : (t + " " + o.dom.join(i + " ") + i).split(" "), h = 0; h < e.length; h++)
        if ("undefined" != typeof r.style[e[h]]) return 0 !== h && o.reduce(h - 1), c(t, e[h]);
      return c(t, !1)
    }
  }, {
  ...
  26: [function(t, e, i) {
    ...
    e.exports = function(t, e) {
      var i;
      return e += "", !!(t = n(t)) && (s(t, e) ? e : (i = a[t].css, e = e.replace(h, function(e) {
        var n, a, h, u;
        if ("#" === e[0] || !isNaN(e[0])) return e;
        if (a = e.replace(c, ""), h = i + ":" + a, h in o) return o[h] === !1 ? "" : e.replace(a, o[h]);
  ...
  30: [function(t, e, i) {
    "use strict";
    var n, s, r = t("./stylePropertyCache"),
    ...
    e.exports = function(t, e) {
      var i, o;
      if (c(), n) return t = r[t].css, CSS.supports(t, e);
      if (o = a(), i = o.style[t], s) try {
        o.style[t] = e
      } catch (h) {
        return !1
      } else o.style[t] = e;
  ...
  34: [function(t, e, i) {
    ...
    function n(t) {
      t = t || {}, r.call(this), this.id = o.getNewID(), this.executor = t.executor || a, this._reset(), this._willRun = !1, this._didDestroy = !1
    }
    var s, r = t("@marcom/ac-event-emitter-micro").EventEmitterMicro,
      a = t("./sharedRAFExecutorInstance"),
      o = t("./sharedRAFEmitterIDGeneratorInstance");
    s = n.prototype = Object.create(r.prototype), s.run = function() {
  ...
  35: [function(t, e, i) {
    ...
    var s, r = t("@marcom/ac-event-emitter-micro/EventEmitterMicro");
    s = n.prototype, s.frameRequestedPhase = "requested", s.startPhase = "start", s.runPhases = ["update", "external", "draw"], s.endPhase = "end", s.disabledPhase = "disabled", s.beforePhaseEventPrefix = "before:", s.afterPhaseEventPrefix = "after:", s.subscribe = function(t, e) {
  ...
  36: [function(t, e, i) {
    ...
    r.requestAnimationFrame = function(t, e) {
      ...
      this._cancelFrameIdx = this._nextFrameCallbacks.indexOf(t), this._cancelFrameIdx > -1 ? this._cancelNextAnimationFrame() : (this._cancelFrameIdx = this._currentFrameCallbacks.indexOf(t),
  ...
  43: [function(t, e, i) {
    ...
    o || (o = s[r] = {}), o[a] || (o[a] = c), e.exports = o[a]
  }, {}],
  44: [function(t, e, i) {
    "use strict";
    ...
    e.exports = function(t, e) {
      ...
      e = "string" === i ? t : e, t = t && "string" !== i ? t : window;
      var n = t === window;
  ...
  46: [function(t, e, i) {
    ...
    e.exports = function(t, e, i, a) {
      var o = [];
      if (s.childNode(t, "ancestors"), s.selector(e, "ancestors"), i && n(t, r) && (!e || t.matches(e)) && o.push(t), a = a || document.body, t !== a)
        for (;
  ...
  47: [function(t, e, i) {
    ...
    e.exports = {
      parentNode: function(t, e) {
        if (!t || !n(t, u)) throw new TypeError(e + ": node" + l)
      },
      childNode: function(t, e) {
        if (!t || !n(t, m)) throw new TypeError(e + ": node" + d)
      },
      selector: function(t, e, i) {
        if (i = "boolean" == typeof i && i, (t || i) && "string" != typeof t) throw new TypeError(e + ": selector" + f)
      }
    }
  }, {
    "@marcom/ac-dom-nodes/NODE_TYPES": 10,
  ...
  49: [function(t, e, i) {
    ...
    e.exports = function(t, e) {
      ...
      var i = function s() {
        var i = arguments,
          n = e.apply(this, i);
        return n in s.cache || (s.cache[n] = t.apply(this, i)), s.cache[n]
      };
      return i.cache = {}, i
    }
  }, {}],
  ...
  52: [function(t, e, i) {
    ...
    function s(t, e) {
      ...
      for (var s, r = i.length, a = 0; a < r; a++)
        if (s = e.match(n(i[a])), s && s.length > 1) return s[1].replace(/_/g, ".");
      return !1
    }

    function r(t, e, i) {
      for (var n, r, a = t.length, o = 0; o < a; o++)
        if ("function" == typeof t[o].test ? t[o].test(i) === !0 && (n = t[o].name) : i.ua.indexOf(t[o].userAgent) > -1 && (n = t[o].name), n) {
          if (e[n] = !0, r = s(t[o], i.ua), "string" == typeof r) {
            var c = r.split(".");
    ...
    function a(t) {
      var e = {};
      return e.browser = r(c.browser, o.browser, t), e.os = r(c.os, o.os, t), e
    }
    var o = t("./defaults"),
      c = t("./dictionary");
    e.exports = a
  ...
  54: [function(t, e, i) {
    ...
    Object.defineProperty(l, "id", {
      ...
      return e || (e = document.createElement("div"), e.id = t, e = document.body.appendChild(e)), e.hasAttribute(o.DOM_DISPATCH) || (e.setAttribute(o.DOM_DISPATCH, ""), this._allowDOMEventDispatch = !0), e.hasAttribute(o.STATE) || (this._allowElementStateData = !0), e
  ...
  55: [function(t, e, i) {
    ...
    var n = t("@marcom/ac-localnav/Localnav"),
      ...
      o = function(t) {
        var e = new s(t, r);
        e.htmlClass(), n.call(this, t, {
          className: "ac-ln",
          selector: "#ac-localnav"
        });
        var i = this.el.querySelectorAll("a.ac-ln-menucta-anchor");
        this._updateComingSoonSubheadClasses(), this._sticky && (this._analyticsRegion = this.el.getAttribute("data-analytics-region"), this._updateAnalyticsRegion = this._updateAnalyticsRegion.bind(this), this._sticky.on("stuck", this._updateAnalyticsRegion), this._sticky.on("unstuck", this._updateAnalyticsRegion)), i.forEach(function(t) {
    ...
    o.prototype.constructor = o, h._getStickyEnabled = function() {
      ...
      this._sticky.stuck && (t += " " + a), this.el.setAttribute("data-analytics-region", t)
