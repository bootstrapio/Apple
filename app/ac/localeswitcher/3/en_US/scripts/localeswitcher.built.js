! function e(t, n, r) {
  ...
  1: [function(e, t, n) {
    ...
    var r = e(4),
      ...
      o = e(7),
      s = e(6),
      a = e(47).EventEmitterMicro,
      l = a.prototype,
      c = e(8),
      u = e(10),
      h = [c.BUSY, c.CHECKED, c.DISABLED, c.EXPANDED, c.HIDDEN, c.INVALID, c.PRESSED, c.SELECTED],
      p = function(e, t) {
        a.call(this), this._options = t || {}, this._selector = t.selector || ".navitem", this._allowMultiSelection = t.multiSelection || !1;
        var n = h.indexOf(t.state) > -1 ? t.state : c.SELECTED;
    ...
    p.ONSELECT = "onSelect", p.ONFOCUS = "onFocus";
    var d = p.prototype = Object.create(l);
    d._setup = function() {
      ...
      s(t.getAttribute(this._state)) && (this.focusedNavItemIndex = e, this.selectedNavitemIndex = e), s(t.getAttribute(c.DISABLED)) ? r(t) : i(t)
    }, d.start = function() {
      ...
      t.preventDefault(), this.previousNavItemIndex = this.focusedNavItemIndex, this.focusedNavItemIndex = this._calculateIndex(e, this.focusedNavItemIndex), this._navItems[this.focusedNavItemIndex].focus(), n || this.trigger(p.ONFOCUS, {
        event: t,
      ...
      n > -1 && document.activeElement !== this._navItems[this.focusedNavItemIndex] && (this.focusedNavItemIndex = n), this._allowMultiSelection ? this._toggleState() : (o(this._navItems[this.selectedNavitemIndex], this._state, "false"), o(this._navItems[this.focusedNavItemIndex], this._state, "true")), this.selectedNavitemIndex = this.focusedNavItemIndex, t || this.trigger(p.ONSELECT, {
        event: e,
      ...
      s(e) ? o(this._navItems[this.focusedNavItemIndex], this._state, "false") : o(this._navItems[this.focusedNavItemIndex], this._state, "true")
    }, d._calculateIndex = function(e, t) {
      var n = t;
      if (!0 === e) {
        if (n = ++n >= this._navItems.length ? 0 : n, !s(this._navItems[n].getAttribute(c.DISABLED)) || this._navItems[n].hasAttribute("disabled")) return n
      } else if (n = --n < 0 ? this._navItems.length - 1 : n, !s(this._navItems[n].getAttribute(c.DISABLED)) || this._navItems[n].hasAttribute("disabled")) return n;
      ...
      e && e.nodeType && this._navItems.indexOf(e) < 0 && (s(e.getAttribute(c.DISABLED)) || i(e), this._navItems.push(e))
    }, d.setSelectedItemByIndex = function(e, t) {
      this._allowMultiSelection || isNaN(this.selectedNavitemIndex) || o(this._navItems[this.selectedNavitemIndex], this._state, "false"), this.focusedNavItemIndex = e, this.selectedNavitemIndex = e, o(this._navItems[this.selectedNavitemIndex], this._state, "true"), t || this.trigger(p.ONSELECT, {
        event: null,
        index: this.focusedNavItemIndex,
        el: this._navItems[this.focusedNavItemIndex]
      })
  ...
  3: [function(e, t, n) {
    ...
    o.isFocusableElement = function(e, t, n) {
      ...
      var i = e.nodeName.toLowerCase(),
        o = r.indexOf(i) > -1;
      return "a" === i || (o ? !e.disabled : !e.contentEditable || (n = n || parseFloat(e.getAttribute("tabindex")), !isNaN(n)))
  ...
  44: [function(e, t, n) {
    ...
    var r = e(97),
      i = e(105);
    t.exports = function() {
      var e, t, n, o, s = Array.prototype.slice.call(arguments),
        a = s.shift(s),
        l = window.getComputedStyle(a),
        c = {};
      for ("string" != typeof s[0] && (s = s[0]), o = 0; o < s.length; o++) e = s[o], (t = r(e)) ? (e = i(t), (n = l[t]) && "auto" !== n || (n = null), n && (n = i(n))) : n = null, c[e] = n;
      return c
    }
  }, {
    105: 105,
  ...
  46: [function(e, t, n) {
    ...
    t.exports = function(e, t) {
      ...
      for (s in t)(l = o(t[s])) || 0 === l ? !1 !== (n = r(s, l)) && (u += " " + n) : (a = i(s), "removeAttribute" in e.style ? e.style.removeAttribute(a) : e.style[a] = "");
      return u.length && (";" !== (c = e.style.cssText).charAt(c.length - 1) && (c += ";"), c += u, e.style.cssText = c), e
    }
  }, {
    45: 45,
    96: 96,
  ...
  49: [function(e, t, n) {
    "use strict";
    t.exports = {
      canvasAvailable: e(50),
      continuousScrollEventsAvailable: e(51),
      cookiesAvailable: e(52),
      cssLinearGradientAvailable: e(53),
      cssPropertyAvailable: e(54),
      cssViewportUnitsAvailable: e(55),
      elementAttributeAvailable: e(56),
      eventTypeAvailable: e(57),
      isDesktop: e(59),
      isHandheld: e(60),
      isRetina: e(61),
      isTablet: e(62),
      localStorageAvailable: e(63),
      mediaElementsAvailable: e(64),
      mediaQueriesAvailable: e(65),
      prefersReducedMotion: e(66),
      sessionStorageAvailable: e(67),
      svgAvailable: e(68),
      threeDTransformsAvailable: e(69),
      touchAvailable: e(70),
      webGLAvailable: e(71)
    }
  }, {
  ...
  75: [function(e, t, n) {
    ...
    function l(e) {
      this._keysDown = {}, this._DOMKeyDown = this._DOMKeyDown.bind(this), this._DOMKeyUp = this._DOMKeyUp.bind(this), this._context = e || document, i(this._context, "keydown", this._DOMKeyDown, !0), i(this._context, "keyup", this._DOMKeyUp, !0), r.call(this)
    }
    var c = l.prototype = s(r.prototype);
    c.onDown = function(e, t) {
      return this.on("keydown:" + e, t)
    }, c.onceDown = function(e, t) {
      return this.once("keydown:" + e, t)
    }, c.offDown = function(e, t) {
      return this.off("keydown:" + e, t)
    }, c.onUp = function(e, t) {
      return this.on("keyup:" + e, t)
    }, c.onceUp = function(e, t) {
      return this.once("keyup:" + e, t)
    }, c.offUp = function(e, t) {
      ...
      return o(this._context, "keydown", this._DOMKeyDown, !0), o(this._context, "keyup", this._DOMKeyUp, !0), this._keysDown = null, this._context = null, r.prototype.destroy.call(this), this
    }, c._DOMKeyDown = function(e) {
      var t = this._normalizeKeyboardEvent(e),
        n = t.keyCode += "";
      this._trackKeyDown(n), this.trigger("keydown:" + n, t)
    }, c._DOMKeyUp = function(e) {
      var t = this._normalizeKeyboardEvent(e),
        n = t.keyCode += "";
      this._trackKeyUp(n), this.trigger("keyup:" + n, t)
    }, c._normalizeKeyboardEvent = function(e) {
      return new a(e)
    }, c._trackKeyUp = function(e) {
      this._keysDown[e] && (this._keysDown[e] = !1)
    }, c._trackKeyDown = function(e) {
  ...
  76: [function(e, t, n) {
    ...
    function i(e) {
      var t;
      for (t in this.originalEvent = e, e) - 1 === r.indexOf(t) && "function" != typeof e[t] && (this[t] = e[t]);
  ...
  96: [function(e, t, n) {
    ...
    t.exports = function(e, t) {
      var n;
      if (!(e = i(e))) return !1;
      if (n = r[e].css, void 0 !== t) {
        if (!1 === (t = o(e, t))) return !1;
        n += ":" + t + ";"
      }
      return n
    }
  ...
  105: [function(e, t, n) {
    ...
    t.exports = function(e) {
      return (e = String.prototype.replace.call(e, r, "")).charAt(0).toLowerCase() + e.substring(1)
    }
  }, {}],
  106: [function(e, t, n) {
    "use strict";
              ...
              switch (g[0]) {
                ...
                case 2:
                  if (_ = this.productions_[g[1]][1], w.$ = r[r.length - _], w._$ = {
                    ...
                    }, h && (w._$.range = [i[i.length - (_ || 1)].range[0], i[i.length - 1].range[1]]), void 0 !== (m = this.performAction.call(w, s, l, a, this.yy, g[1], r, i))) return m;
                  _ && (n = n.slice(0, -1 * _ * 2), r = r.slice(0, -1 * _), i = i.slice(0, -1 * _)), n.push(this.productions_[g[1]][0]), r.push(w.$), i.push(w._$), y = o[n[n.length - 2]][n[n.length - 1]], n.push(y);
                  break;
                case 3:
                  return !0
              }
  ...
  157: [function(e, t, n) {
    ...
    function o(t, n) {
      var i = e(119).readFileSync(n, "utf8");
  ...
  164: [function(e, t, n) {
    ...
    l.fromSourceMap = function(e, t) {
      ...
      for (var n, i, o, l, c, h = 1, p = 0, d = 0, f = 0, g = 0, m = 0, v = e.length, _ = 0, y = {}, b = {}, x = [], w = []; _ < v;)
        if (";" === e.charAt(_)) h++, _++, p = 0;
        else if ("," === e.charAt(_)) _++;
      else {
        for ((n = new u).generatedLine = h, l = _; l < v && !this._charIsMappingSeparator(e, l); l++);
        if (o = y[i = e.slice(_, l)]) _ += i.length;
        else {
          for (o = []; _ < l;) s.decode(e, _, b), c = b.value, _ = b.rest, o.push(c);
  ...
  166: [function(e, t, n) {
    var r = e(165).SourceMapGenerator,
      i = e(167),
      o = /(\r?\n)/,
      s = "$$$isSourceNode$$$";
  ...
  168: [function(e, t, n) {
    n.SourceMapGenerator = e(165).SourceMapGenerator, n.SourceMapConsumer = e(164).SourceMapConsumer, n.SourceNode = e(166).SourceNode
  }, {
    164: 164,
    165: 165,
    166: 166
    ...
    (function(e) {
      (function() {
        ! function(e) {
          ...
          function i(e) {
            this.tokens = [], this.tokens.links = {}, this.options = e || _.defaults, this.rules = r.normal, this.options.gfm && (this.options.tables ? this.rules = r.tables : this.rules = r.gfm)
          }
          ...
          function s(e, t) {
            if (this.options = t || _.defaults, this.links = e, this.rules = o.normal, this.renderer = this.options.renderer || new a, this.renderer.options = this.options, !this.links) throw new Error("Tokens array requires a `links` property.");
          ...
          function c(e) {
            this.tokens = [], this.token = null, this.options = e || _.defaults, this.options.renderer = this.options.renderer || new a, this.renderer = this.options.renderer, this.renderer.options = this.options
          }
          ...
          function _(e, t, n) {
            ...
            if (n || "function" == typeof t) {
              n || (n = t, t = null);
              var r, o, s = (t = v({}, _.defaults, t || {})).highlight,
                a = 0;
              try {
                r = i.lex(e, t)
              } catch (e) {
              ...
              return t && (t = v({}, _.defaults, t)), c.parse(i.lex(e, t), t)
            } catch (e) {
              if (e.message += "\nPlease report this to https://github.com/markedjs/marked.", (t || _.defaults).silent) return "<p>An error occurred:</p><pre>" + u(e.message + "", !0) + "</pre>";
              throw e
            }
          }
          m.exec = m, _.options = _.setOptions = function(e) {
            return v(_.defaults, e), _
          }, _.defaults = {
            gfm: !0,
            tables: !0,
            breaks: !1,
            ...
            xhtml: !1,
            baseUrl: null
          }, _.Parser = c, _.parser = c.parse, _.Renderer = a, _.TextRenderer = l, _.Lexer = i, _.lexer = i.lex, _.InlineLexer = s, _.inlineLexer = s.output, _.parse = _, void 0 !== t && "object" == typeof n ? t.exports = _ : "function" == typeof define && define.amd ? define((function() {
            return _
          })) : e.marked = _
  ...
  174: [function(e, t, n) {
    ...
    var r = null;
    try {
      r = e("@marcom/ac-analytics").observer.Event
    } catch (e) {}
    var i = e(47).EventEmitterMicro,
      o = e(1),
      s = e(75),
      a = e(77),
      l = e(63),
    ...
    function _() {
      this._options = v, this._eventEmitterMicro = new i, this._setLanguageCountryCodes(), this._userLangLocale && this._loadJson(this._userLangLocale)
    }
    var y = _.prototype;
    y._setLanguageCountryCodes = function() {
    ...
    }, y._loadJsonComplete = function() {
      this._setMetaData(), this._shouldInitialize = this._shouldInitializeLocaleSwitcher(), this._shouldInitialize && this._addStyleSheet()
    }, y._setMetaData = function(e) {
      var t = {};
      t.optOutDismissalMax = parseInt(this._jsonData.localeswitcher.exit.metadata.dismiss), t.optOutDaysToExpiration = parseInt(this._jsonData.localeswitcher.exit.metadata.duration), this._options = Object.assign(v, t)
    }, y._addStyleSheet = function() {
    ...
    }, y._loadStylesComplete = function() {
      this._shouldInitialize && this._addLocaleSwitcherContent()
    }, y._addLocaleSwitcherContent = function() {
      var e = f.compile(m)(this._jsonData);
    ...
    }, y._setUpEventListeners = function() {
      "ontouchstart" in document.documentElement ? document.addEventListener("touchstart", this._handleDropdownClickAway) : document.addEventListener("click", this._handleDropdownClickAway), document.getElementById("ac-ls-close").addEventListener("click", this._handleCloseBarEvent), document.getElementById("ac-ls-continue").addEventListener("click", this._handleContinueButtonEvent.bind(this)), this._initializeDropdownToggle()
    }, y._getUserBrowserLanguage = function() {
      return (navigator.language || navigator.userLanguage || navigator.browserLanguage || navigator.systemLanguage || "en-US").substring(0, 2)
    }, y._hasOptedOut = function() {
      var e = !1;
      if (l()) {
        this.storageItem = new c("ls-opt-out"), this.storageItem.load(), this._removeExpiredLocalStorage();
        var t = this.storageItem.value();
        null === t ? this._createLocalStorage() : t.dismissals === this._options.optOutDismissalMax && (e = !0)
      } else e = !0;
      return e
    }, y._createLocalStorage = function() {
      this.storageItem.setValue({
        dismissals: 0
      }), this.storageItemExpiration = c.createExpirationDate(this._options.optOutDaysToExpiration), this.storageItem.setExpirationDate(this.storageItemExpiration), this.storageItem.save()
    }, y._removeExpiredLocalStorage = function() {
      var e = this.storageItem.expirationDate();
      c.createExpirationDate(0) > e && this.storageItem.remove()
    }, y._setOptOutCounter = function() {
      var e = this.storageItem.value().dismissals;
      e < this._options.optOutDismissalMax && (this.storageItem.setValue({
        dismissals: e + 1
      }), this.storageItem.save())
    }, y._localeLanguageInHrefLangDoesNotExist = function() {
      return !document.querySelector("[hreflang=" + this._userLangLocale + "]")
    }, y._userLanglocaleMatchesCurrentLocale = function() {
      return document.documentElement.getAttribute("lang") === this._userLangLocale
    }, y._segmentBarVisible = function() {
      return document.documentElement.classList.contains("ac-gn-segmentbar-visible")
    }, y._setPageTrackingData = function(e) {
      ...
      return e
    }, y._setContinueButton = function(e) {
    ...
    }, y._onRAFUpdate = function() {
      this._elHeight = p(this.el, "height").height
    }, y._onRAFDraw = function() {
    ...
    }, y._determineAnalyticsEvents = function() {
      for (var e, t = 0, n = this._listItems.length - 1; t <= n; t++) {
        this._listItems[t].getAttribute("data-href") === this._selectedLink && (e = t)
      }
      var r = "event142";
      return 0 === e ? r = "event141" : e === this._listItems.length - 1 && (r = "event143"), r
    }, y._handleContinueButtonEvent = function(e) {
      e.preventDefault();
      var t = "event144," + this._determineAnalyticsEvents();
      r && new r(this._eventEmitterMicro).track({
    ...
    }, y._handleCloseBarEvent = function() {
      r && new r(this._eventEmitterMicro).track({
      ...
      document.documentElement.classList.remove(this._selectors.visibleClass), document.documentElement.classList.remove(this._selectors.fixedClass), document.documentElement.classList.remove(this._selectors.cnHpClass), d(document.documentElement, {
        "margin-top": ""
      }), d(this.el, {
        top: ""
    ...
    }, y._handleDropdownClickAway = function(e) {
    ...
    }, y._closeDropdown = function() {
      this._selectIsOpen && (this._dropdownList.setAttribute("aria-expanded", "false"), this._dropdownList.parentElement.classList.add(this._selectors.dropdownCollapsedClass), u(this._selectTrigger), this._selectTrigger.focus(), this._selectIsOpen = !1)
    }, y._dropdownFocusOut = function(e) {
      (e.currentTarget === this._firstFocusableMenuEl && !0 === e.shiftKey && (e.stopPropagation(), e.preventDefault(), this._closeDropdown()), e.currentTarget === this._lastFocusableMenuEl && !1 === e.shiftKey) && (e.stopPropagation(), e.preventDefault(), this._closeDropdown(), document.getElementById("ac-ls-continue").focus())
    }, y._getCookie = function(e) {
      var t = ("; " + document.cookie).split("; " + e + "=");
      if (2 === t.length) return t.pop().split(";").shift()
    }, y._getLocaleCode = function(e, t) {
      var n;
      return n = this._findCountryMatches(e), this._findLanguageMatches(n, t)
    }, y._findCountryMatches = function(e) {
      for (var t = [], n = document.querySelectorAll("[hreflang]"), r = 0; r < n.length; r++) {
        var i = n[r].hreflang;
        e === i.split("-")[1] && t.push(i)
      }
      return t
    }, y._findLanguageMatches = function(e, t) {
      var n = e[0];
      if (e.length > 1)
      ...
      return n
    }, y._getParameterByName = function(e, t) {
      t || (t = window.location.href);
      e = e.replace(/[\[\]]/g, "\\$&");
      var n = new RegExp("[?&]" + e + "(=([^&#]*)|&|#|$)").exec(t);
      return n ? n[2] ? decodeURIComponent(n[2].replace(/\+/g, " ")) : "" : null
    }, y._getAcFilePath = function(e) {
      var t = e.replace("-", "_"),
        n = "/ac/localeswitcher/" + this._options.releaseVersion + "/";
      return -1 !== window.location.href.indexOf("/tests/") && (n = "./../built/ac/localeswitcher/" + this._options.releaseVersion + "/"), n + t
    }, t.exports = _
  }, {
    1: 1,
    111: 111,
