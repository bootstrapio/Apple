require = function() {
  ...
  2: [function(require, module, exports) {
    ...
    var c = function() {
        for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, r = e.keyPrefix, t = void 0 === r ? "" : r, n = e.valuePrefix, a = void 0 === n ? "" : n, o = e.count, c = void 0 === o ? 0 : o, i = {}, u = 1; u <= c; u++) i["".concat(t).concat(u)] = "".concat(a).concat(u);
        return i
      },
      o = function(e) {
    ...
    var s = function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          r = p({}, e);
        return e.hasOwnProperty(o.EVENTS) && (r[o.EVENTS] = t.parseEventCollectionString(e[o.EVENTS])), e.hasOwnProperty(o.PRODUCTS) && (r[o.PRODUCTS] = t.parseProductCollectionString(e[o.PRODUCTS])), r
      },
      f = [function() {
  ...
  6: [function(require, module, exports) {
    ...
    exports.merge = function(r) {
      var t = r.target,
        ...
        c = r.mergers,
        i = void 0 === c ? {} : c;
      return "string" == typeof n.events && (n.events = e.parseEventCollectionString(n.events)), Object.keys(u).forEach(function(r) {
        i[r] ? n[r] = i[r](n[r], u[r]) : n[r] instanceof e.OmnitureCollection && u[r] instanceof e.OmnitureCollection ? n[r].merge(u[r]) : n[r] = u[r]
      }), n
    }, exports.mergers = r
  }, {
    "@apple/analytics-omniture-collection": 7
  ...
  9: [function(require, module, exports) {
    ...
    function o(e) {
      for (var r = 1; r < arguments.length; r++) {
        ...
        r % 2 ? a(Object(n), !0).forEach(function(r) {
          t(e, r, n[r])
    ...
    var l = function(e) {
      ...
      w = function(e) {
        return e.options && e.options.version ? e.schema = S(e.options.version) : e.allSchemas = S(), e
      },
      O = function() {
        return {
          set cookie(e) {
      ...
      j = function(e) {
        var t = e.key,
          ...
          a = void 0 === o ? O : o,
          i = "".concat(t, "=").concat(r);
        i += ";secure", i += ";samesite=strict", i += ";path=/", n && (i += ";domain=".concat(n)), a().cookie = i
      },
      P = function(e) {
        var t = e.key,
          r = e.value,
      ...
      N = function(e) {
        var t = e.key,
          ...
          o = void 0 === n ? O : n,
          a = "".concat(t, "=");
        a += ";secure", a += ";samesite=strict", a += ";path=/", a += ";expires=Thu, 01 Jan 1970 00:00:01 GMT", r && (a += ";domain=".concat(r)), o().cookie = a
      },
      A = function(e) {
        var t = e.key,
          r = e.api;
      ...
      C = function(e) {
        ...
        switch (e.destination) {
          case "cookie":
            ...
            e.options && e.options.cookieDomain && (r.cookieDomain = e.options.cookieDomain), j(r);
            break;
          case "session":
          default:
            P({
              ...
              value: e.transformed
            }), e.transformedSync && "" !== e.transformedSync && I({
              api: t,
      ...
      R = function(e) {
        var t = e.schema,
          ...
          c = i(r) && r.uuid ? p(r.uuid) : null,
          s = i(n) && n.uuid ? p(n.uuid) : null,
          u = i(r) && i(n),
          l = i(c) && i(s) && c.global === s.global,
          f = l && c.session === s.session;
        switch (!0) {
          case !i(r) && i(n):
            a = re({
              schema: t,
      ...
      M = function() {
        ...
        Object.values(r.allSchemas).forEach(function(e) {
          ...
          r.options && r.options.cookieDomain && (i.cookieDomain = r.options.cookieDomain), N(i), A({
            api: t,
            key: a
          }), V({
            api: t
      ...
      z = function(e, t) {
        return e.isSync ? "override" : B(e.schema, t)
      },
      B = function(e, t) {
      ...
      K = function(e, t) {
        ...
        if (e && t) {
          ...
          return n(analyticsOmnitureConstants.VARS.EVENTS, analyticsOmnitureCollection.parseEventCollectionString), n(analyticsOmnitureConstants.VARS.PRODUCTS, analyticsOmnitureCollection.parseProductCollectionString), r
        }
      },
      Q = function(e) {
        return e
        ...
        return e.transformed = {}, e.transformedSync = {}, e.destination = e.options && "cross" === e.options.origin ? "cookie" : "session", null === e.data || (!e.data.hasOwnProperty("minor") && e.options && e.options.hasOwnProperty("minor") && (e.data.minor = e.options.minor), t.data.forEach(function(t) {
          ...
          if (o.includes(e.destination) && e.data[r]) {
            var y = e.data[r],
              m = f(c, a)(y);
            if (m && "" !== m)
              if (e.transformed[n] = m, u) e.transformedSync[n] = m;
              else if ("uuid" === r) {
              var v = p(m).global;
              e.transformedSync[n] = d(v)
            }
          }
        })), e
      },
                  ...
                  if (e.newValue) {
                    ...
                    if (s) {
                      var l = re({
                        ...
                        d = p(l.uuid),
                        y = p(f.uuid),
                        m = d.global === y.global ? l.uuid : f.uuid;
    ...
    var cookieDomain = null,
      ...
      store = function(e) {
        ...
        if ("page" === t) {
          var o = {
            ...
            i = getCookieDomain();
          return null !== i && (a.cookieDomain = i), void oe({
      ...
      init = function() {
        ...
        var a = ae();
        return window.addEventListener("pagehide", triggerNewPage), window.addEventListener("beforeunload", triggerNewPage),
          function() {
            a(), window.removeEventListener("pagehide", triggerNewPage), window.removeEventListener("beforeunload", triggerNewPage)
          }
      },
      error = function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      ...
      mergeObjects = function(e, t) {
        ...
        return r && e.hasOwnProperty("events") && t.hasOwnProperty("events") && (n.events = analyticsOmnitureCollection.parseEventCollectionString(e.events).merge(analyticsOmnitureCollection.parseEventCollectionString(t.events)).toString()), r && e.hasOwnProperty("products") && t.hasOwnProperty("products") && (n.products = analyticsOmnitureCollection.parseProductCollectionString(e.products).merge(analyticsOmnitureCollection.parseProductCollectionString(t.products)).toString()), n
      },
      isObject = function(e) {
      ...
      append = function(e, t) {
        ...
        if (t) {
          ...
          if (null !== a && "function" != typeof a.concat || "function" != typeof t.concat) throw error("append", "cannot call append on this type of data");
          null !== a ? store({
            type: o,
            key: e,
            data: a.concat(t)
  ...
  11: [function(require, module, exports) {
    ...
    var c = {
      ...
      s = function(t) {
        ...
        switch (t) {
          case "quicklinks":
            n.add(new e.OmnitureEvent(c.COMPLETE)), n.add(new e.OmnitureEvent(c.QUICK_LINK));
            break;
          case "suggestions":
            n.add(new e.OmnitureEvent(c.SUGGESTED));
            break;
          case "defaultlinks":
            n.add(new e.OmnitureEvent(c.COMPLETE)), n.add(new e.OmnitureEvent(c.DEFAULT_LINK))
        }
        return n
      },
      ...
      l = function(t) {
        var n = t.accessoriesLink,
          ...
          i = t.results,
          E = t.isComplete,
          a = new e.OmnitureCollection(new e.OmnitureEvent(E ? c.COMPLETE : c.SEARCH));
        return 0 === i && a.add(new e.OmnitureEvent(c.NO_RESULTS_CLICK)), n && a.add(new e.OmnitureEvent(c.ACCESSORIES_LINK)), r && a.add(new e.OmnitureEvent(c.STORE_LINK)), o && a.merge(o.events), a
      },
      V = function(t) {
        var n, o = t.URLObject,
          i = t.serviceLink,
        ...
        if (o) {
          ...
          s && (n = r.getOne(s.token) || "aos_search_result", c.add(new e.OmnitureEvent(s.event)))
        }
        return n || (n = i ? E || "aos_search_result" : ""), {
          eVar17: n,
          events: c
        }
      },
    ...
    exports.accessoriesFilter = function() {
      var r, i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
        ...
        s = i.text,
        S = i.analyticsPrefix;
      return o(r = {}, t.VARS.EVAR_2, n.toStrTrim(E).toLowerCase()), o(r, t.VARS.EVAR_4, "".concat(n.toStrTrim(S), ":search:accessories")), o(r, t.VARS.PROP_3, "filter - ".concat(n.toStrTrim(a), " - ").concat(n.toStrTrim(s))), o(r, t.VARS.PROP_7, n.toStrTrim(E).toLowerCase()), o(r, t.VARS.EVENTS, new e.OmnitureCollection(new e.OmnitureEvent(c.ACCESSORIES_FILTER))), r
    }, exports.begin = function() {
      var r, i = (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}).action,
        E = void 0 === i ? "" : i;
      return o(r = {}, t.VARS.PROP_3, "".concat(n.toStrTrim(E) || "engage", " - search field")), o(r, t.VARS.EVENTS, new e.OmnitureCollection(new e.OmnitureEvent(c.BEGIN))), r
    }, exports.exit = function() {
      var r, i = (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}).keyword;
      return o(r = {}, t.VARS.PROP_7, n.toStrTrim(i).toLowerCase()), o(r, t.VARS.PROP_29, null), o(r, t.VARS.EVAR_2, "D=c7"), o(r, t.VARS.EVENTS, new e.OmnitureCollection(new e.OmnitureEvent(c.EXIT))), r
      ...
      var r, i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
        ...
        s = i.action,
        S = void 0 === s ? "click" : s;
      return o(r = {}, t.VARS.PROP_2, "".concat(n.toStrTrim(S), " - page ").concat(n.toStrTrim(E))), o(r, t.VARS.PROP_3, "".concat(n.toStrTrim(S), " - page ").concat(n.toStrTrim(a))), o(r, t.VARS.EVAR_15, "search (search)"), o(r, t.VARS.EVENTS, new e.OmnitureCollection(new e.OmnitureEvent(c.SEARCH), new e.OmnitureEvent(c.PAGINATION))), r
      ...
      return E({}, void 0 !== V ? o({}, t.VARS.EVAR_23, [O, N, d, u, V].map(n.toStrTrim).join("|")) : {}, (o(r = {}, t.VARS.PROP_7, S.includes(_) ? N : R || "___blank___"), o(r, t.VARS.EVAR_2, "D=c7"), o(r, t.VARS.EVAR_15, "".concat(n.toStrTrim(T), " (").concat("suggestions" === _ ? "typed" : n.toStrTrim(l), ")")), o(r, t.VARS.EVENTS, m.add(new e.OmnitureEvent(c.SEARCH))), r))
      ...
      var e, r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
        ...
        g = (o(e = {}, t.VARS.PROP_7, m), o(e, t.VARS.EVAR_2, "D=c7"), o(e, t.VARS.EVENTS, w), e);
      return A.eVar17 && (g[t.VARS.EVAR_17] = A.eVar17), !a && v && (g[t.VARS.PROP_29] = u([m, S, O, N, T])), d && (g[t.VARS.PROP_30] = u([m, S, O, _, T])), d && !c && (g[t.VARS.EVAR_15] = "null (clicked)"), g
    }, exports.serpPageLoad = function() {
      var r, i, a, s = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
        S = s.directLanding,
        l = s.keyword,
        V = s.intent,
        u = s.results,
      ...
      u || _.add(new e.OmnitureEvent(c.NO_RESULTS)), p && _.add(new e.OmnitureEvent(c.CURATED));
      var R = "".concat(n.toStrTrim(T), ":search");
      return E({}, (o(r = {}, t.VARS.PAGE_NAME, "".concat(R, ":").concat(n.toStrTrim(V))), o(r, t.VARS.PROP_7, n.toStrTrim(l).toLowerCase()), o(r, t.VARS.PROP_21, n.toStrTrim(u) || "0"), r), S ? (o(i = {}, t.VARS.EVAR_2, "D=c7"), o(i, t.VARS.EVAR_15, "external (direct)|".concat(n.toStrTrim(V))), o(i, t.VARS.EVENTS, _.add(new e.OmnitureEvent(c.SERP_DIRECT))), i) : (o(a = {}, t.VARS.EVAR_15, "|".concat(n.toStrTrim(V))), o(a, t.VARS.EVENTS, _), a))
    }
  }, {
    "@apple/analytics-omniture-collection": 7,
    "@apple/analytics-omniture-constants": 8,
  ...
  12: [function(require, module, exports) {
    ...
    var x = function() {
      ...
      T = [/^APPLE/, /^HOMEPOD/, /^IMAC/, /^IPAD/, /^IPHONE/, /^IPOD/, /^MAC/, /^PRO/, /^W\d\d_/, /^Z/, /\+/, /GIFT_CARDS/, /^AOS/],
      R = function(e) {
      ...
      oe = function(e, t, r) {
        return t && t.length ? ie(e, j(t).reverse(), r) : e
      },
      ie = function e(t, r, n) {
        if (!r.length) return n;
        if ("object" === b(t)) {
          var o = r.pop(),
            i = Array.isArray(t) ? j(t) : w({}, t);
      ...
      ae = Object.freeze({
        ...
        formatPath: function e() {
          ...
          return n.map(function(r) {
            return Array.isArray(r) ? e.apply(void 0, j(r)) : t(r).split(re)
          }).reduce(function(e, t) {
            return e.concat(t)
          }, [])
        },
        ...
        remove: function(e, t) {
          return t && t.length && "object" === b(e) ? ue(e, j(t).reverse()) : e
        }
      }),
      ce = Object.freeze({
        __proto__: null,
      ...
      he = ["applenews:", "itms-apps:"],
      _e = ["apps.apple.com", "news.apple.com", "music.apple.com", "wallet.apple.com", "tv.apple.com", "books.apple.com"],
      we = Object.freeze({
        __proto__: null,
        classListContains: me,
        getOrigin: ye,
        ...
        isSignInLink: function(e) {
          return me(e, "ac-gn-bagview-nav-link-signIn")
        },
        isSignOutLink: function(e) {
          return me(e, "ac-gn-bagview-nav-link-signOut")
        },
        ...
        redirectsToSignInLink: function(e) {
          return me(e, "ac-gn-bagview-nav-link-favorites", "ac-gn-bagview-nav-link-orders", "ac-gn-bagview-nav-link-account", "ac-gn-bagview-nav-link-signIn")
        },
        ...
        sanitizeUrl: function() {
          var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            ...
            i = r(t);
          if (!i) return "";
          (o || "string" == typeof n && "errorpage" === n.toLowerCase()) && (i = i.replace(/\/vieworder\/.*/, "/vieworder/******")), i = (i = (i = (i = (i = i.replace(/\/order\/guest\/.*/, "/order/guest/******")).replace(/\/order\/applynow\/ep_payments\/.*/, "/order/applynow/ep_payments/******")).replace(/\/onMyWay\/.*/, "/onMyWay/******")).replace(/\/startPickup\/.*/, "/startPickup/******")).replace(/\/[^\/]+@.*/i, "/******");
          var u = new URL(i);
    ...
    exports.activityMap = g, exports.asCookie = A, exports.asCookieJson = z, exports.beaconHelpers = X, exports.cookie = d, exports.cookieJson = V, exports.deepClone = function e(t) {
    ...
    }, exports.eventHelpers = G, exports.getOmniture = q, exports.getRandomInt = function() {
      var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1e3;
      return Math.floor(Math.random() * Math.floor(e))
    }, exports.jsonEncoder = E, exports.localStorage = Y, exports.localStorageJson = te, exports.objectHelpers = ce, exports.objectPath = ae, exports.pipe = c, exports.sessionStorage = pe, exports.sessionStorageJson = ve, exports.stringHelpers = a, exports.toStr = t, exports.toStrTrim = r, exports.urlHelpers = we
  }, {
    "@apple/analytics-omniture-constants": 8
  }],
        ...
        t.C = function(e) {
          ...
          if (!s && o && (s = t.Na(o)), s && !t.linkLeaveQueryString && (0 <= (i = s.indexOf("?")) && (s = s.substring(0, i))), !c && s) {
            ...
            if (t.trackDownloadLinks && t.linkDownloadFileTypes)
              for (i = (l = s.toLowerCase()).indexOf("?"), r = l.indexOf("#"), 0 <= i ? 0 <= r && r < i && (i = r) : i = r, 0 <= i && (l = l.substring(0, i)), i = t.linkDownloadFileTypes.toLowerCase().split(","), r = 0; r < i.length; r++)(u = i[r]) && (l.substring(l.length - (u.length + 1)) == "." + u || l.substring(l.length - (u.length + 1)) == "/" + u) && (c = "d");
  ...
  102: [function(require, module, exports) {
    ...
    "./plugins/passiveTrackTarget": 123,
    "./plugins/passiveTracker": 124,
    "./plugins/percentPageViewed": 125,
    "./plugins/referrerAndCurrentUrl": 126,
    "./plugins/referrerQueryParam": 127,
    "./plugins/removeSpacesInLinkTrackVars": 128,
    "./plugins/retailCookies": 129,
    "./plugins/setTcallToFalse": 130,
    "./plugins/specialRssLinks": 131,
  ...
  103: [function(require, module, exports) {
    ...
    function appendList(e, r, i) {
      ...
      "string" == typeof i && (i = [i]), "string" != typeof e[r] && (e[r] = JSON.stringify(e[r])), i.forEach(function(i) {
        e[r] = e.apl(e[r], i, n, t)
      })
    }
  ...
  123: [function(require, module, exports) {
    "use strict";
    var passiveTrack = require("../../../passiveTracker"),
      _require = require("../helpers"),
      appendList = _require.appendList,
      isMicroEvent = _require.isMicroEvent,
      track = require("../../../trackers/event").track,
      get = require("@apple/analytics-data-layer").get,
      propName = "eVar57";

    function passiveTrackTarget(e) {
      var a = get("conf.pageName") ? get("conf.pageName") : "",
        r = getTargetData();
      r ? (e[propName] = "".concat(r, ":").concat(a), isMicroEvent(e) && appendList(e, "linkTrackVars", propName)) : document.addEventListener("at-content-rendering-succeeded", function(e) {
        (r = getTargetData()) && passiveTrack({
          eVar57: "".concat(r, ":").concat(a)
        })
      })
    }
    ...
    function getTargetData() {
      if (window && window.ac_target) {
        var e = window.ac_target.data,
          a = window.ac_target.tracked;
        if (e && !a) return window.ac_target.tracked = !0, e
      }
    }
    module.exports = passiveTrackTarget
  }, {
    "../../../passiveTracker": 175,
    "../../../trackers/event": 181,
    "../helpers": 103,
  ...
  179: [function(require, module, exports) {
    ...
    function track(e) {
      ...
      }), !e.beacon.prop57 && r.hier1 && setProperty(e.beacon, "prop57", r.hier1), e
    }
  ...
  192: [function(require, module, exports) {
    ...
    function track(e) {
      ...
      if (t.element && t.element.position && (t.element.position + separator.dot + separator.space, separator.space + separator.dot + t.element.position), e.beacon.title = "section engagement", e.beacon.prop34 = a, e.beacon.prop35 = (r / 1e3).toFixed(2), e.beacon.prop36 = t.element.position, e.beacon.prop35) {
