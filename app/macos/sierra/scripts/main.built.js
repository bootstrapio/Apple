! function t(e, n, i) {
  ...
  18: [function(t, e, n) {
    ...
    i._prefix = function() {
      var t = "https://www.apple.com/global/elements/blank.gif";
  ...
  269: [function(t, e, n) {
    ...
    function i() {
      for (var t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", e = 0, n = t.length; e < n; ++e) c[e] = t[e], l[t.charCodeAt(e)] = e;
    ...
    function r(t) {
      ...
      var c = 0;
      for (e = 0, n = 0; e < i; e += 4, n += 3) r = l[t.charCodeAt(e)] << 18 | l[t.charCodeAt(e + 1)] << 12 | l[t.charCodeAt(e + 2)] << 6 | l[t.charCodeAt(e + 3)], o[c++] = r >> 16 & 255, o[c++] = r >> 8 & 255, o[c++] = 255 & r;
    ...
    function o(t, e, n) {
      for (var i, r = [], o = e; o < n; o += 3) i = (t[o] << 16) + (t[o + 1] << 8) + t[o + 2], r.push(s(i));
      return r.join("")
    }

    function a(t) {
      for (var e, n = t.length, i = n % 3, r = "", s = [], a = 16383, l = 0, h = n - i; l < h; l += a) s.push(o(t, l, l + a > h ? h : l + a));
  ...
  272: [function(t, e, n) {
    ...
    function s() {
      m && f && (m = !1, f.length ? d = f.concat(d) : p = -1, d.length && o())
    }
    ...
    u.nextTick = function(t) {
      ...
      d.push(new a(t, e)), 1 !== d.length || m || i(o)
    }, a.prototype.run = function() {
      this.fun.apply(null, this.array)
    }, u.title = "browser", u.browser = !0, u.env = {}, u.argv = [], u.version = "", u.versions = {}, u.on = c, u.addListener = c, u.once = c, u.off = c, u.removeListener = c, u.removeAllListeners = c, u.emit = c, u.binding = function(t) {
  ...
  578: [function(t, e, n) {
    ...
    function i(t, e, n, i, r, o, a) {
      this.currentBreakpoint = i, this.autoPlay = !1, this._engagedLoadingTimeout = null, this.hasPlayed = !1, this.mediaObjectLoadStarted = !1, this.onEndedWasTriggered = !1, this.trackedComponentElement = null, s.apply(this, arguments), this.name = "MediaObjectComponent_" + a, this.rafWhenVisible = !1, this.destroyed = !1, this.mediaObjectContainer = l("[data-mediaobject]", this.element),
        this.data = this._setData(), this.mediaObject = this._createMediaObject(this.data), this._bindMethods(), this.replayButton = l(".mediaObject-replay", this.element), this.playButton = l(".mediaObject-play", this.element), this._initMediaObject(), this._bindTriggers()
    }
    t("@marcom/ac-polyfills/Object/create");
