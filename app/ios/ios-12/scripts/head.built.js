require = function() {
  ...
  12: [function(t, e, r) {
    ...
    "@marcom/ac-function/memoize": 19,
    "@marcom/ac-prefixer/getStyleProperty": 39,
    "@marcom/ac-prefixer/getStyleValue": 40
  }],
  13: [function(t, e, r) {
    "use strict";
    e.exports = {
  ...
  21: [function(t, e, r) {
    ...
    "./defaults": 22,
    "@marcom/ac-feature/webGLAvailable": 18
  }],
  22: [function(t, e, r) {
    "use strict";
    e.exports = {
  ...
  27: [function(t, e, r) {
    ...
    "@marcom/ac-browser": 1,
    "@marcom/ac-feature/svgAvailable": 16,
    "@marcom/ac-feature/touchAvailable": 17
  }],
  28: [function(t, e, r) {
    "use strict";
  ...
  34: [function(t, e, r) {
    ...
    function i(t, e, r, o) {
      ...
      c(e, n) || (l && a ? u(e, n) : s ? f(e, i) : t === O ? u(e, n) : t === x && f(e, n))
    }

    function a(t, e, r, o) {
      var n = t._subscribers,
        i = n.length;
      n[i] = e, n[i + O] = r, n[i + x] = o
    }
  ...
  37: [function(t, e, r) {
    ...
    function o(t) {
      if (t && "object" === ("undefined" == typeof t ? "undefined" : n(t)) && t.constructor === this) return t;
      var e = this;
  ...
  38: [function(t, e, r) {
    ...
    function o(t) {
      return n(t) || "object" === ("undefined" == typeof t ? "undefined" : a(t)) && null !== t
    }
    ...
    r.objectOrFunction = o, r.isFunction = n, r.isArray = i, r.now = s
  }, {}],
  39: [function(t, e, r) {
    "use strict";
  ...
  55: [function(t, e, r) {
    ...
    var a = function() {
      ...
      s = t("@marcom/ac-gpu-reporter/GPUReporter"),
      c = t("@marcom/ac-feature/webGLAvailable"),
      u = (t("@marcom/ac-gpu-reporter/defaults"), {
        gpuList: {
          blackList: [],
          whitelist: []
        },
      ...
      l = function(t) {
        function e(t) {
          ...
          return t = Object.assign({}, u, t), r._gpuList = t.extendDefaultList ? r._extendLists(t.gpuList) : t.gpuList, r
        }
        return i(e, t), a(e, null, [{
          ...
          value: function() {
            var t = this._gpuList;
            if (!e.IS_SUPPORTED()) return this.NO_WEBGL;
            var r = this.getGPU();
            return null === r ? this.NOT_FOUND : "whitelist" in t && this._matchesList(r, t.whitelist) ? this.WHITELISTED : "blacklist" in t && this._matchesList(r, t.blacklist) ? this.BLACKLISTED : this.NOT_LISTED
          }
        }]), e
      }(s);
    e.exports = l
    ...
    "@marcom/ac-feature/webGLAvailable": 18,
    "@marcom/ac-gpu-reporter/GPUReporter": 21,
    "@marcom/ac-gpu-reporter/defaults": 22
  }],
  56: [function(t, e, r) {
    "use strict";
    ...
    function o() {
      return 1 === new m({
        gpuList: {
          blacklist: ["Apple A7 GPU", "Apple A8 GPU"]
        }
      }).getGPUClass()
    }

    function n() {
      var t = c.os.ios && c.os.version.major > 9,
        e = c.browser.chrome;
      return (l() || t || e) && !d && !document.documentElement.classList.contains("aow")
    }
    ...
    function a() {
      return !p("will-change") || !p("position", "sticky")
    }
    var s = t("@marcom/ac-headjs"),
      c = t("@marcom/ac-useragent"),
      u = t("@marcom/ac-feature/prefersReducedMotion"),
      l = t("@marcom/ac-feature/isDesktop"),
      f = t("@marcom/ac-feature/canvasAvailable"),
      p = t("@marcom/ac-feature/cssPropertyAvailable"),
      m = t("./GpuReporter"),
      y = document.documentElement.classList.contains("aow"),
      d = o();
    s.addTests({
      "reduced-motion": u(),
      "inline-video": n(),
      "animated-hero": i(),
      "static-interaction": a(),
      "progressive-image": !0
    }), s.htmlClass()
  }, {
    "./GpuReporter": 55,
    "@marcom/ac-feature/canvasAvailable": 11,
    "@marcom/ac-feature/cssPropertyAvailable": 12,
    "@marcom/ac-feature/isDesktop": 14,
    "@marcom/ac-feature/prefersReducedMotion": 15,
    "@marcom/ac-headjs": 26,
    "@marcom/ac-useragent": 47
  }],
